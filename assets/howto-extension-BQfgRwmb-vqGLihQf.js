import{E as e,F as t,I as n,M as r,N as i,O as a,P as o,R as s,_ as c,d as l,g as u,k as d,w as f}from"./dist-C1LXzuY9.js";import{I as ee,N as p,Q as te,U as m,n as ne,r as h,w as g,z as _}from"./repeat-D7ZcYN9W.js";import{d as v,m as y,n as b,o as x,s as S,u as C}from"./fs-access-D-fDaJ8V-BQA-EXV_.js";import{n as w,t as T}from"./events-B_ZxkU_G-CIQGcfIC.js";import{a as re,s as E}from"./ai-service-_8yd8pWc-8F3iWzoJ.js";import"./api-DXImfNzB.js";var D=v(`HowToService`),O=`system.howtos`,k=new class{constructor(){this.contributions=new Map,this.loadContributions(),w(a,e=>{e.target===`system.howtos`&&this.loadContributions()})}loadContributions(){let e=i.getContributions(O);this.contributions.clear();for(let t of e){if(!t.id){D.warn(`HowTo contribution missing id, skipping`);continue}if(t.label||=typeof t.title==`function`?t.title():t.title,!t.steps||t.steps.length===0){D.warn(`HowTo contribution "${t.id}" has no steps, skipping`);continue}let e=new Set;for(let n of t.steps){if(e.has(n.id)){D.warn(`HowTo contribution "${t.id}" has duplicate step ID: "${n.id}"`);continue}e.add(n.id)}this.contributions.set(t.id,t);let n=typeof t.title==`function`?t.title():t.title;D.debug(`Loaded HowTo contribution: ${n} (${t.id})`)}D.info(`Loaded ${this.contributions.size} HowTo contributions`)}getContribution(e){return this.contributions.get(e)}getAllContributions(){return Array.from(this.contributions.values())}getContributionsByCategory(e){return Array.from(this.contributions.values()).filter(t=>t.category===e)}hasContribution(e){return this.contributions.has(e)}},A=`welcome.txt`;async function j(){if(!await C.getWorkspace())return null;let e=await C.getFolders();return e.length===0?null:`${e[0].name}/${A}`}function M(e){return e&&typeof e.getFilePath==`function`}async function N(){return C.isConnected()}async function P(){let e=await j();if(!e)return!1;let t=await C.getWorkspace();if(!t)return!1;try{return await t.getResource(e)instanceof b}catch{return!1}}function F(){let e=d.get();if(!e||!M(e))return!1;let t=e.getFilePath();return t===A||t?.endsWith(`/`+A)===!0}function I(){if(!F())return!1;let e=d.get();return e?e.isDirty()===!1:!1}function L(){return!F()}function R(){return u.getCurrentApp()?.name||`AppSpace`}i.registerContribution(O,{id:`docks.onboarding`,title:()=>`Welcome to ${R()}`,description:()=>`Get started with ${R()} by learning the basics of workspace and file management`,icon:`graduation-cap`,label:``,category:`Getting Started`,initialize:e=>{let t=[];return w(x,()=>{e.requestUpdate()}),w(S,()=>{e.requestUpdate()}),t.push(s(d,()=>{e.requestUpdate()})),t.push(s(o,()=>{e.requestUpdate()})),()=>{t.forEach(e=>e())}},steps:[{id:`create-text-file`,title:`Create welcome.txt`,description:`Create a new text file called "welcome.txt" in your workspace. If you don't have a workspace selected, choose one first.`,preCondition:async()=>await N(),postCondition:async()=>await P(),command:`touch`,commandParams:async()=>{let e=await j();return e?{path:e,contents:`Welcome to AppSpace!

This is your first file. You can edit it and save your changes.`}:{}}},{id:`open-text-file`,title:`Open welcome.txt`,description:`Open the "welcome.txt" file in the editor.`,preCondition:async()=>await P(),postCondition:()=>F(),command:`open_editor`,commandParams:async()=>{let e=await j();return e?{path:e}:{}}},{id:`edit-and-save`,title:`Type something and save`,description:`Type some text in the editor to modify the file, then save it using Ctrl+S or the save button.`,preCondition:()=>F(),postCondition:()=>I()},{id:`close-text-file`,title:`Close the file`,description:`Close the editor tab by clicking the X button on the tab.`,preCondition:()=>F(),postCondition:()=>L()}]});var z=`.system.ai-config`;function B(e){return e&&typeof e.getFilePath==`function`}function V(){let e=d.get();return!e||!B(e)?!1:e.getFilePath()===z}async function H(){try{let e=await c.get(re);if(!e||!e.defaultProvider)return!1;let t=e.providers?.find(t=>t.name===e.defaultProvider);return t?!!t.apiKey&&t.apiKey.trim()!==``:!1}catch{return!1}}function U(){let e=d.get();return!e||!B(e)||e.getFilePath()!==z?!1:e.isDirty()===!0}function W(){return V()?!U():!1}function G(){return!V()}async function ie(){try{let e=await c.get(`aiChatSessions`);if(!e||typeof e!=`object`)return!1;for(let t in e){let n=e[t];if(n?.history&&Array.isArray(n.history)&&n.history.some(e=>e.role===`user`&&e.content&&e.content.trim()!==``))return!0}return!1}catch{return!1}}function K(){return u.getCurrentApp()?.name||`AppSpace`}i.registerContribution(O,{id:`docks.ai-setup`,title:()=>`Set up AI in ${K()}`,description:()=>`Configure an LLM provider to enable AI chat features in ${K()}`,icon:`robot`,label:``,category:`Getting Started`,initialize:e=>{let t=[];return t.push(s(d,()=>{e.requestUpdate()})),t.push(s(o,()=>{e.requestUpdate()})),w(E,()=>{e.requestUpdate()}),()=>{t.forEach(e=>e())}},steps:[{id:`open-ai-settings`,title:`Open AI Settings`,description:`Open the AI settings editor by clicking the robot icon in the toolbar or using the command palette.`,preCondition:()=>!0,postCondition:()=>V(),command:`open_ai_config`},{id:`configure-llm-provider`,title:`Configure LLM Provider`,description:`Select a provider as default and enter an API key. Make sure to save your changes using Ctrl+S or the save button.`,preCondition:()=>V(),postCondition:async()=>{let e=await H(),t=W();return e&&t}},{id:`save-and-close`,title:`Save and Close`,description:`Save your changes (if not already saved) and close the AI settings editor tab.`,preCondition:()=>V(),postCondition:()=>G()},{id:`type-in-chat`,title:`Type in Chat`,description:`Open the AI chat view (if not already open) and type a message to test your AI configuration.`,preCondition:async()=>await H(),postCondition:async()=>await ie()}]});var q=`howto/show-panel`,J=`howto/toggle-panel`,Y=`howto-panel`,X={x:100,y:100},Z={width:400,height:300},Q=class extends e{constructor(...e){super(...e),this.contributions=[],this.activeContributionId=null,this.stepStates=new Map,this.isMinimized=!1,this.isVisible=!1,this.positionX=X.x,this.positionY=X.y,this.isDragging=!1,this.dragPreviewPosition=null,this.dragStartPosition={x:0,y:0},this.panelRef=ne(),this.handleDragStart=e=>{let t=e.target;if(this.isDragTarget(t)||!this.panelRef.value)return;let n=this.panelRef.value.getBoundingClientRect();this.dragStartPosition={x:e.clientX-n.left,y:e.clientY-n.top},this.isDragging=!0,this.dragPreviewPosition={x:this.positionX,y:this.positionY},this.requestUpdate(),e.preventDefault(),e.stopPropagation()},this.handleDragMove=e=>{if(!this.isDragging||!this.dragPreviewPosition)return;let t=this.getViewportBounds(),n=Math.max(0,Math.min(e.clientX-this.dragStartPosition.x,t.maxX)),r=Math.max(0,Math.min(e.clientY-this.dragStartPosition.y,t.maxY));(this.dragPreviewPosition.x!==n||this.dragPreviewPosition.y!==r)&&(this.dragPreviewPosition={x:n,y:r},this.requestUpdate())},this.handleDragEnd=async()=>{if(!this.isDragging||!this.dragPreviewPosition)return;this.isDragging=!1;let e=this.dragPreviewPosition;this.dragPreviewPosition=null,this.positionX=e.x,this.positionY=e.y,await this.saveSettings(),this.requestUpdate()}}async doBeforeUI(){if(this.loadContributions(),w(a,e=>{e.target===`system.howtos`&&(this.loadContributions(),this.requestUpdate())}),w(q,()=>this.showPanel()),w(J,()=>this.toggleVisibility()),await this.loadSettings(),!C.isConnected()&&this.isVisible===!1){let e=await c.getDialogSetting(Y);(!e||e.visible===void 0)&&(this.isVisible=!0,await this.saveSettings())}w(S,()=>{(async()=>{let e=await c.getDialogSetting(Y);!e||e.visible})()})}doInitUI(){this.boundHandleDragMove=this.handleDragMove.bind(this),this.boundHandleDragEnd=this.handleDragEnd.bind(this),document.addEventListener(`mousemove`,this.boundHandleDragMove),document.addEventListener(`mouseup`,this.boundHandleDragEnd)}firstUpdated(e){super.firstUpdated(e)}loadContributions(){this.contributions=k.getAllContributions()}async loadSettings(){let e=await c.getDialogSetting(Y);e&&(e.position&&(this.positionX=e.position.x||X.x,this.positionY=e.position.y||X.y),e.visible!==void 0&&(this.isVisible=e.visible))}async saveSettings(){await c.setDialogSetting(Y,{position:{x:this.positionX,y:this.positionY},visible:this.isVisible})}isDragTarget(e){return!!(e.closest(`.header-actions`)||e.closest(`wa-button`))}getViewportBounds(){let e=this.panelRef.value?.offsetWidth||Z.width,t=this.panelRef.value?.offsetHeight||Z.height;return{maxX:window.innerWidth-e,maxY:window.innerHeight-t}}async startHowTo(e){let t=k.getContribution(e);if(!t){n(`HowTo "${e}" not found`);return}this.cleanupHowTo(),this.activeContributionId=e,this.isMinimized=!1;let r=t.steps.map(e=>({step:e,status:`pending`}));if(this.stepStates.set(e,r),t.initialize){let n={requestUpdate:()=>this.recheckActiveStepConditions(),contributionId:e};this.howtoCleanup=t.initialize(n)||void 0}this.requestUpdate(),await this.checkPreConditions(e,0)}cleanupHowTo(){this.howtoCleanup&&=(this.howtoCleanup(),void 0)}getStepState(e,t){let n=this.stepStates.get(e);return n&&t<n.length?n[t]:null}async checkPreConditions(e,t){let n=this.getStepState(e,t);if(n){if(!n.step.preCondition){n.preConditionMet=!0,this.requestUpdate();return}try{n.preConditionMet=await n.step.preCondition(),this.requestUpdate()}catch(e){console.error(`Pre-condition check failed for step ${n.step.id}:`,e),n.preConditionMet=!1,this.requestUpdate()}}}async checkPostConditions(e,t){let n=this.getStepState(e,t);if(n){if(!n.step.postCondition){this.completeStep(e,t);return}try{let r=await n.step.postCondition();n.postConditionMet=r,n.status=r?`completed`:`failed`,r&&this.activateNextStep(e,t),this.requestUpdate()}catch(e){console.error(`Post-condition check failed for step ${n.step.id}:`,e),n.postConditionMet=!1,n.status=`failed`,this.requestUpdate()}}}completeStep(e,t){let n=this.getStepState(e,t);n&&(n.status=`completed`,this.activateNextStep(e,t),this.requestUpdate())}async activateNextStep(e,t){let n=this.stepStates.get(e);if(!n||t+1>=n.length)return;let r=n[t+1];r.status=`active`,await this.checkPreConditions(e,t+1)}async recheckActiveStepConditions(){if(!this.activeContributionId)return;let e=this.stepStates.get(this.activeContributionId);if(!e)return;let t=e.findIndex(e=>e.status===`active`);if(t!==-1){let n=e[t],r=n.step;if(r.postCondition)try{if(await r.postCondition()&&n.status===`active`){await this.checkPostConditions(this.activeContributionId,t);return}}catch{}}for(let t=0;t<e.length;t++){let n=e[t];n.status===`pending`&&n.step.preCondition&&await this.checkPreConditions(this.activeContributionId,t)}this.requestUpdate()}async executeStep(e,t){let n=this.getStepState(e,t);n&&await this.validatePreConditions(n,e,t)&&(n.status=`active`,this.requestUpdate(),!(n.step.command&&!await this.executeStepCommand(n))&&await this.checkPostConditions(e,t))}async validatePreConditions(e,t,r){return e.step.preCondition?((e.preConditionMet===void 0||e.preConditionMet===!1)&&await this.checkPreConditions(t,r),e.preConditionMet===!0?!0:(n(`Pre-conditions not met for step: ${e.step.title}`),!1)):!0}async executeStepCommand(e){if(!e.step.command)return!0;try{let t=e.step.commandParams,n=typeof t==`function`?await t():t||{},i=r.createExecutionContext(n);return await r.execute(e.step.command,i),!0}catch(t){return console.error(`Failed to execute command for step ${e.step.id}:`,t),n(`Failed to execute step: ${e.step.title}`),e.status=`failed`,this.requestUpdate(),!1}}async runStepCommand(e,t){let r=this.getStepState(e,t);if(!(!r||!r.step.command)){if(r.step.preCondition&&!await r.step.preCondition()){n(`Pre-conditions not met for step: ${r.step.title}`);return}await this.executeStepCommand(r)&&await this.checkPostConditions(e,t)}}skipStep(e,t){let n=this.getStepState(e,t);!n||!n.step.optional||(n.status=`skipped`,this.activateNextStep(e,t),this.requestUpdate())}closeHowTo(){this.cleanupHowTo(),this.activeContributionId=null,this.stepStates.clear(),this.requestUpdate()}toggleMinimize(){this.isMinimized=!this.isMinimized,this.requestUpdate()}async showPanel(){this.isVisible=!0,this.isMinimized=!1,await this.saveSettings(),this.requestUpdate()}async hidePanel(){this.isVisible=!1,await this.saveSettings(),this.requestUpdate()}async toggleVisibility(){this.isVisible?await this.hidePanel():await this.showPanel()}renderStep(e,t,n){let{step:r,status:i,preConditionMet:a,postConditionMet:o}=e,s=i===`active`,c=i===`completed`,l=i===`failed`,u=i===`pending`,d=i===`skipped`;return m`
            <div class="step ${i}" ?data-active=${s}>
                <div class="step-header">
                    ...
                    <div class="step-status">
                        ...
                        `:_}
                        ${c?m`<wa-icon name="check-circle" class="status-icon completed"></wa-icon>`:_}
                        ${l?m`<wa-icon name="xmark-circle" class="status-icon failed"></wa-icon>`:_}
                        ${d?m`<wa-icon name="minus-circle" class="status-icon skipped"></wa-icon>`:_}
                        ${u?m`<wa-icon name="circle" class="status-icon pending"></wa-icon>`:_}
                        ${s?m`<wa-icon name="play-circle" class="status-icon active"></wa-icon>`:_}
                    </div>
                </div>
                <div class="step-description">${r.description}</div>
                ${r.preCondition&&a!==void 0?m`
                    <div class="condition pre-condition ${a?`met`:`not-met`}">
                        <wa-icon name="${a?`check`:`xmark`}"></wa-icon>
                        <span>Pre-condition: ${a?`Met`:`Not met`}</span>
                    </div>
                `:_}
                ${r.postCondition&&o!==void 0?m`
        ...
        `}render(){if(!this.isVisible)return _;let e=this.activeContributionId?k.getContribution(this.activeContributionId):null,t=this.activeContributionId&&this.stepStates.get(this.activeContributionId)||[];return m`
            ${this.dragPreviewPosition?m`
                <div 
                    class="howto-panel-drag-preview"
                style=${g({left:`${this.dragPreviewPosition.x}px`,top:`${this.dragPreviewPosition.y}px`,width:`${this.panelRef.value?.offsetWidth||Z.width}px`,height:`${this.panelRef.value?.offsetHeight||Z.height}px`,display:`block`,visibility:`visible`})}
                ></div>
            `:_}
            <div 
                class="howto-panel ${this.isMinimized?`minimized`:``} ${this.dragPreviewPosition?`dragging`:``}"
                style=${g({left:`${this.positionX}px`,top:`${this.positionY}px`,transform:`translateZ(0)`})}
                ${h(this.panelRef)}
            >
                    ...
                    <div class="panel-content">
                        ...
                        `:m`
                            <div class="workflows-list">
                                ...
                                `:this.contributions.map(e=>{let t=typeof e.title==`function`?e.title():e.title,n=e.description?typeof e.description==`function`?e.description():e.description:null;return m`
    ...
    `}};f([p()],Q.prototype,`contributions`,void 0),f([p()],Q.prototype,`activeContributionId`,void 0),f([p()],Q.prototype,`stepStates`,void 0),f([p()],Q.prototype,`isMinimized`,void 0),f([p()],Q.prototype,`isVisible`,void 0),f([p()],Q.prototype,`positionX`,void 0),f([p()],Q.prototype,`positionY`,void 0),f([p()],Q.prototype,`dragPreviewPosition`,void 0),Q=f([ee(`docks-howto-panel`)],Q);var $=v(`HowToExtension`);function ae(e){$.info(`HowTo system extension loaded`),y.put(`howToService`,k);let n=()=>{if(document.querySelector(`docks-howto-panel`))return;let e=document.createElement(`docks-howto-panel`);document.body.appendChild(e),$.info(`HowTo panel added to DOM`)};if(document.body)requestAnimationFrame(()=>{n()});else{let e=()=>{document.body?n():requestAnimationFrame(e)};requestAnimationFrame(e)}t({command:{id:`howto.show-panel`,name:`Show HowTo Panel`,description:`Shows the HowTo workflows panel`,icon:`list-check`,parameters:[]},handler:{execute:()=>{T(q,null)}}}),t({command:{id:`howto.toggle-panel`,name:`Toggle HowTo Panel`,description:`Toggles the visibility of the HowTo workflows panel`,icon:`list-check`,keyBinding:`CTRL+SHIFT+H`,parameters:[]},handler:{execute:()=>{T(J,null)}},contribution:{target:l,icon:`list-check`,label:`HowTo`}}),$.info(`HowTo system extension initialized`)}export{O as HOWTO_CONTRIBUTION_TARGET,ae as default,k as howToService};