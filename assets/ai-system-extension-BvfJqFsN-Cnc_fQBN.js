...
import{_ as I}from"./preload-helper-WQhrSmCl.js";import{au as ne,az as le,ao as V,q as j,av as ce,aI as de,aG as $,aJ as Q,aA as ae,s as ie,x as l,a6 as pe,Z as O,$ as m,a1 as v,aK as he,ai as ge,ay as N,I as h,ar as ue,aq as me,as as H,z as oe,aL as re,P as U,a4 as G,ad as ve,aM as we,a3 as ee,am as fe,at as X,aN as be,aO as Y,aP as Ae,aF as ye,aQ as Ee,a0 as _}from"./index-BgkfMran.js";import"./chunk.LTSJC6DR-BCCP1Gxs.js";const Se=`You are an assistant in a web application with workspace, editors, and AI chat.
...
`;var Te=Object.defineProperty,Ce=Object.getOwnPropertyDescriptor,D=(s,e,a,t)=>{for(var i=t>1?void 0:t?Ce(e,a):e,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=(t?n(e,a,i):n(i))||i);return t&&i&&Te(e,a,i),i};let P=class extends N{constructor(){super(...arguments),this.isStreaming=!1,this.showHeader=!0,this.attentionInputValue=""}formatTimestamp(){return new Date().toLocaleTimeString()}copyToClipboard(s){navigator.clipboard.writeText(s).catch(e=>{console.error("Failed to copy:",e)})}processMarkdownContent(s){return s.includes("code-block-wrapper")?s:s.replace(/<pre><code([^>]*)>([\s\S]*?)<\/code><\/pre>/gi,(e,a,t)=>`<div class="code-block-wrapper">
            ...
            <div class="message-wrapper ${e?"user":"assistant"} ${this.isStreaming?"streaming":""} ${a?"requires-attention":""}">
                ...
                <div class="message-content-wrapper ${e?"user":""}">
                    <div class="message-content">
                        ${ue(this.processMarkdownContent(me.parse(s.content||"")))}
    ...
    `;L([m({type:String})],M.prototype,"value",2);L([m({type:Boolean})],M.prototype,"disabled",2);L([m({type:Boolean})],M.prototype,"busy",2);L([m({type:Boolean})],M.prototype,"hasProvider",2);L([he("wa-textarea")],M.prototype,"textareaElement",2);M=L([_("ai-chat-input")],M);var $e=Object.defineProperty,Ie=Object.getOwnPropertyDescriptor,te=(s,e,a,t)=>{for(var i=t>1?void 0:t?Ie(e,a):e,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=(t?n(e,a,i):n(i))||i);return t&&i&&$e(e,a,i),i};let z=class extends N{constructor(){super(...arguments),this.message=r("NO_PROVIDER_CONFIGURED"),this.hint=r("CLICK_SETTINGS_TO_CONFIGURE")}render(){return l`
                ...
                ${h(s.length>0,()=>l`
                    ${this.pendingToolApprovals.size>0?l`
                        <div class="tool-approval-section">
                            ${Array.from(this.pendingToolApprovals.entries()).map(([t,i])=>{const o=i.request.toolCalls,n=o.length;o.map(u=>{const T=u.function.arguments||"{}";let b={};try{b=JSON.parse(T)}catch{b={}}const C=Object.entries(b).map(([E,d])=>`${E}=${JSON.stringify(d)}`).join(", ");return`${u.function.name}${C?`(${C})`:"()"}`}).join(", ");const c=n>1?"s":"",p=n>1?", ...":"",w=r("TOOL_EXECUTION_PENDING",{toolCount:n.toString(),plural:c,toolName:o[0]?.function.name||"",more:p});return l`
                                    <wa-details class="approval-details">
                                        ...
                                        <div class="approval-content">
                                            <div class="approval-message">
                                                ...
                                                <ul class="tool-list">
                                                    ${o.map(u=>{const T=u.function.arguments||"{}";let b={};try{b=JSON.parse(T)}catch{b={}}const C=Object.entries(b).length>0?`(${Object.entries(b).map(([d,g])=>`${d}=${JSON.stringify(g)}`).join(", ")})`:"()",E=i.allowListSelections.get(u.id)||!1;return l`
