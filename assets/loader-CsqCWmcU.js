import{G as b}from"./gs-map-editor-3ZF3IM1n.js";import{a as D,b as r,i as T,n as I,c as y,t as O}from"./default-xvQdiKMn.js";import{w}from"./index-bn5ri0EB.js";import{n as C,t as x,b as L}from"./geospace-app-CCGOW35A.js";import"./preload-helper-WQhrSmCl.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./chunk.IVRNYRHD-Htfh_CZj.js";import"./chunk.2PWIIYRH-COD9mzAh.js";const F=D`
    wa-dialog {
        --width: 900px;
    }
...
`;function A(e){const t=e.stroke?.color||"transparent",a=e.fill?.color||"transparent",i=Math.min(e.stroke?.width||1,5),o=e.stroke?.lineDash?.join(" ")||"none",n=e.stroke?.lineCap||"round",l=e.stroke?.lineJoin||"round";return e.image?.type==="circle"?E(e,t,a,i):e.image?.type==="regular-shape"?j(e,t,a,i):e.image?.type==="icon"?z(e):r`
    ...
    `}function j(e,t,a,i){const o=e.image?.points||5,n=Math.min(e.image?.radius||10,15),l=e.image?.fill?.color||a,u=e.image?.stroke?.color||t,c=Math.min(e.image?.stroke?.width||i,3),p=e.image?.opacity??1,d=((e.image?.rotation||0)+(e.image?.angle||0))*(180/Math.PI),s=q(20,20,n,o,e.image?.radius2);return r`
        <svg width="40" height="40" viewBox="0 0 40 40">
            <polygon
                points="${s}"
                fill="${l}"
