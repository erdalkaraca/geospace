...
`)),s=e[e.length-1]}else throw Error(`Bad write`);return n.length};let c=[],l,u=0;n=({data:e})=>(e.length>0&&(c.push(e),l&&l()),d),o.read=(e,t,n,r,i,a)=>{if(e!==0||n!==0||r!==t.length||i!==null)throw Error(`Bad read`);if(c.length===0){l=()=>o.read(e,t,n,r,i,a);return}let s=c[0],d=Math.max(0,Math.min(r,s.length-u));t.set(s.subarray(u,u+d),n),u+=d,u===s.length&&(c.shift(),u=0),a(null,d)};let d=new r.Go;return d.argv=[``,`--service=0.25.12`],i(t,d).then(t=>{e(null),d.run(t)},t=>{e(t)}),d};function i(e,n){return t(this,null,function*(){if(e instanceof WebAssembly.Module)return WebAssembly.instantiate(e,n.importObject);let t=yield fetch(e);if(!t.ok)throw Error(`Failed to download ${JSON.stringify(e)}`);if(`instantiateStreaming`in WebAssembly&&/^application\/wasm($|;)/i.test(t.headers.get(`Content-Type`)||``))return(yield WebAssembly.instantiateStreaming(t,n.importObject)).instance;let r=yield t.arrayBuffer();return(yield WebAssembly.instantiate(r,n.importObject)).instance})}return e=>n(e)})(e=>r.onmessage({data:e})),t;r={onmessage:null,postMessage:n=>setTimeout(()=>{try{t=e({data:n})}catch(e){i(e)}}),terminate(){if(t)for(let e of t._scheduledTimeouts.values())clearTimeout(e)}}}let o,s,c=new Promise((e,t)=>{o=e,s=t});r.onmessage=({data:e})=>{r.onmessage=({data:e})=>u(e),e?s(e):o()},r.postMessage(t||new URL(e,location.href).toString());let{readFromStdout:u,service:d}=ie({writeToStdin(e){r.postMessage(e)},isSync:!1,hasFS:!1,esbuild:l});yield c,Ce=()=>{r.terminate(),Q=void 0,Ce=void 0,we=void 0},we={build:e=>new Promise((t,n)=>{a.then(n),d.buildOrContext({callName:`build`,refs:null,options:e,isTTY:!1,defaultWD:`/`,callback:(e,r)=>e?n(e):t(r)})}),context:e=>new Promise((t,n)=>{a.then(n),d.buildOrContext({callName:`context`,refs:null,options:e,isTTY:!1,defaultWD:`/`,callback:(e,r)=>e?n(e):t(r)})}),transform:(e,t)=>new Promise((n,r)=>{a.then(r),d.transform({callName:`transform`,refs:null,input:e,options:t||{},isTTY:!1,fs:{readFile(e,t){t(Error(`Internal error`),null)},writeFile(e,t){t(null)}},callback:(e,t)=>e?r(e):n(t)})}),formatMessages:(e,t)=>new Promise((n,r)=>{a.then(r),d.formatMessages({callName:`formatMessages`,refs:null,messages:e,options:t,callback:(e,t)=>e?r(e):n(t)})}),analyzeMetafile:(e,t)=>new Promise((n,r)=>{a.then(r),d.analyzeMetafile({callName:`analyzeMetafile`,refs:null,metafile:typeof e==`string`?e:JSON.stringify(e),options:t,callback:(e,t)=>e?r(e):n(t)})})}}),De=l})(typeof t==`object`?t:{set exports(e){(typeof self<`u`?self:this).esbuild=e}})}))(),1),y=`/assets/esbuild-BHljloGq.wasm`;function b(e){let t=e.lastIndexOf(`/`);return t>=0?e.slice(0,t):``}function x(e,t){return e?`${e}/${t}`.replace(/\/+/g,`/`):t}function S(e,t){if(e.startsWith(`/`))return e.slice(1);let n=t.split(`/`).filter(e=>e),r=e.split(`/`).filter(e=>e);if(e.startsWith(`./`)||e.startsWith(`../`)||!e.startsWith(`/`)){let e=n.slice(0,-1);n.length=0,n.push(...e)}for(let e of r)if(e===`.`)continue;else e===`..`?n.length>0&&n.pop():n.push(e);return n.join(`/`)}var C=`../../gs-lib`,w={name:`workspace`,setup(e){e.onResolve({filter:/.*/},e=>{if(e.path.startsWith(`http://`)||e.path.startsWith(`https://`)||e.path.startsWith(`data:`))return;let t=e.path;if(t.startsWith(`/`)&&(t=t.slice(1)),e.importer&&e.importer!==``){let n=e.importer;n.startsWith(`virtual-workspace:`)&&(n=n.slice(18));let r=e.path.startsWith(`./`)||e.path.startsWith(`../`),i=t.includes(`/`),a=n.startsWith(`__build/`);r?t=S(e.path,n):!i&&!a&&(t=S(t,n))}return{path:t,namespace:`virtual-workspace`}}),e.onLoad({filter:/.*/},async e=>{if(!/^(?!https?:\/\/).+/.test(e.path))return;let t=e.path,n=await d.getWorkspace(),r=await n.getResource(t);if(r||=(await n.listChildren(!0),await n.getResource(t)),!r)throw Error(`Module not found: ${t}`);let i=await r.getContents(),a=t.split(`.`).pop()?.toLowerCase(),o;return a===`ts`||a===`tsx`?o=a===`tsx`?`tsx`:`ts`:a===`js`||a===`jsx`?o=a===`jsx`?`jsx`:`js`:a===`json`?o=`json`:a===`css`&&(o=`css`),{contents:i,loader:o}})}},T=new class{constructor(){this.initialized=!1,this.workspaceCache=null}async getWorkspace(){return this.workspaceCache||=await d.getWorkspace(),this.workspaceCache}async init(){this.initialized||=(await v.initialize({wasmURL:y}),!0)}createBrowserFileCopier(e){let t=this.getWorkspace.bind(this),n={"dist/index.js":()=>u(()=>import(`${C}/dist/index.js?raw`),[]),"dist/gs-lib.css":()=>u(()=>import(`${C}/dist/gs-lib.css?raw`),[]),"public/pwa/staticwebapp.config.json":()=>u(()=>import(`${C}/public/pwa/staticwebapp.config.json?raw`),[]),"public/pwa/sw.js":()=>u(()=>import(`${C}/public/pwa/sw.js?raw`),[]),"public/pwa/manifest.json":()=>u(()=>import(`${C}/public/pwa/manifest.json?raw`),[]),"public/index.html":()=>u(()=>import(`${C}/public/index.html?raw`),[]),"public/pwa/assets/icons/24x24.png":()=>u(()=>import(`${C}/public/pwa/assets/icons/24x24.png?url`),[]),"public/pwa/assets/icons/48x48.png":()=>u(()=>import(`${C}/public/pwa/assets/icons/48x48.png?url`),[]),"public/pwa/assets/icons/192x192.png":()=>u(()=>import(`${C}/public/pwa/assets/icons/192x192.png?url`),[]),"public/pwa/assets/icons/512x512.png":()=>u(()=>import(`${C}/public/pwa/assets/icons/512x512.png?url`),[]),"public/pwa/assets/icons/icon_24.png":()=>u(()=>import(`${C}/public/pwa/assets/icons/icon_24.png?url`),[]),"public/pwa/assets/icons/icon_48.png":()=>u(()=>import(`${C}/public/pwa/assets/icons/icon_48.png?url`),[]),"public/pwa/assets/icons/icon_192.png":()=>u(()=>import(`${C}/public/pwa/assets/icons/icon_192.png?url`),[]),"public/pwa/assets/icons/icon_512.png":()=>u(()=>import(`${C}/public/pwa/assets/icons/icon_512.png?url`),[])},r=async(r,i,a,o)=>{let s=n[r];if(!s)throw Error(`No import mapping for ${r}. Make sure gs-lib is built.`);let c;try{let e=await s();if(a)c=e.default,o&&(c=await o(c));else{let t=e.default,n=await fetch(t);if(!n.ok)throw Error(`Failed to fetch: ${n.statusText}`);c=await n.blob()}}catch(e){throw Error(`Failed to copy ${r}: ${e}. Make sure gs-lib is built (run: npm run build --workspace=@kispace-io/gs-lib)`)}let l=await t(),u=x(e,i);await(await l.getResource(u,{create:!0})).saveContents(c),c=void 0};return{async copyTextFile(e,t,n){await r(e,t,!0,n)},async copyBinaryFile(e,t){await r(e,t,!1)}}}async build(e,t=void 0,n,r){let i=(e,t)=>{n&&(n.currentStep=e,n.message=t)};i(0,`Initializing build system...`),await this.init();let a=await this.getWorkspace();await h(e,{async readFile(e){let t=x(r,e),n=await a.getResource(t);if(!n)throw Error(`File not found: ${t}`);return await n.getContents()},async writeFile(e,t){let n=x(r,e);await(await a.getResource(n,{create:!0})).saveContents(t)},async ensureDir(e){let t=x(r,e.endsWith(`/`)?e:e+`/`);await a.getResource(t,{create:!0})},async exists(e){let t=x(r,e);return await a.getResource(t)!==null},async deleteDir(e){let t=x(r,e),n=await a.getResource(t);n instanceof m&&await n.delete()}},w,v,{gsLibCopier:this.createBrowserFileCopier(r),cleanAfterBuild:t,copyAssets:async(e,t)=>{let n=x(r,`assets`),i=await a.getResource(n);i&&await i.copyTo(`${t}/assets`)}},i),i(0,`Finalizing build...`),a.touch(),n&&(n.message=`Build completed successfully!`)}async buildMapFile(e,t){let n=JSON.parse(await e.getContents()),o=b(e.getWorkspacePath()),s=await g([t||`.env`],o||void 0);r.runAsync(`Building map`,async t=>{await T.build({title:e.getName(),gsMap:n,env:s,version:s.VERSION||`0.0.0`},void 0,t,o||void 0)}).then(()=>{a(`🚀 Map files copied to 'dist' folder in your workspace!`)}).catch(e=>{i(`💥 Map could not be built: ${e}`)})}};p.put(`buildService`,T);var E=`.geospace`,D=`.env`,O=[`node_modules`,`.git`,`dist`,`build`,`.next`,`.cache`,`.vscode`,`.idea`,`coverage`,`.nyc_output`,`.parcel-cache`,`.turbo`,`.yarn`,`.pnp`,`.svelte-kit`,`.nuxt`,`.output`,`target`,`out`,`.temp`,`.tmp`];function k(e){let t=e.toLowerCase();return O.some(e=>t===e.toLowerCase())}async function A(e,t,n,r={value:0}){let i=[],a=await e.listChildren(!0);for(let e of a){r.value++;let a=e.getWorkspacePath();if(n&&(n.message=`Scanning: ${a}`,n.currentStep=r.value),e instanceof f&&e.getName().toLowerCase().endsWith(t))i.push(a);else if(e instanceof m&&!k(e.getName())){let a=await A(e,t,n,r);i.push(...a)}}return i.sort()}function j(){let e=document.getElementById(`global-dialog-container`);return e||(e=document.createElement(`div`),e.id=`global-dialog-container`,document.body.appendChild(e)),e}async function M(e,t,n,r){return new Promise(i=>{let a=j(),o=n||``,s=r||``,u=()=>{c(l``,a)},d=()=>{u(),i({geospaceFile:o||null,envFile:s||null})},f=()=>{u(),i({geospaceFile:null,envFile:null})};c(l`
        ...
        `,a)})}var N=({commandRegistry:e})=>{e.registerAll({command:{id:`build_map`,name:`Build map`,description:`Builds a publishable map from a .geospace file`,parameters:[{name:`file`,description:`Path to the .geospace file relative to workspace root. If not provided, uses the active map editor or selected file.`,required:!1},{name:`env`,description:`Path to the environment file relative to workspace root (e.g., 'dev.env', 'prod.env'). Defaults to '.env' if not specified.`,required:!1},{name:`ask`,description:`If true, prompts for missing files (map file or env file) when not provided.`,required:!1}]},handler:{execute:async e=>{let t=e.params?.env,o=e.params?.file,c=e.params?.ask===!0||e.params?.ask===`true`,l=await d.getWorkspace();if(!l){i(`No workspace available`);return}let u;if(o){let e=await l.getResource(o);if(!e||!(e instanceof f)){i(`File not found: ${o}`);return}if(!e.getName().toLowerCase().endsWith(E)){i(`File is not a .geospace file: ${o}`);return}u=e}else{let e=n.get();if(e&&e.input)e.isDirty()&&(await e.save(),a(`Map saved automatically to run build.`)),u=e.input.data;else{let e=s.get();e instanceof f&&e.getName().toLowerCase().endsWith(E)&&(u=e)}}if(c&&(!u||!t)){let e=[],n=[];await r.runAsync(`Collecting files`,async t=>{t.message=`Scanning workspace for .geospace files...`,e=await A(l,E,t,{value:0}),t.message=`Scanning workspace for .env files...`,t.currentStep=0,n=await A(l,D,t,{value:0}),t.message=`Found ${e.length} .geospace files and ${n.length} .env files`});let a=u?.getWorkspacePath(),s=await M(e,n,a,t||`.env`);if(s.geospaceFile===null&&s.envFile===null)return;if(s.geospaceFile&&!u){o=s.geospaceFile;let e=await l.getResource(o);if(!e||!(e instanceof f)){i(`File not found: ${o}`);return}if(!e.getName().toLowerCase().endsWith(E)){i(`File is not a .geospace file: ${o}`);return}u=e}s.envFile!==null&&(t=s.envFile||`.env`)}else if(!u){i(`No map editor active, no .geospace file selected, and no file path provided`);return}if(!u){i(`No map file available`);return}return T.buildMapFile(u,t)}},contribution:{target:`mapeditor.toolbar.misc`,icon:`hammer`,label:`Build map`,disabled:()=>!(n.get()instanceof _)}}),o.registerContribution(`contextmenu:filebrowser`,{command:`build_map`,icon:`hammer`,label:`Build map`,params:{ask:!0},disabled:()=>{let e=s.get();return e instanceof f?!e.getName().toLowerCase().endsWith(E):!0}})};export{N as default};