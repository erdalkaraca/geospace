const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/python-editor-BDx_xCVN-VirpkTqa.js","assets/repeat-Duk-1tMZ.js","assets/config-RT97oKMn-ocVRH-Jd.js","assets/config-RT97oKMn-bj3odw9V.css","assets/pyservice-CXj6dvu6-D9HS5RJt.js","assets/package-manager-DTcpwrMr-DtrihrKx.js","assets/index-61uDgnsK.js","assets/notebook-kernel-api--RBL5TaE-2imfStcI.js"])))=>i.map(i=>d[i]);
import{b as h,_ as y}from"./repeat-Duk-1tMZ.js";import{c as g,b as l,t as u,f,F as m,w as v}from"./config-RT97oKMn-ocVRH-Jd.js";import"./index-61uDgnsK.js";import{P as s}from"./pyservice-CXj6dvu6-D9HS5RJt.js";import{p as c}from"./package-manager-DTcpwrMr-DtrihrKx.js";import{T as P}from"./notebook-kernel-api--RBL5TaE-2imfStcI.js";class _{constructor(){this.id="python",this.label="Python",this.language="python",this.pyenv=null,this.requiredPackages=[]}async connect(t){if(this.pyenv)return;this.requiredPackages=t?.requiredPackages??[],this.pyenv=new s;const e=await v.getWorkspace();await this.pyenv.init(e),this.requiredPackages.length>0&&await this.pyenv.loadPackages(this.requiredPackages);try{await this.pyenv.execCode(`
try:
    import matplotlib
    matplotlib.use('agg')
