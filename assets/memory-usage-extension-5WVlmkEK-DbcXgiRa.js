import{q as c,aA as o,a0 as d,am as m,x as l}from"./index-BgkfMran.js";import"./preload-helper-WQhrSmCl.js";import"./chunk.LTSJC6DR-BCCP1Gxs.js";var u=Object.getOwnPropertyDescriptor,g=(e,s,i,a)=>{for(var t=a>1?void 0:a?u(s,i):s,n=e.length-1,r;n>=0;n--)(r=e[n])&&(t=r(t)||t);return t};let p=class extends m{constructor(){super(...arguments),this.updateInterval=null}connectedCallback(){super.connectedCallback(),this.updateInterval=window.setInterval(()=>{this.requestUpdate()},2e3)}disconnectedCallback(){super.disconnectedCallback(),this.updateInterval!==null&&(clearInterval(this.updateInterval),this.updateInterval=null)}render(){const e=performance.memory;if(!e)return l``;const s=(e.usedJSHeapSize/1048576).toFixed(1),i=(e.jsHeapSizeLimit/1048576).toFixed(0),a=e.usedJSHeapSize/e.jsHeapSizeLimit*100,t=a.toFixed(0),n=a>80?"#ff4444":a>60?"#ffaa00":"#44aa44";return l`
        ...
        `}};p=g([d("k-memory-usage")],p);c.registerContribution(o,{target:o,label:"Memory",disabled:()=>!performance.memory,html:"<k-memory-usage></k-memory-usage>"});
