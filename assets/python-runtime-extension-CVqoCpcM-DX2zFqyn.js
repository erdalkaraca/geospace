const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/python-editor-BDx_xCVN-DkuiEEHH.js","assets/repeat-Duk-1tMZ.js","assets/config-BnnWtrGw-CtyKT0bq.js","assets/config-BnnWtrGw-bj3odw9V.css","assets/pyservice-CXj6dvu6-B4wEdVUl.js","assets/package-manager-DTcpwrMr-D_b_nLAc.js","assets/index-C7fLYY0Y.js","assets/notebook-kernel-api--RBL5TaE-2imfStcI.js"])))=>i.map(i=>d[i]);
import{b as h,_ as y}from"./repeat-Duk-1tMZ.js";import{c as g,b as l,t as u,f,F as m,w as v}from"./config-BnnWtrGw-CtyKT0bq.js";import"./index-C7fLYY0Y.js";import{P as s}from"./pyservice-CXj6dvu6-B4wEdVUl.js";import{p as c}from"./package-manager-DTcpwrMr-D_b_nLAc.js";import{T as P}from"./notebook-kernel-api--RBL5TaE-2imfStcI.js";class _{constructor(){this.id="python",this.label="Python",this.language="python",this.pyenv=null,this.requiredPackages=[]}async connect(t){if(this.pyenv)return;this.requiredPackages=t?.requiredPackages??[],this.pyenv=new s;const e=await v.getWorkspace();await this.pyenv.init(e),this.requiredPackages.length>0&&await this.pyenv.loadPackages(this.requiredPackages);try{await this.pyenv.execCode(`
try:
    import matplotlib
    matplotlib.use('agg')
