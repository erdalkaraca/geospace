const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-CxIJLZi0.js","assets/index-C4bFKT08.js","assets/index-C2t38aP0.css","assets/main-Bk6wZs2B.css"])))=>i.map(i=>d[i]);
import{o as Q,p as B,k as F,J as Y,L as X,K as Z,j as R,c as M,v as D,b as ee,u as te,t as se,r as ae}from"./main-CxIJLZi0.js";import{a as k,n as g,r as T,i as _,x as n,l as p,o as ie,t as I,ab as re,_ as L}from"./index-C4bFKT08.js";var oe=Object.defineProperty,ne=Object.getOwnPropertyDescriptor,z=(s,e,a,t)=>{for(var i=t>1?void 0:t?ne(e,a):e,o=s.length-1,r;o>=0;o--)(r=s[o])&&(i=(t?r(e,a,i):r(i))||i);return t&&i&&oe(e,a,i),i};let C=class extends _{constructor(){super(...arguments),this.isStreaming=!1,this.showHeader=!0,this.attentionInputValue=""}formatTimestamp(){return new Date().toLocaleTimeString()}copyToClipboard(s){navigator.clipboard.writeText(s).catch(e=>{console.error("Failed to copy:",e)})}processMarkdownContent(s){return s.includes("code-block-wrapper")?s:s.replace(/<pre><code([^>]*)>([\s\S]*?)<\/code><\/pre>/gi,(e,a,t)=>`<div class="code-block-wrapper">
    ...
    `;z([g({type:Object,attribute:!1})],C.prototype,"message",2);z([g({type:Boolean})],C.prototype,"isStreaming",2);z([g({type:Boolean})],C.prototype,"showHeader",2);z([g({type:Number,attribute:!1})],C.prototype,"messageIndex",2);z([T()],C.prototype,"attentionInputValue",2);C=z([I("ai-chat-message")],C);var le=Object.defineProperty,ce=Object.getOwnPropertyDescriptor,U=(s,e,a,t)=>{for(var i=t>1?void 0:t?ce(e,a):e,o=s.length-1,r;o>=0;o--)(r=s[o])&&(i=(t?r(e,a,i):r(i))||i);return t&&i&&le(e,a,i),i};let P=class extends _{constructor(){super(...arguments),this.value="",this.disabled=!1,this.busy=!1,this.hasProvider=!0}onInput(s){const e=s.target;this.value=e.value,this.dispatchEvent(new CustomEvent("input-change",{detail:{value:this.value},bubbles:!0,composed:!0}))}onKeyDown(s){s.key==="Enter"&&!s.shiftKey&&(s.preventDefault(),this.send())}async send(){if(!this.value.trim()||this.disabled||!this.hasProvider)return;const s=this.value;this.value="",this.requestUpdate(),await this.updateComplete,this.textareaElement&&(this.textareaElement.value="",this.textareaElement.focus()),this.dispatchEvent(new CustomEvent("send",{detail:{value:s},bubbles:!0,composed:!0}))}cancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}openSettings(){this.dispatchEvent(new CustomEvent("open-settings",{bubbles:!0,composed:!0}))}render(){return n`
    ...
    `;U([g({type:String})],P.prototype,"value",2);U([g({type:Boolean})],P.prototype,"disabled",2);U([g({type:Boolean})],P.prototype,"busy",2);U([g({type:Boolean})],P.prototype,"hasProvider",2);U([re("wa-textarea")],P.prototype,"textareaElement",2);P=U([I("ai-chat-input")],P);var de=Object.defineProperty,pe=Object.getOwnPropertyDescriptor,H=(s,e,a,t)=>{for(var i=t>1?void 0:t?pe(e,a):e,o=s.length-1,r;o>=0;o--)(r=s[o])&&(i=(t?r(e,a,i):r(i))||i);return t&&i&&de(e,a,i),i};let j=class extends _{constructor(){super(...arguments),this.message="No AI provider configured",this.hint="Click the settings button to configure"}render(){return n`
    ...
    `;H([g({type:String})],j.prototype,"message",2);H([g({type:String})],j.prototype,"hint",2);j=H([I("ai-empty-state")],j);var ge=Object.getOwnPropertyDescriptor,ue=(s,e,a,t)=>{for(var i=t>1?void 0:t?ge(e,a):e,o=s.length-1,r;o>=0;o--)(r=s[o])&&(i=r(i)||i);return i};let K=class extends _{render(){return n`
    ...
    `;V([g({type:Object,attribute:!1})],q.prototype,"agentInfo",2);V([g({type:Object,attribute:!1})],q.prototype,"message",2);V([g({type:Boolean})],q.prototype,"isStreaming",2);V([g({type:String})],q.prototype,"groupId",2);q=V([I("ai-agent-response-card")],q);var ve=Object.defineProperty,we=Object.getOwnPropertyDescriptor,J=(s,e,a,t)=>{for(var i=t>1?void 0:t?we(e,a):e,o=s.length-1,r;o>=0;o--)(r=s[o])&&(i=(t?r(e,a,i):r(i))||i);return t&&i&&ve(e,a,i),i};let G=class extends _{handleAction(s){const e=s();e instanceof Promise&&e.catch(a=>{console.error("Action failed:",a)})}render(){if(!this.group)return n``;const s=Array.from(this.group.agents.values()),e=s.filter(l=>l.status==="completed").length,a=s.filter(l=>l.status==="streaming").length,t=s.filter(l=>l.status==="error").length,i=s.length>0&&e+t===s.length,o=s.length===1,r=s.filter(l=>l.message&&l.message.actions&&l.message.actions.length>0).flatMap(l=>l.message.actions.map(c=>({...c,agentRole:l.role,agentLabel:l.label}))).sort((l,c)=>{const m=l.requiresAttention?1:0;return(c.requiresAttention?1:0)-m});return n`
            <div class="agent-response-group">
                ...
                <div class="agent-group-content">
                    ${B(s,l=>l.role,l=>{const c=l.message||(l.status==="streaming"&&this.findStreamingMessage?this.findStreamingMessage(l.role):void 0);return n`
    ...
    `;J([g({type:Object,attribute:!1})],G.prototype,"group",2);J([g({type:Function,attribute:!1})],G.prototype,"findStreamingMessage",2);G=J([I("ai-agent-response-group")],G);var fe=Object.defineProperty,be=Object.getOwnPropertyDescriptor,$=(s,e,a,t)=>{for(var i=t>1?void 0:t?be(e,a):e,o=s.length-1,r;o>=0;o--)(r=s[o])&&(i=(t?r(e,a,i):r(i))||i);return t&&i&&fe(e,a,i),i};let w=class extends _{constructor(){super(...arguments),this.open=!1,this.providers=[],this.selectedProviderName="",this.selectedModel="",this.availableModels=[],this.loadingModels=!1,this.requireToolApproval=!0,this.toolApprovalAllowlist=[],this.availableCommands=[]}onProviderChange(s){const e=s.target;this.selectedProviderName=e.value,this.dispatchEvent(new CustomEvent("provider-change",{detail:{providerName:e.value},bubbles:!0,composed:!0}))}onModelChange(s){const e=s.target;this.selectedModel=e.value,this.dispatchEvent(new CustomEvent("model-change",{detail:{model:e.value},bubbles:!0,composed:!0}))}onToolApprovalChange(s){const e=s.target;this.requireToolApproval=e.checked,this.dispatchEvent(new CustomEvent("tool-approval-change",{detail:{value:e.checked},bubbles:!0,composed:!0}))}onAllowlistChange(s,e){s.target.checked?this.toolApprovalAllowlist.includes(e)||(this.toolApprovalAllowlist=[...this.toolApprovalAllowlist,e]):this.toolApprovalAllowlist=this.toolApprovalAllowlist.filter(t=>t!==e),this.dispatchEvent(new CustomEvent("allowlist-change",{detail:{allowlist:[...this.toolApprovalAllowlist]},bubbles:!0,composed:!0})),this.requestUpdate()}async firstUpdated(){await this.loadAllowedCommands()}async loadAllowedCommands(){if(this.toolApprovalAllowlist.length===0){this.availableCommands=[];return}const{commandRegistry:s}=await L(async()=>{const{commandRegistry:i}=await import("./main-CxIJLZi0.js").then(o=>o.M);return{commandRegistry:i}},__vite__mapDeps([0,1,2,3])),e=s.createExecutionContext(),a=s.listCommands(e),t=Object.values(a);this.availableCommands=this.toolApprovalAllowlist.map(i=>{const o=t.find(r=>r.id===i);return{id:i,name:o?.name||i}}).sort((i,o)=>i.name.localeCompare(o.name))}updated(s){s.has("toolApprovalAllowlist")&&this.loadAllowedCommands()}save(){this.dispatchEvent(new CustomEvent("save",{detail:{providerName:this.selectedProviderName,model:this.selectedModel},bubbles:!0,composed:!0}))}cancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}render(){if(!this.open)return n``;const s=this.providers.find(e=>e.name===this.selectedProviderName);return n`
                    ...
                    ${p(this.requireToolApproval,()=>n`
                        <div class="settings-field">
                            ...
                            <div class="allowlist-container">
                                ${B(this.availableCommands,e=>e.id,e=>n`
            ...
            <div class="chat-container">
                ...
                ${p(s.length>0,()=>n`
                    <wa-tab-group 
                        ...
                        ${B(s,t=>t,(t,i)=>{const o=this.sessionManager.getSession(t);return o?n`
                                <wa-tab panel="${t}">
                    ...
                    ${this.pendingToolApprovals.size>0?n`
                        <div class="tool-approval-section">
                            ${Array.from(this.pendingToolApprovals.entries()).map(([t,i])=>{const o=i.request.toolCalls,r=o.length;o.map(c=>{const m=c.function.arguments||"{}";let u={};try{u=JSON.parse(m)}catch{u={}}const y=Object.entries(u).map(([f,b])=>`${f}=${JSON.stringify(b)}`).join(", ");return`${c.function.name}${y?`(${y})`:"()"}`}).join(", ");const l=`Tool execution pending: ${r} tool${r>1?"s":""} (${o[0]?.function.name}${r>1?", ...":""})`;return n`
                                    <wa-details class="approval-details">
                                        <span slot="summary" class="approval-summary">
                                            ...
                                            <div class="approval-actions-inline">
                                                ...
                                                <wa-button
                                                    ...
                                                    size="small"
                                                    variant="success"
                                                    @click="${async c=>{c.stopPropagation();for(const[m,u]of i.allowListSelections.entries())if(u){const y=i.request.toolCalls.find(f=>f.id===m);if(y){const{ToolExecutor:f}=await L(async()=>{const{ToolExecutor:h}=await import("./main-CxIJLZi0.js").then(v=>v.O);return{ToolExecutor:h}},__vite__mapDeps([0,1,2,3])),b=new f,A=D.createExecutionContext(this),d=b.findCommand(y,A);d&&this.toolApprovalAllowlist.add(d.id)}}i.allowListSelections.size>0&&await this.providerManager.saveSettings(this.providerManager.getSettingsProviderName()||"",this.providerManager.getSettingsModel()||"",this.requireToolApproval,Array.from(this.toolApprovalAllowlist)),i.resolve(!0),this.pendingToolApprovals.delete(t),this.requestUpdate()}}">
                                        ...
                                        <div class="approval-content">
                                            <div class="approval-message">
                                                ...
                                                <ul class="tool-list">
                                                    ${o.map(c=>{const m=c.function.arguments||"{}";let u={};try{u=JSON.parse(m)}catch{u={}}const y=Object.entries(u).length>0?`(${Object.entries(u).map(([b,A])=>`${b}=${JSON.stringify(A)}`).join(", ")})`:"()",f=i.allowListSelections.get(c.id)||!1;return n`
                                                            <li class="tool-list-item">
                                                                <label class="tool-item-label">
                                                                    <wa-checkbox
                                                                        ?checked="${f}"
                                                                        @change="${b=>{const A=b.target.checked;i.allowListSelections.set(c.id,A),this.requestUpdate()}}">
                                                                    </wa-checkbox>
                                                                    <span>Always allow</span>
                                                                </label>
                                                                <code>${c.function.name}${y}</code>
                                                            </li>
                                                        `})}
                                                </ul>
                                            </div>
    ...
    `;E([T()],x.prototype,"busy",2);E([T()],x.prototype,"inputValue",2);E([T()],x.prototype,"settingsDialogOpen",2);E([T()],x.prototype,"requireToolApproval",2);E([T()],x.prototype,"pendingToolApprovals",2);E([Y(X)],x.prototype,"onAIConfigChanged",1);x=E([I("k-aiview")],x);const Ie=({})=>{ae.put("aiService",R)};export{Ie as default};
