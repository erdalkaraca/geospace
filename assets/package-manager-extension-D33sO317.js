import{s as d,J as m,x as i,O as h,u as k,y as g,z as l,A as u}from"./index-BPuo-xLZ.js";import{r as f}from"./geospace-app-DOqKRYZp.js";import"./preload-helper-WQhrSmCl.js";var y=Object.defineProperty,v=Object.getOwnPropertyDescriptor,o=(a,e,r,s)=>{for(var n=s>1?void 0:s?v(e,r):e,c=a.length-1,p;c>=0;c--)(p=a[c])&&(n=(s?p(e,r,n):p(n))||n);return s&&n&&y(e,r,n),n};let t=class extends d{constructor(){super(...arguments),this.open=!1,this.packages=[],this.loadingPackages=!1}configure(a){this.packages=a.packages||[],this.pyenv=a.pyenv,this.onPackageAdded=a.onPackageAdded,this.onPackageRemoved=a.onPackageRemoved}show(){this.open=!0}hide(){this.open=!1}addPackage(a){if(!a||a.trim()==="")return;const e=a.trim();this.packages.includes(e)||(this.packages=[...this.packages,e],this.onPackageAdded?.(e))}removePackage(a){this.packages.indexOf(a)>-1&&(this.packages=this.packages.filter(r=>r!==a),this.onPackageRemoved?.(a))}async reloadPackages(){if(this.pyenv){this.loadingPackages=!0,this.packageLoadError=void 0;try{await this.pyenv.loadPackages(this.packages)}catch(a){this.packageLoadError=String(a)}finally{this.loadingPackages=!1}}}render(){let a;return i`
    ...
    `;o([g({type:Boolean})],t.prototype,"open",2);o([g({type:Array})],t.prototype,"packages",2);o([g({attribute:!1})],t.prototype,"pyenv",2);o([l()],t.prototype,"loadingPackages",2);o([l()],t.prototype,"packageLoadError",2);t=o([u("k-python-package-manager")],t);class w{showPackageManager(e){return this.managerInstance||(this.managerInstance=document.createElement("k-python-package-manager"),document.body.appendChild(this.managerInstance)),this.managerInstance.configure(e),this.managerInstance.show(),this.managerInstance}getManager(){return this.managerInstance}}const P=new w,E=({})=>{f.put("pythonPackageManagerService",P)};export{t as KPythonPackageManager,E as default,P as pythonPackageManagerService};
