const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BgkfMran.js","assets/preload-helper-WQhrSmCl.js","assets/chunk.LTSJC6DR-BCCP1Gxs.js","assets/index-aP6FMjSZ.css"])))=>i.map(i=>d[i]);
import{w as Xe,ad as pt,T as mt,P as Pe,az as Jt,aB as gt,M as ct,u as Ne,a5 as ut,q as qt,x as qe,aE as ft}from"./index-BgkfMran.js";import{l as Ht,G as Yt}from"./geospace-app-Dl26UnuM.js";import{_ as oe,g as Xt}from"./preload-helper-WQhrSmCl.js";import"./chunk.LTSJC6DR-BCCP1Gxs.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";function Kt(A,E){for(var D=0;D<E.length;D++){const S=E[D];if(typeof S!="string"&&!Array.isArray(S)){for(const I in S)if(I!=="default"&&!(I in A)){const k=Object.getOwnPropertyDescriptor(S,I);k&&Object.defineProperty(A,I,k.get?k:{enumerable:!0,get:()=>S[I]})}}}return Object.freeze(Object.defineProperty(A,Symbol.toStringTag,{value:"Module"}))}function Qt(A){const D=[...A.gsMap.controls||[],...A.gsMap.overlays||[]].map(k=>k.src).filter(k=>k),S=D.map((k,F)=>{const L=k.replace(/`/g,"\\`").replace(/\$/g,"\\$");return`import script${F} from '${L}'`}),I=D.map((k,F)=>`${JSON.stringify(k)}: script${F}`).join(`,
        `);return`
