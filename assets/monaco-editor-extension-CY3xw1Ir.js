import{U as p,e as u,s as m}from"./editor.main-DU6ZLs7V.js";import{l as f,x as i,b as y,z as v,q as g,F as w,a as k,n as l,c as h,t as x}from"./index-C1DvjuJF.js";import{e as W,k as C,P as E,j as $}from"./main-Ci7DRhcV.js";function j(e){return new Worker("/assets/editor.worker-BKDaejSB.js",{type:"module",name:e==null?void 0:e.name})}function R(e){return new Worker("/assets/json.worker-bnpFxRku.js",{type:"module",name:e==null?void 0:e.name})}function b(e){return new Worker("/assets/css.worker-BAVIDzD3.js",{type:"module",name:e==null?void 0:e.name})}function D(e){return new Worker("/assets/html.worker-De8bSgst.js",{type:"module",name:e==null?void 0:e.name})}function I(e){return new Worker("/assets/ts.worker-8yPRNxAu.js",{type:"module",name:e==null?void 0:e.name})}var L=Object.defineProperty,O=Object.getOwnPropertyDescriptor,o=(e,t,r,s)=>{for(var n=s>1?void 0:s?O(t,r):t,c=e.length-1,d;c>=0;c--)(d=e[c])&&(n=(s?d(t,r,n):d(n))||n);return s&&n&&L(t,r,n),n};self.MonacoEnvironment={getWorker(e,t){return t==="json"?new R:t==="css"||t==="scss"||t==="less"?new b:t==="html"||t==="handlebars"||t==="razor"?new D:t==="typescript"||t==="javascript"?new I:new j}};$.registerEditorInputHandler({canHandle:e=>e instanceof w,handle:async e=>{const t={title:e.getName(),data:e,key:e.getName(),icon:"file-pen",noOverflow:!1,state:{}};return t.widgetFactory=()=>i`
            <k-monaco-editor .input=${t}></k-monaco-editor>`,t}});let a=class extends W{constructor(){super(...arguments),this.readOnly=!1,this.editorRef=f(),this.canExecute=!1,this.chatContext={history:[]}}doBeforeUI(){const e=this.input.data;this.canExecute=e.getName().endsWith(".py")}updated(e){super.updated(e),(e.has("canExecute")||e.has("pyenv"))&&this.updateToolbar()}async doInitUI(){const e=this.input.data,t=await e.getContents(),r=this.editorRef.value,s=p.file(e.getName());this.model=u.createModel(t,void 0,s),this.editor=u.create(r,{theme:"vs-dark",automaticLayout:!1}),this.model.onDidChangeContent(n=>{this.readOnly||this.markDirty(!0)}),this.editor.setModel(this.model)}getEditor(){return this.editor}save(){var t;const e=this.model.getValue();(t=this.input)==null||t.data.saveContents(e),this.markDirty(!1)}doClose(){var e,t,r;(e=this.model)==null||e.dispose(),(t=this.editor)==null||t.dispose(),this.model=void 0,this.editor=void 0,(r=this.pyenv)==null||r.close(),this.pyenv=void 0}async onRunCode(){var e;this.canExecute&&(this.pyenv||await this.toggleConnection(),(e=this.pyenv)==null||e.execCode(this.model.getValue()))}getLanguage(){var e;return(e=this.model.getLanguageId())==null?void 0:e.toLowerCase()}renderToolbar(){return this.canExecute?i`
    ...
    `;o([l({attribute:!1})],a.prototype,"input",2);o([l()],a.prototype,"readOnly",2);o([h()],a.prototype,"canExecute",2);o([h()],a.prototype,"pyenv",2);a=o([x("k-monaco-editor")],a);export{a as KMonacoEditor};
