import{x as d,E as x,w as _,H as $,J as E,N as A,u as S,y as M,z as u,A as O}from"./index-BMTNPmID.js";import{F as R,f as b,m as P,P as z,w as D,n as I}from"./geospace-app-CEA0mcDY.js";import{e as k,s as T}from"./editor.main-ChA2hgQD.js";import{pythonPackageManagerService as q}from"./package-manager-extension-DWiw1Kbi.js";import"./preload-helper-WQhrSmCl.js";import"./chunk.LTSJC6DR-BTS7fm5P.js";import"./chunk.RRCUZAZD-5O78oK5S.js";var F=Object.defineProperty,H=Object.getOwnPropertyDescriptor,h=(e,t,o,a)=>{for(var i=a>1?void 0:a?H(t,o):t,l=e.length-1,s;l>=0;l--)(s=e[l])&&(i=(a?s(t,o,i):s(i))||i);return a&&i&&F(t,o,i),i};let p=class extends P{constructor(){super(...arguments),this.cellOutputs=new Map,this.executingCells=new Set,this.pyConnected=!1,this.pyConnecting=!1,this.editingMarkdownCells=new Set,this.executionCounter=0,this.isRunningAll=!1,this.highlightedCellIndex=-1,this.focusedCellIndex=-1,this.cancelRunAll=!1,this.monacoEditors=new Map,this.cellRefs=new Map}doClose(){this.input=void 0,this.notebook=void 0,this.cellOutputs.clear(),this.executingCells.clear(),this.monacoEditors.forEach(e=>e.dispose()),this.monacoEditors.clear(),this.cellRefs.clear(),this.focusedCellIndex=-1,this.themeObserver&&(this.themeObserver.disconnect(),this.themeObserver=void 0),this.pyenv&&(this.pyenv.close(),this.pyenv=void 0),this.pyConnected=!1,this.pyVersion=void 0}async save(){if(!(!this.notebook||!this.input))try{this.saveEditorContents(),this.notebook.cells.forEach((o,a)=>{if(o.cell_type==="code"){const i=this.cellOutputs.get(a);o.outputs=i?this.convertOutputToJupyter(i,o.execution_count):[]}});const e=JSON.stringify(this.notebook,null,2);await this.input.data.saveContents(e),this.markDirty(!1)}catch(e){throw console.error("Failed to save notebook:",e),e}}doBeforeUI(){this.loadNotebook()}renderToolbar(){const e=this.pyConnecting?"Connecting to Python...":this.pyConnected?"Python Connected":"Python Disconnected - Click to connect",t=this.pyConnecting?"Connecting...":this.pyConnected&&this.pyVersion?`Python ${this.pyVersion}`:"Not connected",o=this.pyConnected?"var(--wa-color-green-40)":this.pyConnecting?"var(--wa-color-warning-500)":"var(--wa-color-red-40)",a=this.isRunningAll?d`
...
Failed to parse notebook file.`]}]}}if(this.notebook?.cells){const o=this.notebook.cells.filter(a=>a.cell_type==="code").map(a=>a.execution_count??0).reduce((a,i)=>Math.max(a,i),0);this.executionCounter=o,this.notebook.cells.forEach((a,i)=>{if(a.cell_type==="code"&&a.outputs&&a.outputs.length>0){const l=this.convertOutputFromJupyter(a.outputs[0]);l&&this.cellOutputs.set(i,l)}})}}setupThemeObserver(){const e=document.documentElement;let t=this.getMonacoTheme();this.themeObserver=new MutationObserver(()=>{const o=this.getMonacoTheme();o!==t&&(t=o,k.setTheme(o))}),this.themeObserver.observe(e,{attributes:!0,attributeFilter:["class"]})}getCellSource(e){return Array.isArray(e.source)?e.source.join(""):e.source}convertOutputToJupyter(e,t){if(e.type==="execute_result"){const o={};return e.imageData&&(o["image/png"]=e.imageData),e.data&&(o["text/plain"]=e.data),[{output_type:"execute_result",data:o,execution_count:t,metadata:{}}]}else if(e.type==="error")return[{output_type:"error",ename:"Error",evalue:e.data,traceback:[e.data]}];return[]}convertOutputFromJupyter(e){return e.output_type==="execute_result"&&e.data?{type:"execute_result",data:e.data["text/plain"]||"",imageData:e.data["image/png"]||void 0}:e.output_type==="error"?{type:"error",data:e.evalue||e.traceback?.join(`
...
`):void 0,imageData:s}),this.executionCounter++,t.execution_count=this.executionCounter,this.markDirty(!0)}catch(o){this.executingCells.has(e)&&this.cellOutputs.set(e,{type:"error",data:String(o)})}finally{this.executingCells.delete(e),this.requestUpdate()}}}async cancelExecution(e){if(this.pyenv)if(this.pyenv.canInterrupt())this.pyenv.interrupt();else{this.cellOutputs.set(e,{type:"error",data:"Execution cancelled by user (worker terminated - SharedArrayBuffer not available for graceful interrupt)"}),this.executingCells.delete(e),this.pyenv.close(),this.pyenv=void 0,this.pyConnected=!1,this.pyVersion=void 0;try{await this.initPyodide()}catch(t){console.error("Failed to reinitialize Python after cancellation:",t)}this.requestUpdate()}}clearAllOutputs(){this.cellOutputs.clear(),this.executionCounter=0,this.notebook?.cells&&this.notebook.cells.forEach(e=>{e.cell_type==="code"&&(e.execution_count=null,e.outputs=[])}),this.markDirty(!0),this.requestUpdate()}async restartKernel(){if(!(!this.pyenv||this.pyConnecting))try{this.pyConnecting=!0,this.pyenv.close(),this.pyenv=void 0,this.pyConnected=!1,this.pyVersion=void 0,this.requestUpdate(),await this.initPyodide(),this.requestUpdate()}catch(e){console.error("Failed to restart kernel:",e)}finally{this.pyConnecting=!1}}async runAllCells(){if(this.notebook?.cells){this.isRunningAll=!0,this.cancelRunAll=!1,this.requestUpdate();try{for(let e=0;e<this.notebook.cells.length&&!this.cancelRunAll;e++)this.notebook.cells[e].cell_type==="code"&&await this.executeCell(e)}finally{this.isRunningAll=!1,this.cancelRunAll=!1,this.requestUpdate()}}}cancelAllCells(){this.cancelRunAll=!0}toggleMarkdownEdit(e){this.editingMarkdownCells.has(e)?this.editingMarkdownCells.delete(e):this.editingMarkdownCells.add(e),this.requestUpdate()}saveMarkdownEdit(e,t){const a=t.target.value;if(this.notebook&&this.notebook.cells[e]){const i=this.notebook.cells[e],l=this.getCellSource(i);i.source=this.stringToSourceArray(a),l!==a&&this.markDirty(!0)}this.editingMarkdownCells.delete(e),this.requestUpdate()}renderMarkdownCell(e,t){const o=this.getCellSource(e),a=!o||o.trim()==="";if(this.editingMarkdownCells.has(t)){const n=d`
        ...
        `;return d`
            <div class="cell-wrapper">
                <wa-animation 
                    ...
                    ?play=${this.highlightedCellIndex===t}
                    @wa-finish=${()=>this.highlightedCellIndex=-1}>
                    <div class="cell markdown-cell ${a?"empty":""}" @dblclick=${()=>this.toggleMarkdownEdit(t)}>
                        <div class="cell-header">
        ...
        `}renderCodeCell(e,t){const o=this.cellOutputs.get(t),a=this.executingCells.has(t);this.cellRefs.has(t)||this.cellRefs.set(t,$());const i=this.cellRefs.get(t),l=a?d`
            <wa-button 
                size="small" 
                appearance="plain"
        ...
        `;return d`
            <div class="cell-wrapper">
                <wa-animation 
                    ...
                    ?play=${this.highlightedCellIndex===t}
                    @wa-finish=${()=>this.highlightedCellIndex=-1}>
                    <div class="cell code-cell ${a?"executing":""}">
                        <div class="cell-header">
                            <span class="cell-label">
                                ${a?d`
                                    In [<wa-animation name="pulse" duration="1000" iterations="Infinity" ?play=${a}>
                        ...
                        <div class="cell-input monaco-container" ${E(i)} data-cell-index="${t}"></div>
                        ${o?d`
                            <div class="cell-output ${o.type==="error"?"output-error":""}">
                                ...
                                `:""}
                                ${o.data?d`<pre><code>${o.data}</code></pre>`:""}
                            </div>
                        `:""}
                        ${this.renderFooterActions(t)}
                    </div>
        ...
        `}renderCell(e,t){if(e.cell_type==="markdown")return this.renderMarkdownCell(e,t);if(e.cell_type==="code")return this.renderCodeCell(e,t);{const o=this.getCellSource(e);return d`
                <div class="cell raw-cell">
                    <pre><code>${o}</code></pre>
                </div>
            `}}async connectPython(){if(!(this.pyConnecting||this.pyConnected))try{this.pyConnecting=!0,await this.initPyodide()}catch(e){console.error("Failed to initialize Pyodide:",e)}finally{this.pyConnecting=!1}}addCell(e,t="code"){this.notebook&&(this.saveEditorContents(),this.shiftIndices(e,"up"),this.notebook.cells.splice(e,0,this.createCell(t)),t==="markdown"&&this.editingMarkdownCells.add(e),this.resetCellState(),this.highlightedCellIndex=e,this.updateComplete.then(()=>{this.scrollToCell(e)}))}scrollToCell(e){const t=this.shadowRoot?.querySelectorAll(".cell-wrapper")[e];if(!t)return;const o=this.closest("wa-scroller");if(!o){t.scrollIntoView({behavior:"smooth",block:"center",inline:"nearest"});return}const a=o.getBoundingClientRect(),i=t.getBoundingClientRect(),s=o.scrollTop+(i.top-a.top)-a.height/2+i.height/2;o.scrollTo({top:s,behavior:"smooth"})}saveEditorContents(){this.monacoEditors.forEach((e,t)=>{const o=this.notebook.cells[t];o&&o.cell_type==="code"&&(o.source=this.stringToSourceArray(e.getValue()))})}resetCellState(){this.monacoEditors.forEach(e=>e.dispose()),this.monacoEditors.clear(),this.cellRefs.clear(),this.markDirty(!0)}deleteCell(e){!this.notebook||this.notebook.cells.length<=1||(this.saveEditorContents(),this.cellOutputs.delete(e),this.executingCells.delete(e),this.editingMarkdownCells.delete(e),this.notebook.cells.splice(e,1),this.shiftIndices(e,"down"),this.resetCellState())}shiftIndices(e,t){const o=t==="up"?1:-1,a=t==="up"?n=>n>=e:n=>n>e,i=t==="up"?(n,c)=>c-n:(n,c)=>n-c,l=n=>{Array.from(n.keys()).filter(a).sort(i).forEach(r=>{const m=n.get(r);n.delete(r),n.set(r+o,m)})},s=n=>{Array.from(n).filter(a).sort(i).forEach(r=>{n.delete(r),n.add(r+o)})};l(this.cellOutputs),s(this.executingCells),s(this.editingMarkdownCells)}initializeMonacoEditor(e,t,o){const a=this.getCellSource(t),i=a.split(`
`).length,l=19,s=10,n=100,c=Math.max(n,i*l+s);e.style.height=`${c}px`;const r=k.create(e,{value:a,language:"python",theme:this.getMonacoTheme(),minimap:{enabled:!1},scrollBeyondLastLine:!1,lineNumbers:"on",renderLineHighlight:"all",automaticLayout:!0,fontSize:14,tabSize:4,wordWrap:"on"});let m=!1;r.onDidFocusEditorText(()=>{m=!0,this.focusedCellIndex=o}),r.onDidBlurEditorText(()=>{m=!1,this.focusedCellIndex===o&&(this.focusedCellIndex=-1)}),e.addEventListener("wheel",g=>{if(!m){const y=r.getScrollTop(),f=r.getScrollHeight(),w=r.getContentHeight(),v=f>w,C=g.deltaY<0&&y<=0||g.deltaY>0&&y+w>=f;(!v||C)&&g.stopImmediatePropagation()}},{passive:!0,capture:!0}),r.onDidContentSizeChange(()=>{const g=r.getContentHeight();e.style.height=`${Math.max(n,g+s)}px`,r.layout()}),r.onDidChangeModelContent(()=>{const g=r.getValue(),y=this.getCellSource(t);g!==y&&this.markDirty(!0)}),this.monacoEditors.set(o,r)}getMonacoTheme(){const e=document.documentElement;return e.classList.contains("wa-dark")?"vs-dark":e.classList.contains("wa-light")?"vs":"vs-dark"}openPackageManager(){const e=this.notebook?.metadata?.required_packages||[];q.showPackageManager({packages:e,pyenv:this.pyenv,onPackageAdded:t=>{this.notebook&&(this.notebook.metadata||(this.notebook.metadata={}),this.notebook.metadata.required_packages||(this.notebook.metadata.required_packages=[]),this.notebook.metadata.required_packages.includes(t)||(this.notebook.metadata.required_packages.push(t),this.markDirty(!0)))},onPackageRemoved:t=>{if(!this.notebook?.metadata?.required_packages)return;const o=this.notebook.metadata.required_packages.indexOf(t);o>-1&&(this.notebook.metadata.required_packages.splice(o,1),this.markDirty(!0))}})}updated(e){super.updated(e),(e.has("pyConnected")||e.has("pyConnecting")||e.has("pyVersion")||e.has("isRunningAll"))&&this.updateToolbar(),this.notebook?.cells&&this.notebook.cells.forEach((t,o)=>{if(t.cell_type==="code"){const a=this.cellRefs.get(o);a?.value&&!this.monacoEditors.has(o)&&this.initializeMonacoEditor(a.value,t,o)}})}render(){return this.notebook?d`
            <style>
                ${T}
            </style>
        ...
        `:d`<div class="loading">Loading notebook...</div>`}};p.styles=S`
        :host {
            display: block;
            width: 100%;
        }
    ...
    `;h([M({attribute:!1})],p.prototype,"input",2);h([u()],p.prototype,"notebook",2);h([u()],p.prototype,"cellOutputs",2);h([u()],p.prototype,"executingCells",2);h([u()],p.prototype,"pyenv",2);h([u()],p.prototype,"pyConnected",2);h([u()],p.prototype,"pyConnecting",2);h([u()],p.prototype,"pyVersion",2);h([u()],p.prototype,"editingMarkdownCells",2);h([u()],p.prototype,"executionCounter",2);h([u()],p.prototype,"isRunningAll",2);h([u()],p.prototype,"highlightedCellIndex",2);p=h([O("k-notebook-editor")],p);const K=({editorRegistry:e,commandRegistry:t,contributionRegistry:o})=>{e.registerEditorInputHandler({canHandle:i=>i instanceof R&&i.getName().toLowerCase().endsWith(".ipynb"),handle:async i=>{const l={title:i.getName(),data:i,key:i.getName(),editorId:"notebook-editor",icon:"k jupyter",noOverflow:!0,state:{}};return l.widgetFactory=()=>d`
                <k-notebook-editor .input=${l}></k-notebook-editor>`,l},ranking:100}),t.registerHandler("run_python",{canExecute:i=>{const l=b.get();if(l instanceof p){const s=i.params?.cellIndex;return s!==void 0?s>=0&&s<(l.notebook?.cells.length??0):l.focusedCellIndex>=0}return!1},execute:async i=>{const l=b.get();if(l instanceof p){const s=i.params?.cellIndex??l.focusedCellIndex;s>=0&&await l.executeCell(s)}}});const a=JSON.stringify({cells:[{cell_type:"markdown",source:["Press the **Run** button in the code cell below to execute it."],metadata:{}},{cell_type:"code",source:['print("Hello, World!")'],execution_count:null,outputs:[],metadata:{}}],metadata:{},nbformat:4,nbformat_minor:4},null,2);o.registerContribution("filebrowser.create",{label:"Jupyter Notebook",icon:"k jupyter",command:"create_file",params:{path:"notebook.ipynb",extension:".ipynb",ask:!0,contents:a}})};export{p as KNotebookEditor,K as default};
