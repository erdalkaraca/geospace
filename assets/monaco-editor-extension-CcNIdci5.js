import{U as m,e as h,s as f}from"./editor.main-CIIfPI4g.js";import{j as k,o as y,y as g,P as w,w as v,x as P,F as C,n as p,d as u,e as x}from"./main-DJJFELAT.js";import{j as W,x as l,k as q,h as $}from"./index-CGmBFeLm.js";import{pythonPackageManagerService as j}from"./package-manager-extension-C7SxbZWu.js";function E(e){return new Worker("/assets/editor.worker-qXNJQzUK.js",{type:"module",name:e==null?void 0:e.name})}function I(e){return new Worker("/assets/json.worker-BQ7VPioS.js",{type:"module",name:e==null?void 0:e.name})}function b(e){return new Worker("/assets/css.worker-DeeK5MWe.js",{type:"module",name:e==null?void 0:e.name})}function M(e){return new Worker("/assets/html.worker-CK9sgbOp.js",{type:"module",name:e==null?void 0:e.name})}function R(e){return new Worker("/assets/ts.worker-BTcyiMLZ.js",{type:"module",name:e==null?void 0:e.name})}var L=Object.defineProperty,O=Object.getOwnPropertyDescriptor,d=(e,t,n,r)=>{for(var a=r>1?void 0:r?O(t,n):t,s=e.length-1,o;s>=0;s--)(o=e[s])&&(a=(r?o(t,n,a):o(a))||a);return r&&a&&L(t,n,a),a};self.MonacoEnvironment={getWorker(e,t){return t==="json"?new I:t==="css"||t==="scss"||t==="less"?new b:t==="html"||t==="handlebars"||t==="razor"?new M:t==="typescript"||t==="javascript"?new R:new E}};P.registerEditorInputHandler({canHandle:e=>e instanceof C,handle:async e=>{const t={title:e.getName(),data:e,key:e.getName(),editorId:"monaco-editor",icon:"file-pen",noOverflow:!1,state:{}};return t.widgetFactory=()=>l`
            <k-monaco-editor .input=${t}></k-monaco-editor>`,t}});let i=class extends k{constructor(){super(...arguments),this.readOnly=!1,this.editorRef=W(),this.canExecute=!1,this.requiredPackages=[],this.chatContext={history:[]}}doBeforeUI(){const e=this.input.data;this.canExecute=e.getName().endsWith(".py")}updated(e){super.updated(e),(e.has("canExecute")||e.has("pyenv"))&&this.updateToolbar()}async doInitUI(){const e=this.input.data,t=await e.getContents(),n=this.editorRef.value,r=m.file(e.getName());this.model=h.createModel(t,void 0,r),this.editor=h.create(n,{theme:"vs-dark",automaticLayout:!1}),this.model.onDidChangeContent(a=>{this.readOnly||this.markDirty(!0)}),this.editor.setModel(this.model),this.canExecute&&(this.requiredPackages=this.parsePackagesFromContent(t))}getEditor(){return this.editor}save(){var t;const e=this.model.getValue();(t=this.input)==null||t.data.saveContents(e),this.markDirty(!1)}doClose(){var e,t,n;(e=this.model)==null||e.dispose(),(t=this.editor)==null||t.dispose(),this.model=void 0,this.editor=void 0,(n=this.pyenv)==null||n.close(),this.pyenv=void 0}async onRunCode(){var e;this.canExecute&&(this.pyenv||await this.toggleConnection(),(e=this.pyenv)==null||e.execCode(this.model.getValue()))}getLanguage(){var e;return(e=this.model.getLanguageId())==null?void 0:e.toLowerCase()}renderToolbar(){return this.canExecute?l`
...
`);s!==e&&this.model.setValue(s)}openPackageManager(){j.showPackageManager({packages:this.requiredPackages,pyenv:this.pyenv,onPackageAdded:e=>{this.requiredPackages.includes(e)||(this.requiredPackages=[...this.requiredPackages,e],this.updatePackagesInContent())},onPackageRemoved:e=>{this.requiredPackages=this.requiredPackages.filter(t=>t!==e),this.updatePackagesInContent()}})}render(){return l`
            <style>
                ${f}
            </style>
            <div class="monaco-editor-container" ${q(this.editorRef)}>
            </div>
        `}};i.styles=$`
        :host {
            display: flex;
    ...
    `;d([p({attribute:!1})],i.prototype,"input",2);d([p()],i.prototype,"readOnly",2);d([u()],i.prototype,"canExecute",2);d([u()],i.prototype,"pyenv",2);d([u()],i.prototype,"requiredPackages",2);i=d([x("k-monaco-editor")],i);export{i as KMonacoEditor};
