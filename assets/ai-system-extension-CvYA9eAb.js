const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-D_a0cemo.js","assets/index-CmA8t-CU.js","assets/index-Ci3bp9A1.css","assets/main-DQjgvuwU.css"])))=>i.map(i=>d[i]);
import{m as ee,n as L,C as R,I as te,J as se,k as ae,j as G,b as I,p as j,t as ie,L as oe,a as re,H as Z,K as ne,s as le,M as ce,N as W,r as de,e as pe,x as X}from"./main-D_a0cemo.js";import{b as M,n as g,r as $,i as E,x as n,q as d,o as ge,t as C,ad as ue,_ as q}from"./index-CmA8t-CU.js";var he=Object.defineProperty,me=Object.getOwnPropertyDescriptor,O=(a,e,s,t)=>{for(var i=t>1?void 0:t?me(e,s):e,o=a.length-1,r;o>=0;o--)(r=a[o])&&(i=(t?r(e,s,i):r(i))||i);return t&&i&&he(e,s,i),i};let T=class extends E{constructor(){super(...arguments),this.isStreaming=!1,this.showHeader=!0,this.attentionInputValue=""}formatTimestamp(){return new Date().toLocaleTimeString()}copyToClipboard(a){navigator.clipboard.writeText(a).catch(e=>{console.error("Failed to copy:",e)})}processMarkdownContent(a){return a.includes("code-block-wrapper")?a:a.replace(/<pre><code([^>]*)>([\s\S]*?)<\/code><\/pre>/gi,(e,s,t)=>`<div class="code-block-wrapper">
