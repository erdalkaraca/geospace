      ...
      >
        <div class="extension-manager">
          ...
          <div class="extension-list">
            ${this.loading?l`<div class="extension-list-empty">Loading extensions…</div>`:a?z(n,i=>i.id,i=>this.renderExtensionRow(i)):l`
