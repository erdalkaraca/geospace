...
`):void 0,imageData:s}),this.executionCounter++,t.execution_count=this.executionCounter,this.markDirty(!0)}catch(o){this.executingCells.has(e)&&this.cellOutputs.set(e,{type:"error",data:String(o)})}finally{this.executingCells.delete(e),this.requestUpdate()}}}async cancelExecution(e){if(this.pyenv)if(this.pyenv.canInterrupt())this.pyenv.interrupt();else{this.cellOutputs.set(e,{type:"error",data:"Execution cancelled by user (worker terminated - SharedArrayBuffer not available for graceful interrupt)"}),this.executingCells.delete(e),this.pyenv.close(),this.pyenv=void 0,this.pyConnected=!1,this.pyVersion=void 0;try{await this.initPyodide()}catch(t){console.error("Failed to reinitialize Python after cancellation:",t)}this.requestUpdate()}}clearAllOutputs(){this.cellOutputs.clear(),this.executionCounter=0,this.notebook?.cells&&this.notebook.cells.forEach(e=>{e.cell_type==="code"&&(e.execution_count=null,e.outputs=[])}),this.markDirty(!0),this.requestUpdate()}async restartKernel(){if(!(!this.pyenv||this.pyConnecting))try{this.pyConnecting=!0,this.pyenv.close(),this.pyenv=void 0,this.pyConnected=!1,this.pyVersion=void 0,this.requestUpdate(),await this.initPyodide(),this.requestUpdate()}catch(e){console.error("Failed to restart kernel:",e)}finally{this.pyConnecting=!1}}async runAllCells(){if(this.notebook?.cells){this.isRunningAll=!0,this.cancelRunAll=!1,this.requestUpdate();try{for(let e=0;e<this.notebook.cells.length&&!this.cancelRunAll;e++)this.notebook.cells[e].cell_type==="code"&&await this.executeCell(e)}finally{this.isRunningAll=!1,this.cancelRunAll=!1,this.requestUpdate()}}}cancelAllCells(){this.cancelRunAll=!0}toggleMarkdownEdit(e){this.editingMarkdownCells.has(e)?this.editingMarkdownCells.delete(e):this.editingMarkdownCells.add(e),this.requestUpdate()}saveMarkdownEdit(e,t){const a=t.target.value;if(this.notebook&&this.notebook.cells[e]){const i=this.notebook.cells[e],l=this.getCellSource(i);i.source=this.stringToSourceArray(a),l!==a&&this.markDirty(!0)}this.editingMarkdownCells.delete(e),this.requestUpdate()}renderMarkdownCell(e,t){const o=this.getCellSource(e),a=!o||o.trim()==="";if(this.editingMarkdownCells.has(t)){const n=d`
        ...
        `}renderCodeCell(e,t){const o=this.cellOutputs.get(t),a=this.executingCells.has(t);this.cellRefs.has(t)||this.cellRefs.set(t,M());const i=this.cellRefs.get(t),l=a?d`
            <wa-button 
                size="small" 
                appearance="plain"
            ...
            <div class="cell-wrapper">
                <wa-animation 
                    ...
                    <div class="cell code-cell ${a?"executing":""}">
                        ...
                        <div class="cell-input monaco-container" ${O(i)} data-cell-index="${t}"></div>
                        ${o?d`
...
`).length,l=19,s=10,n=100,c=Math.max(n,i*l+s);e.style.height=`${c}px`;const r=k.create(e,{value:a,language:"python",theme:this.getMonacoTheme(),minimap:{enabled:!1},scrollBeyondLastLine:!1,lineNumbers:"on",renderLineHighlight:"all",automaticLayout:!0,fontSize:14,tabSize:4,wordWrap:"on"});let m=!1;r.onDidFocusEditorText(()=>{m=!0,this.focusedCellIndex=o}),r.onDidBlurEditorText(()=>{m=!1,this.focusedCellIndex===o&&(this.focusedCellIndex=-1)}),e.addEventListener("wheel",g=>{if(!m){const y=r.getScrollTop(),f=r.getScrollHeight(),w=r.getContentHeight(),v=f>w,C=g.deltaY<0&&y<=0||g.deltaY>0&&y+w>=f;(!v||C)&&g.stopImmediatePropagation()}},{passive:!0,capture:!0}),r.onDidContentSizeChange(()=>{const g=r.getContentHeight();e.style.height=`${Math.max(n,g+s)}px`,r.layout()}),r.onDidChangeModelContent(()=>{const g=r.getValue(),y=this.getCellSource(t);g!==y&&this.markDirty(!0)}),this.monacoEditors.set(o,r)}getMonacoTheme(){const e=document.documentElement;return e.classList.contains("wa-dark")?"vs-dark":e.classList.contains("wa-light")?"vs":"vs-dark"}openPackageManager(){const e=this.notebook?.metadata?.required_packages||[];T.showPackageManager({packages:e,pyenv:this.pyenv,onPackageAdded:t=>{this.notebook&&(this.notebook.metadata||(this.notebook.metadata={}),this.notebook.metadata.required_packages||(this.notebook.metadata.required_packages=[]),this.notebook.metadata.required_packages.includes(t)||(this.notebook.metadata.required_packages.push(t),this.markDirty(!0)))},onPackageRemoved:t=>{if(!this.notebook?.metadata?.required_packages)return;const o=this.notebook.metadata.required_packages.indexOf(t);o>-1&&(this.notebook.metadata.required_packages.splice(o,1),this.markDirty(!0))}})}updated(e){super.updated(e),(e.has("pyConnected")||e.has("pyConnecting")||e.has("pyVersion")||e.has("isRunningAll"))&&this.updateToolbar(),this.notebook?.cells&&this.notebook.cells.forEach((t,o)=>{if(t.cell_type==="code"){const a=this.cellRefs.get(o);a?.value&&!this.monacoEditors.has(o)&&this.initializeMonacoEditor(a.value,t,o)}})}render(){return this.notebook?d`
        ...
        `:d`<div class="loading">Loading notebook...</div>`}};p.styles=P`
        :host {
            display: block;
            width: 100%;
        }
