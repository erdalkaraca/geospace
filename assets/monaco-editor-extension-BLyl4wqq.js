import{U as p,e as l,s as y}from"./editor.main-DRCUfrNX.js";import{k as f,y as g,q as v,l as w,b as k,x as d,F as x,a as W,n as h,c as m,t as C}from"./index-BBymxG1x.js";import{e as E,t as u,c as $,P as j,j as R}from"./main-DJKOehCJ.js";function I(e){return new Worker("/assets/editor.worker-BKDaejSB.js",{type:"module",name:e==null?void 0:e.name})}function P(e){return new Worker("/assets/json.worker-bnpFxRku.js",{type:"module",name:e==null?void 0:e.name})}function b(e){return new Worker("/assets/css.worker-BAVIDzD3.js",{type:"module",name:e==null?void 0:e.name})}function D(e){return new Worker("/assets/html.worker-De8bSgst.js",{type:"module",name:e==null?void 0:e.name})}function O(e){return new Worker("/assets/ts.worker-8yPRNxAu.js",{type:"module",name:e==null?void 0:e.name})}var _=Object.defineProperty,L=Object.getOwnPropertyDescriptor,s=(e,t,r,o)=>{for(var n=o>1?void 0:o?L(t,r):t,i=e.length-1,c;i>=0;i--)(c=e[i])&&(n=(o?c(t,r,n):c(n))||n);return o&&n&&_(t,r,n),n};self.MonacoEnvironment={getWorker(e,t){return t==="json"?new P:t==="css"||t==="scss"||t==="less"?new b:t==="html"||t==="handlebars"||t==="razor"?new D:t==="typescript"||t==="javascript"?new O:new I}};R.registerEditorInputHandler({canHandle:e=>e instanceof x,handle:async e=>{const t={title:e.getName(),data:e,key:e.getName(),icon:"file-pen",noOverflow:!1,state:{}};return t.widgetFactory=()=>d`
