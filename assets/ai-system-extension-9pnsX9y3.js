const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-CJ7vKuNz.js","assets/index-ZfqTFlZV.js","assets/index-C2t38aP0.css","assets/main-DQjgvuwU.css"])))=>i.map(i=>d[i]);
import{n as Y,s as L,E as R,I as Q,J as X,K as Z,k as j,b as P,x as G,t as ee,L as te,a as se,j as ae,r as ie}from"./main-CJ7vKuNz.js";import{a as T,n as g,r as $,i as D,x as n,l as d,o as re,t as _,ac as oe,_ as q}from"./index-ZfqTFlZV.js";var ne=Object.defineProperty,le=Object.getOwnPropertyDescriptor,z=(a,e,s,t)=>{for(var i=t>1?void 0:t?le(e,s):e,r=a.length-1,o;r>=0;r--)(o=a[r])&&(i=(t?o(e,s,i):o(i))||i);return t&&i&&ne(e,s,i),i};let k=class extends D{constructor(){super(...arguments),this.isStreaming=!1,this.showHeader=!0,this.attentionInputValue=""}formatTimestamp(){return new Date().toLocaleTimeString()}copyToClipboard(a){navigator.clipboard.writeText(a).catch(e=>{console.error("Failed to copy:",e)})}processMarkdownContent(a){return a.includes("code-block-wrapper")?a:a.replace(/<pre><code([^>]*)>([\s\S]*?)<\/code><\/pre>/gi,(e,s,t)=>`<div class="code-block-wrapper">
    ...
    `;H([g({type:String})],K.prototype,"message",2);H([g({type:String})],K.prototype,"hint",2);K=H([_("ai-empty-state")],K);var ue=Object.getOwnPropertyDescriptor,he=(a,e,s,t)=>{for(var i=t>1?void 0:t?ue(e,s):e,r=a.length-1,o;r>=0;r--)(o=a[r])&&(i=o(i)||i);return i};let W=class extends D{render(){return n`
    ...
    `;W=he([_("ai-loading-indicator")],W);var me=Object.defineProperty,ve=Object.getOwnPropertyDescriptor,F=(a,e,s,t)=>{for(var i=t>1?void 0:t?ve(e,s):e,r=a.length-1,o;r>=0;r--)(o=a[r])&&(i=(t?o(e,s,i):o(i))||i);return t&&i&&me(e,s,i),i};let E=class extends D{constructor(){super(...arguments),this.isStreaming=!1,this.groupId=""}renderStatusIcon(a){switch(a){case"streaming":return n`<wa-icon name="spinner" class="spinning"></wa-icon>`;case"completed":return n`<wa-icon name="check-circle" class="status-success"></wa-icon>`;case"error":return n`<wa-icon name="exclamation-circle" class="status-error"></wa-icon>`}}copyToClipboard(a){navigator.clipboard.writeText(a).catch(e=>{console.error("Failed to copy:",e)})}render(){if(!this.agentInfo)return n``;const a=this.message?.requiresAttention&&(this.message.attentionRequests?.length||0)>0;return this.message?n`
                                    ...
                                    <wa-details class="approval-details">
                                        ...
                                        <div class="approval-content">
                                            <div class="approval-message">
                                                ...
                                                <ul class="tool-list">
                                                    ${r.map(c=>{const u=c.function.arguments||"{}";let h={};try{h=JSON.parse(u)}catch{h={}}const S=Object.entries(h).length>0?`(${Object.entries(h).map(([b,x])=>`${b}=${JSON.stringify(x)}`).join(", ")})`:"()",f=i.allowListSelections.get(c.id)||!1;return n`
