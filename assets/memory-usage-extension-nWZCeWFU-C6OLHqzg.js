import{f as c,T as o,h as d}from"./geospace-app-CCGOW35A.js";import{t as m,b as l}from"./default-xvQdiKMn.js";import"./preload-helper-WQhrSmCl.js";import"./chunk.2PWIIYRH-COD9mzAh.js";import"./chunk.IVRNYRHD-Htfh_CZj.js";var u=Object.getOwnPropertyDescriptor,g=(e,i,s,a)=>{for(var t=a>1?void 0:a?u(i,s):i,n=e.length-1,r;n>=0;n--)(r=e[n])&&(t=r(t)||t);return t};let p=class extends d{constructor(){super(...arguments),this.updateInterval=null}connectedCallback(){super.connectedCallback(),this.updateInterval=window.setInterval(()=>{this.requestUpdate()},2e3)}disconnectedCallback(){super.disconnectedCallback(),this.updateInterval!==null&&(clearInterval(this.updateInterval),this.updateInterval=null)}render(){const e=performance.memory;if(!e)return l``;const i=(e.usedJSHeapSize/1048576).toFixed(1),s=(e.jsHeapSizeLimit/1048576).toFixed(0),a=e.usedJSHeapSize/e.jsHeapSizeLimit*100,t=a.toFixed(0),n=a>80?"#ff4444":a>60?"#ffaa00":"#44aa44";return l`
        ...
        `}};p=g([m("k-memory-usage")],p);c.registerContribution(o,{target:o,label:"Memory",html:"<k-memory-usage></k-memory-usage>"});
