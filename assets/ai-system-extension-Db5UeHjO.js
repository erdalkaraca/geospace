const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-CTi7ay9e.js","assets/index-C4bFKT08.js","assets/index-C2t38aP0.css","assets/main-Bk6wZs2B.css"])))=>i.map(i=>d[i]);
import{o as Q,p as L,k as z,J as Y,L as X,K as Z,j as G,c as M,v as R,b as ee,u as te,t as se,r as ae}from"./main-CTi7ay9e.js";import{a as I,n as g,r as k,i as T,x as n,l as p,o as ie,t as q,ab as re,_ as j}from"./index-C4bFKT08.js";var oe=Object.defineProperty,ne=Object.getOwnPropertyDescriptor,N=(s,e,a,t)=>{for(var i=t>1?void 0:t?ne(e,a):e,r=s.length-1,o;r>=0;r--)(o=s[r])&&(i=(t?o(e,a,i):o(i))||i);return t&&i&&oe(e,a,i),i};let C=class extends T{constructor(){super(...arguments),this.isStreaming=!1,this.showHeader=!0,this.attentionInputValue=""}formatTimestamp(){return new Date().toLocaleTimeString()}copyToClipboard(s){navigator.clipboard.writeText(s).catch(e=>{console.error("Failed to copy:",e)})}processMarkdownContent(s){return s.includes("code-block-wrapper")?s:s.replace(/<pre><code([^>]*)>([\s\S]*?)<\/code><\/pre>/gi,(e,a,t)=>`<div class="code-block-wrapper">
