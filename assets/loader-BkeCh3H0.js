import{i as b,c as f,b as i,e as g,a as p,u as C,f as y,t as T}from"./webawesome-C6zoK8ho.js";import{c as d,A as x,L as w,B as $,C as u,x as s,E as S}from"./config-BnnWtrGw-B7Dvw4S0.js";var A=Object.defineProperty,I=Object.getOwnPropertyDescriptor,h=(e,t,o,r)=>{for(var n=r>1?void 0:r?I(t,o):t,l=e.length-1,c;l>=0;l--)(c=e[l])&&(n=(r?c(t,o,n):c(n))||n);return r&&n&&A(t,o,n),n};const m="catalog.root";let a=class extends w{constructor(){super(...arguments),this.treeRef=g()}doBeforeUI(){this.rebuildTree(),this.contributionsSubscriptionToken=p($,e=>{(e.target===m||e.target?.startsWith("catalog."))&&this.rebuildTree()})}doClose(){this.contributionsSubscriptionToken&&(C(this.contributionsSubscriptionToken),this.contributionsSubscriptionToken=void 0),super.doClose()}rebuildTree(){const e=d.getContributions(m);this.rootNodes=this.toTreeNodes(e),this.requestUpdate()}renderToolbar(){const e=u.get()instanceof a&&s.get()!==void 0;return i`
            <lyra-command
    ...
    `;h([f()],a.prototype,"rootNodes",2);a=h([T("lyra-catalog")],a);d.registerContribution(x,{name:"catalog",label:"Catalog",icon:"book",component:e=>i`<lyra-catalog id="${e}"></lyra-catalog>`});
