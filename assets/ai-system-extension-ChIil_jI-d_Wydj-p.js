const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/geospace-app-RtTDgl_E.js","assets/preload-helper-WQhrSmCl.js","assets/index-CUNXveE1.js","assets/chunk.LTSJC6DR-BTS7fm5P.js","assets/index-aP6FMjSZ.css","assets/chunk.RRCUZAZD-5O78oK5S.js"])))=>i.map(i=>d[i]);
import{_ as I}from"./preload-helper-WQhrSmCl.js";import{A as O,E as m,M as v,a7 as ne,x as l,z as N,Q as h,J as le,R as j,u as Q,I as _}from"./index-CUNXveE1.js";import{o as ce,e as H,S as de,J as pe,B as $,L as X,x as ae,v as ie,h as he,M as ge,r as ue,k as V,u as me,m as oe,N as re,b as U,n as G,t as ve,O as we,H as ee,K as fe,Q as be,R as Y,U as Ae,A as Ee,V as Se}from"./geospace-app-RtTDgl_E.js";import"./chunk.LTSJC6DR-BTS7fm5P.js";import"./chunk.RRCUZAZD-5O78oK5S.js";const ye=`You are an assistant in a web application with workspace, editors, and AI chat.
                ...
                ${h(s.length>0,()=>l`
                    ${this.pendingToolApprovals.size>0?l`
                        <div class="tool-approval-section">
                            ${Array.from(this.pendingToolApprovals.entries()).map(([t,i])=>{const o=i.request.toolCalls,n=o.length;o.map(u=>{const T=u.function.arguments||"{}";let b={};try{b=JSON.parse(T)}catch{b={}}const C=Object.entries(b).map(([S,d])=>`${S}=${JSON.stringify(d)}`).join(", ");return`${u.function.name}${C?`(${C})`:"()"}`}).join(", ");const c=n>1?"s":"",p=n>1?", ...":"",w=r("TOOL_EXECUTION_PENDING",{toolCount:n.toString(),plural:c,toolName:o[0]?.function.name||"",more:p});return l`
                                    <wa-details class="approval-details">
                                        ...
                                        <div class="approval-content">
                                            <div class="approval-message">
                                                ...
                                                <ul class="tool-list">
                                                    ${o.map(u=>{const T=u.function.arguments||"{}";let b={};try{b=JSON.parse(T)}catch{b={}}const C=Object.entries(b).length>0?`(${Object.entries(b).map(([d,g])=>`${d}=${JSON.stringify(g)}`).join(", ")})`:"()",S=i.allowListSelections.get(u.id)||!1;return l`
