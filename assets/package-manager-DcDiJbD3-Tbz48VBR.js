import{m as e}from"./fs-access-D-fDaJ8V-4fi1R5VX.js";import{L as t,Q as n,U as r,_ as i,b as a,r as o,t as s,v as c}from"./repeat-jF3QiNU_.js";import{T as l}from"./dist-Bs3vRgSi.js";var u=class extends t{constructor(...e){super(...e),this.open=!1,this.packages=[],this.loadingPackages=!1}configure(e){this.packages=e.packages||[],this.pyenv=e.pyenv,this.onPackageAdded=e.onPackageAdded,this.onPackageRemoved=e.onPackageRemoved}show(){this.open=!0}hide(){this.open=!1}addPackage(e){if(!e||e.trim()===``)return;let t=e.trim();this.packages.includes(t)||(this.packages=[...this.packages,t],this.onPackageAdded?.(t))}removePackage(e){this.packages.indexOf(e)>-1&&(this.packages=this.packages.filter(t=>t!==e),this.onPackageRemoved?.(e))}async reloadPackages(){if(this.pyenv){this.loadingPackages=!0,this.packageLoadError=void 0;try{await this.pyenv.loadPackages(this.packages)}catch(e){this.packageLoadError=String(e)}finally{this.loadingPackages=!1}}}render(){let e;return r`
    ...
    `}};l([c({type:Boolean})],u.prototype,`open`,void 0),l([c({type:Array})],u.prototype,`packages`,void 0),l([c({attribute:!1})],u.prototype,`pyenv`,void 0),l([i()],u.prototype,`loadingPackages`,void 0),l([i()],u.prototype,`packageLoadError`,void 0),u=l([a(`docks-python-package-manager`)],u);var d=new class{showPackageManager(e){return this.managerInstance||(this.managerInstance=document.createElement(`docks-python-package-manager`),document.body.appendChild(this.managerInstance)),this.managerInstance.configure(e),this.managerInstance.show(),this.managerInstance}getManager(){return this.managerInstance}};e.put(`pythonPackageManagerService`,d);export{d as t};