const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-Dla4KgeC.js","assets/index-C4bFKT08.js","assets/index-C2t38aP0.css","assets/main-Bk6wZs2B.css"])))=>i.map(i=>d[i]);
import{o as Q,p as L,k as z,J as Y,L as X,K as Z,j,c as M,v as G,b as ee,u as te,t as se,I as ae,r as ie}from"./main-Dla4KgeC.js";import{a as k,n as g,r as I,i as E,x as n,l as p,o as re,t as T,ab as oe,_}from"./index-C4bFKT08.js";var ne=Object.defineProperty,le=Object.getOwnPropertyDescriptor,N=(a,e,s,t)=>{for(var i=t>1?void 0:t?le(e,s):e,r=a.length-1,o;r>=0;r--)(o=a[r])&&(i=(t?o(e,s,i):o(i))||i);return t&&i&&ne(e,s,i),i};let C=class extends E{constructor(){super(...arguments),this.isStreaming=!1,this.showHeader=!0,this.attentionInputValue=""}formatTimestamp(){return new Date().toLocaleTimeString()}copyToClipboard(a){navigator.clipboard.writeText(a).catch(e=>{console.error("Failed to copy:",e)})}processMarkdownContent(a){return a.includes("code-block-wrapper")?a:a.replace(/<pre><code([^>]*)>([\s\S]*?)<\/code><\/pre>/gi,(e,s,t)=>`<div class="code-block-wrapper">
