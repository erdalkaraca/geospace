import{U as e,b as t}from"./repeat-jF3QiNU_.js";import{F as n,T as r,d as i,i as a}from"./dist-Bs3vRgSi.js";var o=class extends a{constructor(...e){super(...e),this.updateInterval=null}connectedCallback(){super.connectedCallback(),this.updateInterval=window.setInterval(()=>{this.requestUpdate()},2e3)}disconnectedCallback(){super.disconnectedCallback(),this.updateInterval!==null&&(clearInterval(this.updateInterval),this.updateInterval=null)}render(){let t=performance.memory;if(!t)return e``;let n=(t.totalJSHeapSize/1048576).toFixed(1),r=(t.jsHeapSizeLimit/1048576).toFixed(0),i=t.totalJSHeapSize/t.jsHeapSizeLimit*100,a=i.toFixed(0);return e`
        ...
        `}};o=r([t(`docks-memory-usage`)],o),n.registerContribution(i,{target:i,label:`Memory`,component:`<docks-memory-usage></docks-memory-usage>`});