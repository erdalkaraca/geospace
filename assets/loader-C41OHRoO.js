import{G as b}from"./gs-map-editor-C6WUCIjB.js";import{H as D,b as r,q as T,n as x,r as y,t as O}from"./webawesome-Bcy1vMqC.js";import{I as w}from"./index-mkGwh4oX.js";import{I as C,t as I,u as L}from"./config-ByP2ak92-zMGYTrLw.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./__vite-browser-external-DrV_kz0N.js";import"./preload-helper-BXl3LOEh.js";import"./chunk.FSRXYGSW-CMgxtNeZ.js";import"./third-party-BW12UeC1.js";const F=D`
    wa-dialog {
        --width: 900px;
    }
...
`;function A(e){const t=e.stroke?.color||"transparent",a=e.fill?.color||"transparent",i=Math.min(e.stroke?.width||1,5),o=e.stroke?.lineDash?.join(" ")||"none",n=e.stroke?.lineCap||"round",l=e.stroke?.lineJoin||"round";return e.image?.type==="circle"?E(e,t,a,i):e.image?.type==="regular-shape"?j(e,t,a,i):e.image?.type==="icon"?q(e):r`
    ...
    `}function E(e,t,a,i){const o=Math.min(e.image?.radius||5,15),n=e.image?.fill?.color||a,l=e.image?.stroke?.color||t,u=Math.min(e.image?.stroke?.width||i,3),c=e.image?.opacity??1,p=(e.image?.rotation||0)*(180/Math.PI),d=e.image?.scale||1;return r`
        <svg width="40" height="40" viewBox="0 0 40 40">
            <circle
                cx="20"
                cy="20"
    ...
    `}function j(e,t,a,i){const o=e.image?.points||5,n=Math.min(e.image?.radius||10,15),l=e.image?.fill?.color||a,u=e.image?.stroke?.color||t,c=Math.min(e.image?.stroke?.width||i,3),p=e.image?.opacity??1,d=((e.image?.rotation||0)+(e.image?.angle||0))*(180/Math.PI),s=z(20,20,n,o,e.image?.radius2);return r`
        <svg width="40" height="40" viewBox="0 0 40 40">
            <polygon
                points="${s}"
                fill="${l}"
    ...
    `}function q(e){const t=e.image?.src,a=e.image?.color||"#0064ff",i=e.image?.opacity??1,o=(e.image?.rotation||0)*(180/Math.PI),n=e.image?.scale||1;return t?t.startsWith("data:image/svg+xml")?r`
            <div
                style="
                    width: 40px;
                    height: 40px;
    ...
    `}function ee(e,t){const a=J(e.image?.points,e.image?.radius2),i=e.image?.radius2!==void 0;return r`
        ...
        ></wa-input>
    `}function M(e,t=24){let a=e.trim();if(!a.startsWith("<svg")&&!a.startsWith("<?xml"))throw new Error("Invalid SVG markup");return a=a.replace(/<\?xml[^>]*\?>\s*/i,""),a.includes("width=")||(a=a.replace("<svg",`<svg width="${t}"`)),a.includes("height=")||(a=a.replace("<svg",`<svg height="${t}"`)),`data:image/svg+xml;base64,${btoa(unescape(encodeURIComponent(a)))}`}function te(e,t){let a=e.image?.src||"";const i=a.startsWith("data:"),o=i?H(a):null;let n=o!==null;const l=i&&!n,u=!i&&a.length>0,p=(i?_(a):null)||e.image?.color||k;if(!a){const s=$("marker",p);setTimeout(()=>t.onImageSrcChange(s),0),a=s,n=!0}let d="marker";return n&&o?d=o:n&&!o?d="marker":l?d="paste-svg":u&&(d="custom-url"),r`
        <wa-divider></wa-divider>
        <wa-select
            label="Icon Source"
            value="${d}"
            @change=${s=>{const g=s.target.value;if(f[g]){const m=$(g,p);t.onImageSrcChange(m)}else(g==="paste-svg"||g==="custom-url")&&t.onImageSrcChange("")}}
        >
            <small>Presets</small>
        ...
        ${n?r`
                  <wa-color-picker
                      ...
                      opacity
                      size="small"
                      @change=${s=>{const g=o||d;if(f[g]){const m=$(g,s.target.value);t.onImageSrcChange(m)}}}
                  ></wa-color-picker>
              `:r`
                  <wa-color-picker
                      label="Tint Color"
    ...
    `}function le(e,t,a,i){const o=e[t];if(!o)return null;let n=o;for(let c=0;c<a.length-1;c++){const p=a[c];n[p]||(n[p]={}),n=n[p]}const l=a[a.length-1];return n[l]===i?null:(i===void 0?delete n[l]:n[l]=i,{...e})}function se(e){return{onStrokeColorChange:t=>e(["stroke","color"],t),onStrokeWidthChange:t=>e(["stroke","width"],t),onStrokeLineDashChange:t=>e(["stroke","lineDash"],t),onStrokeLineCapChange:t=>e(["stroke","lineCap"],t),onStrokeLineJoinChange:t=>e(["stroke","lineJoin"],t),onFillColorChange:t=>e(["fill","color"],t),onImageTypeChange:t=>e(["image","type"],t),onImageRotationChange:t=>e(["image","rotation"],t),onImageOpacityChange:t=>e(["image","opacity"],t),onImageScaleChange:t=>e(["image","scale"],t),onImageRadiusChange:t=>e(["image","radius"],t),onImageFillColorChange:t=>e(["image","fill","color"],t),onImageStrokeColorChange:t=>e(["image","stroke","color"],t),onImageStrokeWidthChange:t=>e(["image","stroke","width"],t),onImageSrcChange:t=>e(["image","src"],t),onImageColorChange:t=>e(["image","color"],t),onImageAnchorChange:t=>e(["image","anchor"],t),onImagePointsChange:t=>e(["image","points"],t),onImageRadius2Change:t=>e(["image","radius2"],t),onImageAngleChange:t=>e(["image","angle"],t)}}var ce=Object.defineProperty,pe=Object.getOwnPropertyDescriptor,v=(e,t,a,i)=>{for(var o=i>1?void 0:i?pe(t,a):t,n=e.length-1,l;n>=0;n--)(l=e[n])&&(o=(i?l(t,a,o):l(o))||o);return i&&o&&ce(t,a,o),o};let h=class extends T{constructor(){super(...arguments),this.open=!1,this.handleDialogHide=e=>{e.target.tagName.toLowerCase()==="wa-dialog"&&this.hide()},this.handleCancel=()=>{this.hide()},this.handleSave=()=>{this.gsMap&&this.workingStyles&&this.workingRules&&(this.gsMap.styles=this.workingStyles,this.gsMap.styleRules=this.workingRules),this.onSave?.(),this.hide()},this.handleAddStyle=()=>{console.log("Add style")},this.handleAddRule=()=>{console.log("Add rule")}}show(e){this.onSave=e,this.gsMap&&(this.workingStyles=JSON.parse(JSON.stringify(this.gsMap.styles||{})),this.workingRules=JSON.parse(JSON.stringify(this.gsMap.styleRules||[]))),this.open=!0,this.requestUpdate()}hide(){this.open=!1,this.selectedStyleId=void 0,this.selectedRuleId=void 0,this.workingStyles=void 0,this.workingRules=void 0,this.gsMap=void 0,this.requestUpdate()}render(){return this.open?r`
            <wa-dialog
                label="Style Editor"
                ?open=${this.open}
        ...
        `}renderSelectedRuleDetail(){if(!this.selectedRuleId||!this.workingRules)return r`
            ...
            `}handleStyleSelect(e){this.selectedStyleId!==e&&(this.selectedStyleId=e,this.requestUpdate())}handleRuleSelect(e){this.selectedRuleId!==e&&(this.selectedRuleId=e,this.requestUpdate())}handleDeleteStyle(e,t){e.stopPropagation(),this.workingStyles&&confirm(`Delete style "${t}"?`)&&(delete this.workingStyles[t],this.selectedStyleId===t&&(this.selectedStyleId=void 0),this.workingStyles={...this.workingStyles})}handleDeleteRule(e,t){if(e.stopPropagation(),!this.workingRules)return;const a=this.workingRules.findIndex((i,o)=>(i.id||`rule-${o}`)===t);a!==-1&&confirm(`Delete rule "${t}"?`)&&(this.workingRules.splice(a,1),this.selectedRuleId===t&&(this.selectedRuleId=void 0),this.workingRules=[...this.workingRules])}updateStyleProperty(e,t){if(!this.selectedStyleId||!this.workingStyles)return;const a=le(this.workingStyles,this.selectedStyleId,e,t);a&&(this.workingStyles=a)}};h.styles=F;v([x({type:Object})],h.prototype,"gsMap",2);v([x({type:Boolean})],h.prototype,"open",2);v([y()],h.prototype,"selectedStyleId",2);v([y()],h.prototype,"selectedRuleId",2);v([y()],h.prototype,"workingStyles",2);v([y()],h.prototype,"workingRules",2);h=v([O("gs-style-editor")],h);const Se=({commandRegistry:e})=>{e.registerAll({command:{id:"edit_styles",name:"Edit Styles",description:"Opens the style editor to define and edit map styles and rules",parameters:[]},handler:{execute:async t=>{const a=C.get();if(!(a instanceof b)){I("No active map editor");return}const i=a.getGsMap();if(!i){I("Map not initialized");return}let o=document.querySelector("gs-style-editor");o||(o=new h,document.body.appendChild(o)),o.gsMap=i,await o.updateComplete,o.show(()=>{a.markDirty(!0),a.refresh(),L("Styles updated")})}},contribution:{target:"toolbar:map-editor",icon:"palette",label:"Edit Styles",disabled:()=>!(C.get()instanceof b)}})};export{Se as default};
