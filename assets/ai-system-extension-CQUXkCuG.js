const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/geospace-app-CEA0mcDY.js","assets/preload-helper-WQhrSmCl.js","assets/index-BMTNPmID.js","assets/chunk.LTSJC6DR-BTS7fm5P.js","assets/index-aP6FMjSZ.css","assets/chunk.RRCUZAZD-5O78oK5S.js","assets/geospace-app-_5If7CXg.css"])))=>i.map(i=>d[i]);
import{u as O,y as m,z as v,s as N,x as l,M as h,w as ne,A as _,a5 as le,N as B}from"./index-BMTNPmID.js";import{n as ce,H as $,M as de,N as oe,m as re,k as F,b as z,q,t as pe,O as he,J as ee,K as ge,s as Q,Q as ue,R as Y,U as me,E as ve,V as X,e as H,W as we,o as fe,r as be,S as Ae,X as Ee,y as ae,x as ie,h as ye,Y as Se}from"./geospace-app-CEA0mcDY.js";import{_ as I}from"./preload-helper-WQhrSmCl.js";import"./chunk.LTSJC6DR-BTS7fm5P.js";import"./chunk.RRCUZAZD-5O78oK5S.js";const Te=`You are an assistant in a web application with workspace, editors, and AI chat.
...
`;var Ce=Object.defineProperty,Oe=Object.getOwnPropertyDescriptor,D=(s,e,a,t)=>{for(var i=t>1?void 0:t?Oe(e,a):e,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=(t?n(e,a,i):n(i))||i);return t&&i&&Ce(e,a,i),i};let P=class extends N{constructor(){super(...arguments),this.isStreaming=!1,this.showHeader=!0,this.attentionInputValue=""}formatTimestamp(){return new Date().toLocaleTimeString()}copyToClipboard(s){navigator.clipboard.writeText(s).catch(e=>{console.error("Failed to copy:",e)})}processMarkdownContent(s){return s.includes("code-block-wrapper")?s:s.replace(/<pre><code([^>]*)>([\s\S]*?)<\/code><\/pre>/gi,(e,a,t)=>`<div class="code-block-wrapper">
            ...
            <div class="message-wrapper ${e?"user":"assistant"} ${this.isStreaming?"streaming":""} ${a?"requires-attention":""}">
                ...
                <div class="message-content-wrapper ${e?"user":""}">
                    <div class="message-content">
                        ${ne(this.processMarkdownContent(ce.parse(s.content||"")))}
    ...
    `;L([m({type:String})],M.prototype,"value",2);L([m({type:Boolean})],M.prototype,"disabled",2);L([m({type:Boolean})],M.prototype,"busy",2);L([m({type:Boolean})],M.prototype,"hasProvider",2);L([le("wa-textarea")],M.prototype,"textareaElement",2);M=L([_("ai-chat-input")],M);var Ie=Object.defineProperty,Pe=Object.getOwnPropertyDescriptor,te=(s,e,a,t)=>{for(var i=t>1?void 0:t?Pe(e,a):e,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=(t?n(e,a,i):n(i))||i);return t&&i&&Ie(e,a,i),i};let K=class extends N{constructor(){super(...arguments),this.message=r("NO_PROVIDER_CONFIGURED"),this.hint=r("CLICK_SETTINGS_TO_CONFIGURE")}render(){return l`
    ...
    `;te([m({type:String})],K.prototype,"message",2);te([m({type:String})],K.prototype,"hint",2);K=te([_("ai-empty-state")],K);var Me=Object.getOwnPropertyDescriptor,xe=(s,e,a,t)=>{for(var i=t>1?void 0:t?Me(e,a):e,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=n(i)||i);return i};let J=class extends N{render(){return l`
    ...
    `;j([m({type:Object,attribute:!1})],k.prototype,"agentInfo",2);j([m({type:Object,attribute:!1})],k.prototype,"message",2);j([m({type:Boolean})],k.prototype,"isStreaming",2);j([m({type:String})],k.prototype,"groupId",2);k=j([_("ai-agent-response-card")],k);var Ne=Object.defineProperty,De=Object.getOwnPropertyDescriptor,se=(s,e,a,t)=>{for(var i=t>1?void 0:t?De(e,a):e,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=(t?n(e,a,i):n(i))||i);return t&&i&&Ne(e,a,i),i};let W=class extends N{handleAction(s){const e=s();e instanceof Promise&&e.catch(a=>{console.error("Action failed:",a)})}render(){if(!this.group)return l``;const s=Array.from(this.group.agents.values()),e=s.filter(c=>c.status==="completed").length,a=s.filter(c=>c.status==="streaming").length,t=s.filter(c=>c.status==="error").length,i=s.length>0&&e+t===s.length,o=s.length===1,n=s.filter(c=>c.message&&c.message.actions&&c.message.actions.length>0).flatMap(c=>c.message.actions.map(p=>({...p,agentRole:c.role,agentLabel:c.label}))).sort((c,p)=>{const w=c.requiresAttention?1:0;return(p.requiresAttention?1:0)-w});return l`
            <div class="agent-response-group">
                ...
                <div class="agent-group-content">
                    ${B(s,c=>c.role,c=>{const p=c.message||(c.status==="streaming"&&this.findStreamingMessage?this.findStreamingMessage(c.role):void 0);return l`
            ...
            <div class="chat-container">
                ${h(s.length>0,()=>l`
                    <wa-tab-group 
                        ...
                        ${B(s,t=>t,(t,i)=>{const o=this.sessionManager.getSession(t);return o?l`
                                <wa-tab panel="${t}">
                ...
                ${h(s.length>0,()=>l`
                    ${this.pendingToolApprovals.size>0?l`
                        <div class="tool-approval-section">
                            ${Array.from(this.pendingToolApprovals.entries()).map(([t,i])=>{const o=i.request.toolCalls,n=o.length;o.map(u=>{const S=u.function.arguments||"{}";let b={};try{b=JSON.parse(S)}catch{b={}}const T=Object.entries(b).map(([y,d])=>`${y}=${JSON.stringify(d)}`).join(", ");return`${u.function.name}${T?`(${T})`:"()"}`}).join(", ");const c=n>1?"s":"",p=n>1?", ...":"",w=r("TOOL_EXECUTION_PENDING",{toolCount:n.toString(),plural:c,toolName:o[0]?.function.name||"",more:p});return l`
                                    <wa-details class="approval-details">
                                        <span slot="summary" class="approval-summary">
                                            ...
                                            <div class="approval-actions-inline">
                                                ...
                                                <wa-button
                                                    ...
                                                    size="small"
                                                    variant="success"
                                                    @click="${async u=>{u.stopPropagation();for(const[S,b]of i.allowListSelections.entries())if(b){const T=i.request.toolCalls.find(y=>y.id===S);if(T){const{ToolExecutor:y}=await I(async()=>{const{ToolExecutor:C}=await import("./geospace-app-CEA0mcDY.js").then(G=>G.a9);return{ToolExecutor:C}},__vite__mapDeps([0,1,2,3,4,5,6])),d=new y,g=q.createExecutionContext(),A=d.findCommand(T,g);A&&this.toolApprovalAllowlist.add(A.id)}}if(i.allowListSelections.size>0){const S=await this.providerManager.getSettingsProviderName(),b=await this.providerManager.getSettingsModel();await this.providerManager.saveSettings(S||"",b||"",void 0,this.requireToolApproval,Array.from(this.toolApprovalAllowlist))}i.resolve(!0),this.pendingToolApprovals.delete(t),this.requestUpdate()}}">
                                        ...
                                        <div class="approval-content">
                                            <div class="approval-message">
                                                ...
                                                <ul class="tool-list">
                                                    ${o.map(u=>{const S=u.function.arguments||"{}";let b={};try{b=JSON.parse(S)}catch{b={}}const T=Object.entries(b).length>0?`(${Object.entries(b).map(([d,g])=>`${d}=${JSON.stringify(g)}`).join(", ")})`:"()",y=i.allowListSelections.get(u.id)||!1;return l`
