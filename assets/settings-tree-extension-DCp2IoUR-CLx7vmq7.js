import{b as o,i as x,n as $,c as y,e as P,a as A,h as S,f as R,t as C}from"./webawesome-C6zoK8ho.js";import{d as w,j as T,c as k,b as N,L as O,k as E,l as f,p as b}from"./config-BnnWtrGw-B7Dvw4S0.js";var D=Object.defineProperty,L=Object.getOwnPropertyDescriptor,m=(e,t,s,i)=>{for(var r=i>1?void 0:i?L(t,s):t,a=e.length-1,n;a>=0;a--)(n=e[a])&&(r=(i?n(t,s,r):n(r))||r);return i&&r&&D(t,s,r),r};let h=class extends O{constructor(){super(...arguments),this.settings={},this.categoryTree=[],this.selectedPath=null,this.detailRows=[],this.detailTitle="",this.searchQuery="",this.detailForPath=null,this.treeRef=P()}async doInitUI(){await this.loadSettings(),A(E,()=>this.loadSettings())}async loadSettings(){this.isDirty()||(this.settings=await f.getAll()??{},this.buildCategoryTree(),this.selectedPath&&this.updateDetailForPath(this.selectedPath))}buildCategoryTree(){const e=f.getCategories(),t=new Set(e.map(i=>i.id)),s=[];for(const i of e){const r=i.schema?.properties,a=this.settings[i.id],n=this.buildChildNodes(`${i.id}`,r,a),l=i.schema?.title??i.label;this.matchesSearch(l,i.id)&&s.push({path:i.id,label:l,children:n,expanded:!0})}for(const i of Object.keys(this.settings)){if(t.has(i))continue;const r=this.settings[i],a=this.buildChildNodes(i,void 0,r);this.matchesSearch(i,i)&&s.push({path:i,label:i,children:a,expanded:!0})}this.categoryTree=s}buildChildNodes(e,t,s){const i=[];if(t)for(const[r,a]of Object.entries(t)){const n=`${e}.${r}`,l=a?.title??r,c=h.isRecord(s)?s[r]:void 0,d=this.buildChildNodes(n,a?.properties,c);this.matchesSearch(l,n)&&i.push({path:n,label:l,children:d,expanded:!1})}if(h.isRecord(s)&&!t)for(const[r,a]of Object.entries(s)){const n=`${e}.${r}`,l=this.buildChildNodes(n,void 0,a);this.matchesSearch(r,n)&&i.push({path:n,label:r,children:l,expanded:!1})}return i}matchesSearch(e,t){if(!this.searchQuery.trim())return!0;const s=this.searchQuery.toLowerCase();return e.toLowerCase().includes(s)||t.toLowerCase().includes(s)}static isRecord(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)}refreshAfterEdit(){this.markDirty(!0),this.selectedPath&&this.updateDetailForPath(this.selectedPath)}getValueAtPath(e){const t=e.split(".").filter(Boolean);if(t.length===0)return this.settings;let s=this.settings;for(const i of t){if(s==null||typeof s!="object")return;s=s[i]}return s}setAtInMemory(e,t){const s=e.split(".").filter(Boolean);s.length!==0&&(this.settings=this.deepSet(this.settings,s,t))}deepSet(e,t,s){if(t.length===1){const c=t[0];if(Array.isArray(e)){const d=parseInt(c,10);if(isNaN(d)||d<0)return e;const p=[...e];return p[d]=s,p}return{...e,[c]:s}}const[i,...r]=t;if(Array.isArray(e)){const c=parseInt(i,10);if(isNaN(c)||c<0)return e;const d=[...e],p=d[c],u=p!==null&&typeof p=="object"?p:{};return d[c]=this.deepSet(u,r,s),d}const a=e,n=a[i],l=n!==null&&typeof n=="object"?n:{};return{...a,[i]:this.deepSet(l,r,s)}}getArrayItemLabel(e,t){if(h.isRecord(e)){if(typeof e.id=="string")return e.id;if(typeof e.name=="string")return e.name}return`Item ${t}`}async updateDetailForPath(e){const t=f.getSchemaForSettingKey(e),s=this.getValueAtPath(e),i=h.isRecord(s)?s:null,r=Array.isArray(s);let a;if(r){const l=s,c=[];l.forEach((d,p)=>{const u=`${e}.${p}`,g=this.getArrayItemLabel(d,p);h.isRecord(d)?Object.keys(d).forEach(v=>{c.push({key:v,path:`${u}.${v}`,title:v,description:"",schema:void 0,value:d[v],parentPath:u,groupLabel:g})}):c.push({key:String(p),path:u,title:g,description:`Array element ${p}.`,schema:void 0,value:d,parentPath:e,groupLabel:g})}),a=c}else if(i!==null){const l=t?.properties;a=Object.keys(l||i).map(d=>{const p=`${e}.${d}`,u=l?.[d],g=i[d];return{key:d,path:p,title:u?.title??d,description:u?.description??"",schema:u,value:g,parentPath:e}})}else if(s!=null&&typeof s!="object"){const l=e.split(".").pop()??e;a=[{key:l,path:e,title:l,description:"Edit value (no schema).",schema:void 0,value:s}]}else a=[];if(a.forEach(l=>{l.title===void 0&&(l.title=l.key)}),this.selectedPath!==e)return;const n=f.getCategories().find(l=>l.id===e);this.detailForPath=e,this.detailTitle=n?.label??t?.title??e,this.detailRows=a}selectPath(e){this.selectedPath=e,this.updateDetailForPath(e)}updated(e){super.updated?.(e),e.has("selectedPath")&&this.selectedPath!==this.detailForPath&&(this.selectedPath?this.updateDetailForPath(this.selectedPath):(this.detailForPath=null,this.detailRows=[],this.detailTitle=""))}setRowValue(e,t){this.setAtInMemory(e.path,t),this.refreshAfterEdit()}setRowValueFromJson(e,t){try{this.setRowValue(e,JSON.parse(t))}catch{this.refreshAfterEdit()}}renameKey(e,t,s){if(s.trim()===""||s===t)return;const i=this.getValueAtPath(e);if(!h.isRecord(i))return;const r=i[t],a={...i};delete a[t],a[s.trim()]=r,this.setAtInMemory(e,a),this.refreshAfterEdit()}deleteKey(e,t){const s=this.getValueAtPath(e);if(!h.isRecord(s))return;const i={...s};delete i[t],this.setAtInMemory(e,i),this.refreshAfterEdit()}async addKeyToGroup(e){const t=await b("New key name:","");t?.trim()&&(this.setAtInMemory(`${e}.${t.trim()}`,null),this.refreshAfterEdit())}deleteTopLevelKey(e){if(!(e in this.settings))return;const t={...this.settings};delete t[e],this.settings=t,this.markDirty(!0),this.selectedPath===e&&(this.selectedPath=null,this.detailForPath=null,this.detailRows=[],this.detailTitle=""),this.buildCategoryTree(),this.selectedPath&&this.updateDetailForPath(this.selectedPath)}renderDetailControl(e){const t=e.schema,s=t?.type,i=t?.enum,r=e.value;if(i&&Array.isArray(i)&&i.length>0){const n=i.map(c=>String(c)),l=r!=null?String(r):t?.default!==void 0?String(t.default):n[0];return o`
    ...
    `;m([$({attribute:!1})],h.prototype,"input",2);m([y()],h.prototype,"settings",2);m([y()],h.prototype,"categoryTree",2);m([y()],h.prototype,"selectedPath",2);m([y()],h.prototype,"detailRows",2);m([y()],h.prototype,"detailTitle",2);m([y()],h.prototype,"searchQuery",2);h=m([C("lyra-settings-tree")],h);const V=e=>{w.registerEditorInputHandler({editorId:"system.settings-tree",label:"Settings",ranking:1e3,canHandle:t=>t.key===".system.settings",handle:async t=>(t.component=()=>o`
                <lyra-settings-tree .input=${t}></lyra-settings-tree>
            `,t)}),T.registerHandler("open_settings",{ranking:100,execute:()=>{const t={title:"Settings",data:{},key:".system.settings",icon:"gear",state:{}};w.loadEditor(t)}}),k.registerContribution(N,{command:"open_settings",icon:"gear",label:"Settings"})};export{V as default};
