...
`,'"',f.BYTE_ORDER_MARK],f.WORKERS_SUPPORTED=!S&&!!a.Worker,f.NODE_STREAM_INPUT=1,f.LocalChunkSize=10485760,f.RemoteChunkSize=5242880,f.DefaultDelimiter=",",f.Parser=ve,f.ParserHandle=Ee,f.NetworkStreamer=we,f.FileStreamer=me,f.StringStreamer=ue,f.ReadableStreamStreamer=ye,a.jQuery&&((u=a.jQuery).fn.parse=function(e){var t=e.config||{},s=[];return this.each(function(w){if(!(u(this).prop("tagName").toUpperCase()==="INPUT"&&u(this).attr("type").toLowerCase()==="file"&&a.FileReader)||!this.files||this.files.length===0)return!0;for(var T=0;T<this.files.length;T++)s.push({file:this.files[T],inputElem:this,instanceConfig:u.extend({},t)})}),l(),this;function l(){if(s.length===0)C(e.complete)&&e.complete();else{var w,T,U,K,m=s[0];if(C(e.before)){var O=e.before(m.file,m.inputElem);if(typeof O=="object"){if(O.action==="abort")return w="AbortError",T=m.file,U=m.inputElem,K=O.reason,void(C(e.error)&&e.error({name:w},T,U,K));if(O.action==="skip")return void o();typeof O.config=="object"&&(m.instanceConfig=u.extend(m.instanceConfig,O.config))}else if(O==="skip")return void o()}var h=m.instanceConfig.complete;m.instanceConfig.complete=function(N){C(h)&&h(N,m.file,m.inputElem),o()},f.parse(m.file,m.instanceConfig)}}function o(){s.splice(0,1),l()}}),E&&(a.onmessage=function(e){e=e.data,f.WORKER_ID===void 0&&e&&(f.WORKER_ID=e.workerId),typeof e.input=="string"?a.postMessage({workerId:f.WORKER_ID,results:f.parse(e.input,e.config),finished:!0}):(a.File&&e.input instanceof File||e.input instanceof Object)&&(e=f.parse(e.input,e.config))&&a.postMessage({workerId:f.WORKER_ID,results:e,finished:!0})}),(we.prototype=Object.create(X.prototype)).constructor=we,(me.prototype=Object.create(X.prototype)).constructor=me,(ue.prototype=Object.create(ue.prototype)).constructor=ue,(ye.prototype=Object.create(X.prototype)).constructor=ye,f})})(_e)),_e.exports}var Ge=Je();const Ye=Pe(Ge),ge="dataview/",ne=ge+"index";class Xe{init(){this.subscriptionToken===void 0&&(this.subscriptionToken=je(Qe,i=>{this.handlePublish(i)}))}async handlePublish(i){const n=Be(),a=Date.now(),u={id:i.id??n,title:i.title,data:i.data,source:i.source,createdAt:a};await B.persistObject(ge+n,u);const S=await B.getObject(ne),E=Array.isArray(S)?S:[];E.push({storageKey:n,title:i.title,source:i.source,createdAt:a}),await B.persistObject(ne,E),Ne(Te,{storageKey:n,title:i.title,createdAt:a})}async listViews(){const i=await B.getObject(ne);return!Array.isArray(i)||i.length===0?[]:typeof i[0]=="string"?i.map(a=>({storageKey:a,title:a,createdAt:0})):[...i].sort((a,u)=>a.createdAt-u.createdAt)}async getView(i){return await B.getObject(ge+i)??null}async deleteView(i){const n=await B.getObject(ne),a=Array.isArray(n)?n.filter(u=>u.storageKey!==i):[];await B.persistObject(ne,a),await B.persistObject(ge+i,null)}async clearAllViews(){const i=await B.getObject(ne),n=Array.isArray(i)?i:[];await Promise.all(n.map(a=>B.persistObject(ge+a.storageKey,null))),await B.persistObject(ne,[])}}const se=new Xe;var et=Object.defineProperty,tt=Object.getOwnPropertyDescriptor,ae=(r,i,n,a)=>{for(var u=a>1?void 0:a?tt(i,n):i,S=r.length-1,E;S>=0;S--)(E=r[S])&&(u=(a?E(i,n,u):E(u))||u);return a&&u&&et(i,n,u),u};function be(r){return r==null?"":String(r)}function rt(r,i){return r.length===0?!1:r.every(n=>{const a=n[i];if(a==null)return!0;const u=Number(a);return Number.isFinite(u)})}function it(r,i,n){if(n){const a=Number(r),u=Number(i);return Number.isFinite(a)?Number.isFinite(u)?a-u:-1:Number.isFinite(u)?1:0}return be(r).localeCompare(be(i),void 0,{numeric:!0})}let W=class extends ze{constructor(){super(...arguments),this.data={columns:[],rows:[]},this.emptyMessage="No data.",this.sortColumnIndex=null,this.sortDirection="asc",this.filterQuery="",this.pageSize=25,this.currentPage=0}get columns(){return Array.isArray(this.data?.columns)?this.data.columns:[]}get rows(){return Array.isArray(this.data?.rows)?this.data.rows:[]}get filteredRows(){const r=this.filterQuery.trim().toLowerCase();return r?this.rows.filter(i=>i.some(n=>be(n).toLowerCase().includes(r))):this.rows}get sortedRows(){const r=this.filteredRows;if(this.sortColumnIndex==null||this.sortColumnIndex<0)return r;const i=this.sortColumnIndex,n=rt(r,i),a=this.sortDirection==="asc"?1:-1;return[...r].sort((u,S)=>{const E=u[i],v=S[i];return a*it(E,v,n)})}get totalRows(){return this.sortedRows.length}get pageCount(){const r=this.totalRows;return r===0?1:Math.ceil(r/this.pageSize)}get pagedRows(){const r=this.sortedRows,n=this.clampedPage*this.pageSize;return r.slice(n,n+this.pageSize)}get clampedPage(){const r=this.pageCount;return r<=0?0:Math.min(this.currentPage,r-1)}goToPage(r){const i=Math.max(0,this.pageCount-1);this.currentPage=Math.max(0,Math.min(r,i)),this.requestUpdate()}onPageSizeChange(r){const i=r.target.value,n=parseInt(i,10);!Number.isFinite(n)||n<1||(this.pageSize=n,this.currentPage=0,this.requestUpdate())}onSort(r){this.sortColumnIndex===r?this.sortDirection=this.sortDirection==="asc"?"desc":"asc":(this.sortColumnIndex=r,this.sortDirection="asc"),this.requestUpdate()}onFilterInput(r){this.filterQuery=r.target.value,this.requestUpdate()}clearFilter(){this.filterQuery="",this.requestUpdate()}getSortAria(r){return this.sortColumnIndex!==r?"none":this.sortDirection==="asc"?"ascending":"descending"}render(){const{columns:r}=this,i=this.totalRows,n=this.pagedRows,a=this.clampedPage,u=this.pageCount,S=i===0?0:a*this.pageSize+1,E=Math.min((a+1)*this.pageSize,i);return r.length===0&&i===0&&this.rows.length===0?z`<div class="table-empty">${this.emptyMessage}</div>`:z`
    ...
    `}};W.PAGE_SIZE_OPTIONS=[10,25,50,100];W.styles=Le`
    :host {
      display: flex;
...
${S}`:u}async onExportCsv(){const r=this.displayed;if(!(!r||!this.hasData))try{const i=this.toCsv(r),n=r.title?.trim()||"dataview",a=new Date().toISOString().replace(/[:.]/g,"-"),u=`${n.replace(/[^a-zA-Z0-9-_]+/g,"_")}-${a}.csv`,S=await He("directory");if(!S)return;this.executeCommand("touch",{path:`${S}/${u}`,contents:i})}catch(i){pe(i instanceof Error?i.message:String(i))}}async doInitUI(){const r=await this.getDialogSetting();r&&typeof r.autoActivateTab=="boolean"&&(this.autoActivateTab=r.autoActivateTab),this.subscribe(Te,async()=>{await this.refreshPersistedList(!0),this.autoActivateTab&&this.activateContainingTab()}),await this.refreshPersistedList(!1)}async refreshPersistedList(r){this.loadingList=!0,this.requestUpdate();try{if(this.persistedList=await se.listViews(),r&&this.persistedList.length>0){const i=this.persistedList[this.persistedList.length-1];this.selectedStorageKey=i.storageKey,this.selectedView=await se.getView(i.storageKey)}else this.selectedStorageKey?this.selectedView=await se.getView(this.selectedStorageKey):this.selectedView=null}catch(i){pe(i instanceof Error?i.message:String(i)),this.persistedList=[],this.selectedView=null}finally{this.loadingList=!1,this.requestUpdate()}}async selectStorageKey(r){if(this.selectedStorageKey=r,!r){this.selectedView=null,this.requestUpdate();return}try{this.selectedView=await se.getView(r)}catch(i){pe(i instanceof Error?i.message:String(i)),this.selectedView=null}this.requestUpdate()}async onAutoActivateChange(r){const i=r.target.checked;this.autoActivateTab=i;const n=await this.getDialogSetting()??{};await this.setDialogSetting({...n,autoActivateTab:i})}async onHistorySelect(r){const i=r.detail?.item?.value??"";!i||i==="__stats__"||await this.selectStorageKey(i)}async onDeleteView(r,i){r.stopPropagation(),r.preventDefault();try{await se.deleteView(i),this.selectedStorageKey===i&&(this.selectedStorageKey="",this.selectedView=null),await this.refreshPersistedList(!0)}catch(n){pe(n instanceof Error?n.message:String(n))}}async onClearHistory(){try{await se.clearAllViews(),this.selectedStorageKey="",this.selectedView=null,await this.refreshPersistedList(!1)}catch(r){pe(r instanceof Error?r.message:String(r))}}renderToolbar(){const r=this.selectedView??this.dataview,i=this.persistedList.find(v=>v.storageKey===this.selectedStorageKey),n=i?.title??r?.title??(this.persistedList.length>0?"Latest data view":"No data"),a=i?.createdAt??r?.createdAt?new Date(i?.createdAt??r?.createdAt).toLocaleString():null,u=r?.source??null,S=u?`${n} · ${u}`:n,E=a?`${S} (${a})`:S;return z`
        ...
        ${Fe(r,()=>z`<wa-divider orientation="vertical"></wa-divider><span>${E}</span>`)}
    `}renderTable(r){return this.hasData?z`<lyra-data-table .data=${r.data}></lyra-data-table>`:z`<div class="result-empty">No data.</div>`}renderContent(){const r=this.displayed;return r!=null?this.renderTable(r):z`<div class="result-empty">No data.</div>`}};te.styles=Le`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
  ...
  `;oe([xe({attribute:!1})],te.prototype,"dataview",2);oe([G()],te.prototype,"persistedList",2);oe([G()],te.prototype,"selectedStorageKey",2);oe([G()],te.prototype,"selectedView",2);oe([G()],te.prototype,"loadingList",2);oe([G()],te.prototype,"autoActivateTab",2);te=oe([Ie("lyra-dataview")],te);function nt(r){const i=Ye.parse(r,{header:!0,skipEmptyLines:!0}),n=i.meta.fields??[],a=i.data.map(u=>n.map(S=>u[S]));return{columns:n,rows:a}}se.init();qe.put("dataviewerService",se);Me.registerContribution(Ue,{name:"view.dataviewer",label:"Data Views",icon:"table",component:r=>z`<lyra-dataview id="${r}"></lyra-dataview>`});Ke.registerEditorInputHandler({editorId:"system.dataviewer-table",label:"Table",icon:"table",ranking:800,canHandle:r=>{if(!(r instanceof Ve))return!1;const i=r.getName().toLowerCase();return i.endsWith(".csv")||i.endsWith(".tsv")},handle:async r=>{r.getName();const i=await r.getContents(),{columns:n,rows:a}=nt(i??""),u={columns:n,rows:a};return{title:r.getWorkspacePath(),data:u,key:r.getWorkspacePath(),icon:"table",state:{},component:()=>z`<lyra-data-table .data=${u}></lyra-data-table>`}}});function ut(){}export{ut as default};
