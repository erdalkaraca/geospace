import{K as c,j as d,k as o}from"./main-C3Mn2iI8.js";import{t as m,x as l}from"./index-DUZ9xzhO.js";var u=Object.getOwnPropertyDescriptor,g=(e,n,r,a)=>{for(var t=a>1?void 0:a?u(n,r):n,s=e.length-1,i;s>=0;s--)(i=e[s])&&(t=i(t)||t);return t};let p=class extends c{constructor(){super(...arguments),this.updateInterval=null}connectedCallback(){super.connectedCallback(),this.updateInterval=window.setInterval(()=>{this.requestUpdate()},2e3)}disconnectedCallback(){super.disconnectedCallback(),this.updateInterval!==null&&(clearInterval(this.updateInterval),this.updateInterval=null)}render(){const e=performance.memory;if(!e)return l``;const n=(e.usedJSHeapSize/1048576).toFixed(1),r=(e.jsHeapSizeLimit/1048576).toFixed(0),a=e.usedJSHeapSize/e.jsHeapSizeLimit*100,t=a.toFixed(0),s=a>80?"#ff4444":a>60?"#ffaa00":"#44aa44";return l`
