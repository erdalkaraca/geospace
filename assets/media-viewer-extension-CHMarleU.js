import{x as d,u as m,y as p,z as c,A as u}from"./index-BMTNPmID.js";import{m as g,F as f,x as h}from"./geospace-app-CEA0mcDY.js";import"./preload-helper-WQhrSmCl.js";import"./chunk.LTSJC6DR-BTS7fm5P.js";import"./chunk.RRCUZAZD-5O78oK5S.js";var w=Object.defineProperty,v=Object.getOwnPropertyDescriptor,l=(e,t,a,s)=>{for(var i=s>1?void 0:s?v(t,a):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&w(t,a,i),i};const y=[".pdf",".jpg",".jpeg",".png",".gif",".svg",".webp",".bmp",".ico"],b=e=>{const t=e.toLowerCase();return t.endsWith(".pdf")?"file-pdf":t.match(/\.(jpg|jpeg|png|gif|webp|bmp|ico|svg)$/)?"image":"file"},U=e=>{const t=e.getName().toLowerCase();return y.some(a=>t.endsWith(a))};h.registerEditorInputHandler({canHandle:e=>e instanceof f&&U(e),handle:async e=>{const t={title:e.getName(),data:e,key:e.getName(),editorId:"media-viewer",icon:b(e.getName()),noOverflow:!1,state:{}};return t.widgetFactory=()=>d`
    ...
    `;l([p({attribute:!1})],r.prototype,"input",2);l([c()],r.prototype,"mediaUrl",2);r=l([u("k-media-viewer")],r);export{r as KMediaViewer};
