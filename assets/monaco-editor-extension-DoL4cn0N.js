import{U as g,e as u,s as m}from"./editor.main-702eHgXz.js";import{j as f,o as k,y as p,P as y,w,x as v,F as P,n as h,d as l,e as C}from"./main-Bas0PgXQ.js";import{j as x,x as d,k as W,h as q}from"./index-CBe0mDof.js";import{pythonPackageManagerService as $}from"./package-manager-extension-CvOySucs.js";function j(e){return new Worker("/assets/editor.worker-Ba5z4c26.js",{type:"module",name:e?.name})}function E(e){return new Worker("/assets/json.worker-De6w3Aj2.js",{type:"module",name:e?.name})}function I(e){return new Worker("/assets/css.worker-Brt0-qFL.js",{type:"module",name:e?.name})}function R(e){return new Worker("/assets/html.worker-DA9W98Qi.js",{type:"module",name:e?.name})}function b(e){return new Worker("/assets/ts.worker-C1ZVYqYQ.js",{type:"module",name:e?.name})}var L=Object.defineProperty,M=Object.getOwnPropertyDescriptor,c=(e,t,i,n)=>{for(var a=n>1?void 0:n?M(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(a=(n?r(t,i,a):r(a))||a);return n&&a&&L(t,i,a),a};self.MonacoEnvironment={getWorker(e,t){return t==="json"?new E:t==="css"||t==="scss"||t==="less"?new I:t==="html"||t==="handlebars"||t==="razor"?new R:t==="typescript"||t==="javascript"?new b:new j}};v.registerEditorInputHandler({canHandle:e=>e instanceof P,handle:async e=>{const t={title:e.getName(),data:e,key:e.getName(),editorId:"monaco-editor",icon:"file-pen",noOverflow:!1,state:{}};return t.widgetFactory=()=>d`
            <k-monaco-editor .input=${t}></k-monaco-editor>`,t}});let o=class extends f{constructor(){super(...arguments),this.readOnly=!1,this.editorRef=x(),this.canExecute=!1,this.requiredPackages=[],this.chatContext={history:[]}}doBeforeUI(){const e=this.input.data;this.canExecute=e.getName().endsWith(".py")}updated(e){super.updated(e),(e.has("canExecute")||e.has("pyenv"))&&this.updateToolbar()}async doInitUI(){const e=this.input.data,t=await e.getContents(),i=this.editorRef.value,n=g.file(e.getName());this.model=u.createModel(t,void 0,n),this.editor=u.create(i,{theme:"vs-dark",automaticLayout:!1}),this.model.onDidChangeContent(a=>{this.readOnly||this.markDirty(!0)}),this.editor.setModel(this.model),this.canExecute&&(this.requiredPackages=this.parsePackagesFromContent(t))}getEditor(){return this.editor}save(){const e=this.model.getValue();this.input?.data.saveContents(e),this.markDirty(!1)}doClose(){this.model?.dispose(),this.editor?.dispose(),this.model=void 0,this.editor=void 0,this.pyenv?.close(),this.pyenv=void 0}async onRunCode(){this.canExecute&&(this.pyenv||await this.toggleConnection(),this.pyenv?.execCode(this.model.getValue()))}getLanguage(){return this.model.getLanguageId()?.toLowerCase()}renderToolbar(){return this.canExecute?d`
...
`),i=/^#\s*@gs-packages:\s*(.+)$/i;for(const n of t){const a=n.match(i);if(a)return a[1].split(",").map(s=>s.trim()).filter(s=>s.length>0)}return[]}updatePackagesInContent(){if(!this.model)return;const e=this.model.getValue(),t=e.split(`
`),i=/^#\s*@gs-packages:/i;let n=-1;for(let r=0;r<t.length;r++)if(i.test(t[r])){n=r;break}const a=this.requiredPackages.length>0?`# @gs-packages: ${this.requiredPackages.join(", ")}`:null;if(a)if(n>=0)t[n]=a;else{const r=t[0]?.startsWith("#!")?1:0;t.splice(r,0,a)}else n>=0&&t.splice(n,1);const s=t.join(`
`);s!==e&&this.model.setValue(s)}openPackageManager(){$.showPackageManager({packages:this.requiredPackages,pyenv:this.pyenv,onPackageAdded:e=>{this.requiredPackages.includes(e)||(this.requiredPackages=[...this.requiredPackages,e],this.updatePackagesInContent())},onPackageRemoved:e=>{this.requiredPackages=this.requiredPackages.filter(t=>t!==e),this.updatePackagesInContent()}})}render(){return d`
    ...
    `;c([h({attribute:!1})],o.prototype,"input",2);c([h()],o.prototype,"readOnly",2);c([l()],o.prototype,"canExecute",2);c([l()],o.prototype,"pyenv",2);c([l()],o.prototype,"requiredPackages",2);o=c([C("k-monaco-editor")],o);export{o as KMonacoEditor};
