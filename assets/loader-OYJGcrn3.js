import{i as b,r as f,b as i,e as g,s as p,z as C,c as y,t as T}from"./repeat-Duk-1tMZ.js";import{c as d,B as w,L as x,C as $,E as u,y as s,G as S}from"./config-RT97oKMn-DH1WMsHN.js";var I=Object.defineProperty,A=Object.getOwnPropertyDescriptor,h=(e,t,o,r)=>{for(var n=r>1?void 0:r?A(t,o):t,l=e.length-1,c;l>=0;l--)(c=e[l])&&(n=(r?c(t,o,n):c(n))||n);return r&&n&&I(t,o,n),n};const m="catalog.root";let a=class extends x{constructor(){super(...arguments),this.treeRef=g()}doBeforeUI(){this.rebuildTree(),this.contributionsSubscriptionToken=p($,e=>{(e.target===m||e.target?.startsWith("catalog."))&&this.rebuildTree()})}doClose(){this.contributionsSubscriptionToken&&(C(this.contributionsSubscriptionToken),this.contributionsSubscriptionToken=void 0),super.doClose()}rebuildTree(){const e=d.getContributions(m);this.rootNodes=this.toTreeNodes(e),this.requestUpdate()}renderToolbar(){const e=u.get()instanceof a&&s.get()!==void 0;return i`
            <lyra-command
