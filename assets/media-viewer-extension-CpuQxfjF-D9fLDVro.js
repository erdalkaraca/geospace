import{a as e,n as t,w as n}from"./dist-C1LXzuY9.js";import{I as r,N as i,P as a,Q as o,U as s,z as c}from"./repeat-D7ZcYN9W.js";import{n as l}from"./fs-access-D-fDaJ8V-BQA-EXV_.js";var u=[`.pdf`,`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],d=e=>{let t=e.toLowerCase();return t.endsWith(`.pdf`)?`file-pdf`:t.match(/\.(jpg|jpeg|png|gif|webp|bmp|ico|svg)$/)?`image`:`file`},f=e=>{let t=e.getName().toLowerCase();return u.some(e=>t.endsWith(e))},p=[`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],m=e=>{let t=e.getName().toLowerCase();return p.some(e=>t.endsWith(e))};t.registerEditorInputHandler({editorId:`system.media-viewer`,label:`Media viewer`,canHandle:e=>e instanceof l&&f(e),handle:async e=>{let t={title:e.getWorkspacePath(),data:e,key:e.getWorkspacePath(),icon:d(e.getName()),state:{}};return t.component=e=>s`
    ...
    `}};n([a({attribute:!1})],h.prototype,`input`,void 0),n([i()],h.prototype,`mediaUrl`,void 0),n([i()],h.prototype,`imageNaturalWidth`,void 0),n([i()],h.prototype,`imageNaturalHeight`,void 0),n([i()],h.prototype,`overlays`,void 0),h=n([r(`docks-media-viewer`)],h);export{h as DocksMediaViewer};