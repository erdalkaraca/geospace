const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-CI4SPmXw.js","assets/index-DoDY4M9O.js","assets/index-C2t38aP0.css","assets/main-DQjgvuwU.css"])))=>i.map(i=>d[i]);
import{m as Y,n as L,C as R,I as Q,J as X,k as Z,j,b as P,p as G,t as ee,L as te,a as se,H as ae,r as ie}from"./main-CI4SPmXw.js";import{b as T,n as g,r as $,i as D,x as n,q as d,o as re,t as _,ad as oe,_ as q}from"./index-DoDY4M9O.js";var ne=Object.defineProperty,le=Object.getOwnPropertyDescriptor,z=(a,e,s,t)=>{for(var i=t>1?void 0:t?le(e,s):e,r=a.length-1,o;r>=0;r--)(o=a[r])&&(i=(t?o(e,s,i):o(i))||i);return t&&i&&ne(e,s,i),i};let k=class extends D{constructor(){super(...arguments),this.isStreaming=!1,this.showHeader=!0,this.attentionInputValue=""}formatTimestamp(){return new Date().toLocaleTimeString()}copyToClipboard(a){navigator.clipboard.writeText(a).catch(e=>{console.error("Failed to copy:",e)})}processMarkdownContent(a){return a.includes("code-block-wrapper")?a:a.replace(/<pre><code([^>]*)>([\s\S]*?)<\/code><\/pre>/gi,(e,s,t)=>`<div class="code-block-wrapper">
