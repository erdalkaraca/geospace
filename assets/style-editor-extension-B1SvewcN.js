import{d as g,G as m,c as w,t as $}from"./main-BS49fa1D.js";import{i as x,x as a,a as R,n as v,r as p,t as I}from"./index-G4cLbRFh.js";var P=Object.defineProperty,z=Object.getOwnPropertyDescriptor,c=(e,t,i,l)=>{for(var s=l>1?void 0:l?z(t,i):t,n=e.length-1,d;n>=0;n--)(d=e[n])&&(s=(l?d(t,i,s):d(s))||s);return l&&s&&P(t,i,s),s};let o=class extends x{constructor(){super(...arguments),this.open=!1}show(e){this.onSave=e,this.gsMap&&(this.workingStyles=JSON.parse(JSON.stringify(this.gsMap.styles||{})),this.workingRules=JSON.parse(JSON.stringify(this.gsMap.styleRules||[]))),this.open=!0,this.requestUpdate()}hide(){this.open=!1,this.selectedStyleId=void 0,this.selectedRuleId=void 0,this.workingStyles=void 0,this.workingRules=void 0,this.gsMap=void 0,this.requestUpdate()}handleCancel(){this.hide()}handleSave(){this.gsMap&&this.workingStyles&&this.workingRules&&(this.gsMap.styles=this.workingStyles,this.gsMap.styleRules=this.workingRules),this.onSave&&this.onSave(),this.hide()}handleStyleSelect(e){this.selectedStyleId=e}handleRuleSelect(e){this.selectedRuleId=e}renderStylesTab(){return a`
    ...
    `;c([v({type:Object})],o.prototype,"gsMap",2);c([v({type:Boolean})],o.prototype,"open",2);c([p()],o.prototype,"selectedStyleId",2);c([p()],o.prototype,"selectedRuleId",2);c([p()],o.prototype,"workingStyles",2);c([p()],o.prototype,"workingRules",2);o=c([I("gs-style-editor")],o);const A=({commandRegistry:e})=>{e.registerAll({command:{id:"edit_styles",name:"Edit Styles",description:"Opens the style editor to define and edit map styles and rules",parameters:[]},handler:{execute:async t=>{const i=g.get();if(!(i instanceof m)){w("No active map editor");return}const l=i.getGsMap();if(!l){w("Map not initialized");return}let s=document.querySelector("gs-style-editor");s||(s=new o,document.body.appendChild(s)),s.gsMap=l,await s.updateComplete,s.show(()=>{i.markDirty(!0),i.refresh(),$("Styles updated")})}},contribution:{target:"toolbar:map-editor",icon:"palette",label:"Edit Styles",disabled:()=>!(g.get()instanceof m)}})};export{A as default};
