import{F as e,I as t,M as n,N as r,a as i,p as a,r as o,w as s}from"./dist-C1LXzuY9.js";import{I as c,N as l,Q as u,U as d,n as f,r as p}from"./repeat-D7ZcYN9W.js";import{t as m}from"./preload-helper-DzyYoeor.js";import{n as h,t as g}from"./events-B_ZxkU_G-CIQGcfIC.js";import"./lit-D5_fOPyp.js";var _=await o(Object.assign({"./commandpalette.de.json":()=>m(()=>import(`./commandpalette.de-Bv--GkIv-CHUvrHnl.js`),[]),"./commandpalette.en.json":()=>m(()=>import(`./commandpalette.en-BkZSMl1d-BVjLe8mC.js`),[])})),v=`commandpalette/open`,y=class extends i{constructor(...e){super(...e),this.inputValue=``,this.filteredCommands=[],this.allCommands=[],this.showParameterPrompt=!1,this.selectedCommand=null,this.parameterValues={},this.isPaletteOpen=!1,this.inputRef=f(),this.dialogRef=f()}async doInitUI(){h(v,()=>{this.openPalette()}),this.boundDocumentClickHandler=this.handleDocumentClick.bind(this),document.addEventListener(`click`,this.boundDocumentClickHandler)}async handleDocumentClick(e){if(!this.isPaletteOpen&&!this.showParameterPrompt)return;await this.updateComplete;let t=e.target;if(this.contains(t)||this.dialogRef.value&&this.dialogRef.value.contains(t))return;let n=t;for(;n;){if(n.tagName===`WA-DIALOG`)return;n=n.parentElement}this.closePalette(),this.closeParameterPrompt()}handleDialogClick(e){e.stopPropagation()}handleInputFocus(){requestAnimationFrame(()=>{this.isPaletteOpen=!0})}handleInputClick(e){e.stopPropagation(),this.openPalette()}handleInputMouseDown(e){e.stopPropagation()}updateCommandList(){let e=n.listCommands(this.executionContext||{});this.allCommands=Object.values(e).filter(e=>e.id!==`commandpalette.open`).map(e=>({id:e.id,name:e.name,description:e.description,icon:e.icon,keyBinding:e.keyBinding})),this.filteredCommands=[...this.allCommands]}async openPalette(){this.executionContext=n.createExecutionContext(),this.inputValue=``,this.updateCommandList(),this.showParameterPrompt=!1,this.isPaletteOpen=!0,await this.updateComplete,this.inputRef.value&&this.inputRef.value.focus()}closePalette(){this.isPaletteOpen=!1,this.inputValue=``,this.showParameterPrompt=!1,this.executionContext=void 0}handleInputChange(e){this.inputValue=e.target.value,this.filterCommands()}filterCommands(){if(!this.inputValue.trim())this.filteredCommands=[...this.allCommands];else{let e=this.inputValue.toLowerCase();this.filteredCommands=this.allCommands.filter(t=>t.name.toLowerCase().includes(e)||t.id.toLowerCase().includes(e)||t.description&&t.description.toLowerCase().includes(e))}}handleKeyDown(e){e.key===`Escape`&&(e.preventDefault(),this.closePalette())}handleCommandClick(e,t){t&&(e.stopPropagation(),this.inputValue=``,this.filterCommands(),this.runCommand(t))}handleContainerClick(e){e.stopPropagation()}runCommand(e){if(!e)return;let t=n.getCommand(e.id);t?.parameters&&t.parameters.length>0?(this.selectedCommand=t,this.parameterValues={},this.showParameterPrompt=!0):this.executeCommandWithParams(e.id,{})}executeCommandWithParams(e,t){try{n.execute(e,{...this.executionContext||{},params:t}),this.closePalette(),this.closeParameterPrompt()}catch(e){console.error(`Failed to execute command:`,e)}}closeParameterPrompt(){this.showParameterPrompt=!1,this.selectedCommand=null,this.parameterValues={}}handleParameterInput(e,t){this.parameterValues={...this.parameterValues,[e]:t}}executeWithParameters(){if(!this.selectedCommand)return;let e=this.selectedCommand.parameters?.filter(e=>e.required&&!this.parameterValues[e.name]).map(e=>e.name);if(e&&e.length>0){t(_.MISSING_REQUIRED_PARAMS({params:e.join(`, `)}));return}this.executeCommandWithParams(this.selectedCommand.id,this.parameterValues)}renderContent(){return d`
  ...
  `}};s([l()],y.prototype,`inputValue`,void 0),s([l()],y.prototype,`filteredCommands`,void 0),s([l()],y.prototype,`allCommands`,void 0),s([l()],y.prototype,`showParameterPrompt`,void 0),s([l()],y.prototype,`selectedCommand`,void 0),s([l()],y.prototype,`parameterValues`,void 0),s([l()],y.prototype,`isPaletteOpen`,void 0),y=s([c(`docks-command-palette`)],y),e({command:{id:`commandpalette.open`,name:_.OPEN_COMMAND_PALETTE,description:_.OPEN_COMMAND_PALETTE_DESC,icon:`terminal`,keyBinding:`CTRL+SHIFT+P`},handler:{execute:()=>(g(v,null),null)}}),r.registerContribution(a,{label:`Command Palette`,icon:`terminal`,component:()=>d`<docks-command-palette></docks-command-palette>`});