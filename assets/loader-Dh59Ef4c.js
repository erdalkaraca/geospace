import{d as e,n as t}from"./fs-access-D-fDaJ8V-CsJvJRH4.js";import{V as n,X as r,h as i,i as a,v as o}from"./repeat-CUOIy3cL.js";import{F as s,L as c,N as l,P as u,S as d,T as f,a as p,j as m,l as h,y as g}from"./dist-8hKpvNa5.js";import"./lit-CtVJFi4_.js";import{v as _}from"./src-BtgKmOay.js";import{a as v,i as y}from"./map-renderer-D4LmjFjM.js";import{i as b,o as x,r as S}from"./utils-Bvh5Osmx.js";import{i as C,t as w}from"./gs-map-editor-CGaDo0VT.js";import"./geo-BwI2KQCN.js";var T=class extends p{constructor(...e){super(...e),this.dropPosition=`before`}doBeforeUI(){this.watch(m,e=>{this.onPartChanged(e)}),this.watch(C,({part:e})=>{this.onMapChanged({part:e})})}onPartChanged(e){if(e!=this&&e!=this.mapEditor){if(!(e instanceof w)){this.mapEditor=void 0,this.requestUpdate();return}this.mapEditor=e,this.requestUpdate()}}onMapChanged({part:e}){e==this.mapEditor&&this.requestUpdate()}toggleVisible(e){let t=this.mapEditor.getGsMap(),n=y(t,e);if(!n)return;let r=n.visible===!1;this.mapEditor?.mapOperations?.setLayerVisible(e,r),this.updateLater()}async confirmAction(e,t){await g(e)&&t()}selectLayer(e){this.selectedLayerUuid=e}renameLayer(e){if(!this.mapEditor)return;let t=e||this.selectedLayerUuid;if(!t)return;let n=this.mapEditor.getGsMap();if(!y(n,t))return;let r=v(n,t),i=u.createExecutionContext({index:r+1});u.execute(`rename_layer`,i)}deleteLayer(e){if(!this.mapEditor)return;let t=e||this.selectedLayerUuid;if(!t)return;let n=this.mapEditor.getGsMap(),r=y(n,t);r&&this.confirmAction(`Delete layer "${r.name||`Layer`}"?`,()=>this.withRefresh(()=>this.mapEditor?.mapOperations?.deleteLayer(t)))}moveLayerUp(e){if(!this.mapEditor)return;let t=this.mapEditor.getGsMap();if(!t)return;let n=v(t,e);if(n<=0)return;let r=t.layers[n-1]?.uuid;r&&(this.withRefresh(()=>this.mapEditor?.mapOperations?.moveLayer(e,r)),this.selectedLayerUuid=r)}layerLabel(e,t){return e.type===_.SCRIPTED?e.name??`Scripted Layer ${t+1}`:e.name??`Layer ${t+1}`}moveLayerDown(e){if(!this.mapEditor)return;let t=this.mapEditor.getGsMap();if(!t)return;let n=v(t,e);if(n<0||n>=t.layers.length-1)return;let r=t.layers[n+1]?.uuid;r&&(this.withRefresh(()=>this.mapEditor?.mapOperations?.moveLayer(e,r)),this.selectedLayerUuid=r)}isCommandEvent(e){return e.composedPath().some(e=>e instanceof HTMLElement&&e.tagName===`DOCKS-COMMAND`)}onLayerDragStart(e,t){if(!t||this.isCommandEvent(e)||!e.dataTransfer){e.preventDefault();return}this.draggedLayerUuid=t,this.dropTargetLayerUuid=void 0,this.selectedLayerUuid=t,e.dataTransfer.effectAllowed=`move`,e.dataTransfer.setData(`text/plain`,t)}onLayerDragOver(e,t){if(!t||!this.draggedLayerUuid||t===this.draggedLayerUuid)return;e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect=`move`);let n=e.currentTarget;if(n){let t=n.getBoundingClientRect();this.dropPosition=e.clientY<t.top+t.height/2?`before`:`after`}this.dropTargetLayerUuid=t}dropLayerAtPosition(e,t,n){let r=this.mapEditor?.getGsMap();if(!r)return;let i=r.layers,a=v(r,e),o=v(r,t);if(a<0||o<0)return;let s=n===`before`?o:o+1,c=Math.min(s,i.length-1);if(c===a)return;let l=i[c]?.uuid;l&&(this.withRefresh(()=>this.mapEditor?.mapOperations?.moveLayer(e,l)),this.selectedLayerUuid=e)}onLayerDrop(e,t){e.preventDefault();let n=this.draggedLayerUuid,r=this.dropPosition;this.draggedLayerUuid=void 0,this.dropTargetLayerUuid=void 0,this.dropPosition=`before`,!(!n||!t||n===t)&&this.dropLayerAtPosition(n,t,r)}onLayerDragEnd(){this.draggedLayerUuid=void 0,this.dropTargetLayerUuid=void 0,this.dropPosition=`before`}renderToolbar(){let e=this.selectedLayerUuid!==void 0,t=this.mapEditor?.getGsMap(),r=e&&t&&this.selectedLayerUuid?v(t,this.selectedLayerUuid):-1,i=r>0,a=r>=0&&!!t&&r<t.layers.length-1;return n`
        ...
        `}renderContextMenu(){let e=this.selectedLayerUuid!==void 0,t=this.mapEditor?.getGsMap(),r=e&&t&&this.selectedLayerUuid?v(t,this.selectedLayerUuid):-1,i=r>0,a=r>=0&&!!t&&r<t.layers.length-1;return n`
            <docks-command ?disabled=${!i}
                      icon="arrow-up"
                      .action=${()=>this.selectedLayerUuid&&this.moveLayerUp(this.selectedLayerUuid)}>
                Move Up
        ...
        `}renderContent(){return a(!this.mapEditor,()=>n`
                    <docks-no-content message="Select a map."></docks-no-content>`,()=>n`
                <wa-tree>
                    <wa-tree-item expanded>
                        ${d(`fg layers`)} Layers
                        ${this.mapEditor.getGsMap()?.layers.map((e,t)=>n`
                                ...
                                <div class="layer-item">
                                    <div class="layer-main">
                                        ...
                                        <div class="layer-name">
                                            <span>${this.layerLabel(e,t)}${t==0?n`
                                                <small>(basemap)</small>`:``}
                                                ${e.type===_.SCRIPTED?n`
                    ...
                    <wa-tree-item expanded>
                        ...
                        ${this.mapEditor?.getGsMap()?.controls.map(e=>n`
                            <wa-tree-item>
                                <span>${S(e.src)}</span>
                                <docks-command size="small"
                                          icon="trash"
                    ...
                    <wa-tree-item expanded>
                        ...
                        ${this.mapEditor?.getGsMap()?.overlays.map(e=>n`
                            <wa-tree-item>
                                <span>${S(e.src)}</span>
                                <docks-command size="small"
                                          icon="trash"
