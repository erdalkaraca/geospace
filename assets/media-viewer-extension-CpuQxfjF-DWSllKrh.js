import{n as e}from"./fs-access-D-fDaJ8V-CsJvJRH4.js";import{L as t,V as n,X as r,g as i,h as a,v as o}from"./repeat-CUOIy3cL.js";import{T as s,a as c,n as l}from"./dist-8hKpvNa5.js";var u=[`.pdf`,`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],d=e=>{let t=e.toLowerCase();return t.endsWith(`.pdf`)?`file-pdf`:t.match(/\.(jpg|jpeg|png|gif|webp|bmp|ico|svg)$/)?`image`:`file`},f=e=>{let t=e.getName().toLowerCase();return u.some(e=>t.endsWith(e))},p=[`.jpg`,`.jpeg`,`.png`,`.gif`,`.svg`,`.webp`,`.bmp`,`.ico`],m=e=>{let t=e.getName().toLowerCase();return p.some(e=>t.endsWith(e))};l.registerEditorInputHandler({editorId:`system.media-viewer`,label:`Media viewer`,canHandle:t=>t instanceof e&&f(t),handle:async e=>{let t={title:e.getWorkspacePath(),data:e,key:e.getWorkspacePath(),icon:d(e.getName()),state:{}};return t.component=e=>n`
                            ...
                            <div class="overlay-layer">
                                ${this.overlays.map(e=>e.type===`bbox`?n`
                                    <div
                                        ...
                                        title="${e.label??``}"
                                    >
                                        ${e.label?n`<span class="overlay-label">${e.label}</span>`:t}
                                    </div>
                                `:e.type===`mask`?n`
                                    <img
                                        class="overlay-mask"
    ...
    `}};s([i({attribute:!1})],h.prototype,`input`,void 0),s([a()],h.prototype,`mediaUrl`,void 0),s([a()],h.prototype,`imageNaturalWidth`,void 0),s([a()],h.prototype,`imageNaturalHeight`,void 0),s([a()],h.prototype,`overlays`,void 0),h=s([o(`docks-media-viewer`)],h);export{h as DocksMediaViewer};