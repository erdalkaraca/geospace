import{w as e}from"./dist-C1LXzuY9.js";import{I as t,L as n,N as r,P as i,Q as a,U as o,r as s,t as c}from"./repeat-D7ZcYN9W.js";import{m as l}from"./fs-access-D-fDaJ8V-BQA-EXV_.js";var u=class extends n{constructor(...e){super(...e),this.open=!1,this.packages=[],this.loadingPackages=!1}configure(e){this.packages=e.packages||[],this.pyenv=e.pyenv,this.onPackageAdded=e.onPackageAdded,this.onPackageRemoved=e.onPackageRemoved}show(){this.open=!0}hide(){this.open=!1}addPackage(e){if(!e||e.trim()===``)return;let t=e.trim();this.packages.includes(t)||(this.packages=[...this.packages,t],this.onPackageAdded?.(t))}removePackage(e){this.packages.indexOf(e)>-1&&(this.packages=this.packages.filter(t=>t!==e),this.onPackageRemoved?.(e))}async reloadPackages(){if(this.pyenv){this.loadingPackages=!0,this.packageLoadError=void 0;try{await this.pyenv.loadPackages(this.packages)}catch(e){this.packageLoadError=String(e)}finally{this.loadingPackages=!1}}}render(){let e;return o`
    ...
    `}};e([i({type:Boolean})],u.prototype,`open`,void 0),e([i({type:Array})],u.prototype,`packages`,void 0),e([i({attribute:!1})],u.prototype,`pyenv`,void 0),e([r()],u.prototype,`loadingPackages`,void 0),e([r()],u.prototype,`packageLoadError`,void 0),u=e([t(`docks-python-package-manager`)],u);var d=new class{showPackageManager(e){return this.managerInstance||(this.managerInstance=document.createElement(`docks-python-package-manager`),document.body.appendChild(this.managerInstance)),this.managerInstance.configure(e),this.managerInstance.show(),this.managerInstance}getManager(){return this.managerInstance}};l.put(`pythonPackageManagerService`,d);export{d as t};