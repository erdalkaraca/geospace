import{f as p,G as h,b as u,a as m}from"./main-DsHFIyhT.js";import{i as w,x as r,b as v,n as y,r as c,t as f}from"./index-DoDY4M9O.js";var S=Object.defineProperty,k=Object.getOwnPropertyDescriptor,o=(e,t,i,l)=>{for(var s=l>1?void 0:l?k(t,i):t,n=e.length-1,d;n>=0;n--)(d=e[n])&&(s=(l?d(t,i,s):d(s))||s);return l&&s&&S(t,i,s),s};let a=class extends w{constructor(){super(...arguments),this.open=!1}show(e){this.onSave=e,this.gsMap&&(this.workingStyles=JSON.parse(JSON.stringify(this.gsMap.styles||{})),this.workingRules=JSON.parse(JSON.stringify(this.gsMap.styleRules||[]))),this.open=!0,this.requestUpdate()}hide(){this.open=!1,this.selectedStyleId=void 0,this.selectedRuleId=void 0,this.workingStyles=void 0,this.workingRules=void 0,this.gsMap=void 0,this.requestUpdate()}handleCancel(){this.hide()}handleSave(){this.gsMap&&this.workingStyles&&this.workingRules&&(this.gsMap.styles=this.workingStyles,this.gsMap.styleRules=this.workingRules),this.onSave&&this.onSave(),this.hide()}handleStyleSelect(e){this.selectedStyleId=e}handleRuleSelect(e){this.selectedRuleId=e}renderStylesTab(){return r`
