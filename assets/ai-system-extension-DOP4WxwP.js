const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-CY9-3YkN.js","assets/index-B-or_cqe.js","assets/index-C2t38aP0.css","assets/main-Bk6wZs2B.css"])))=>i.map(i=>d[i]);
import{p as Q,q as L,m as z,J as Y,L as X,K as Z,k as j,b as M,x as G,t as ee,u as te,a as se,I as ae,r as ie}from"./main-CY9-3YkN.js";import{a as k,n as g,r as I,i as E,x as n,l as d,o as re,t as T,ac as oe,_}from"./index-B-or_cqe.js";var ne=Object.defineProperty,le=Object.getOwnPropertyDescriptor,N=(a,e,s,t)=>{for(var i=t>1?void 0:t?le(e,s):e,r=a.length-1,o;r>=0;r--)(o=a[r])&&(i=(t?o(e,s,i):o(i))||i);return t&&i&&ne(e,s,i),i};let C=class extends E{constructor(){super(...arguments),this.isStreaming=!1,this.showHeader=!0,this.attentionInputValue=""}formatTimestamp(){return new Date().toLocaleTimeString()}copyToClipboard(a){navigator.clipboard.writeText(a).catch(e=>{console.error("Failed to copy:",e)})}processMarkdownContent(a){return a.includes("code-block-wrapper")?a:a.replace(/<pre><code([^>]*)>([\s\S]*?)<\/code><\/pre>/gi,(e,s,t)=>`<div class="code-block-wrapper">
