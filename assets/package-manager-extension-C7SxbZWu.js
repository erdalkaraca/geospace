import{a as d,k as m,x as o,h}from"./index-CGmBFeLm.js";import{r as k,p as u,n as g,d as l,e as f}from"./main-DJJFELAT.js";var y=Object.defineProperty,v=Object.getOwnPropertyDescriptor,s=(a,e,t,r)=>{for(var i=r>1?void 0:r?v(e,t):e,c=a.length-1,p;c>=0;c--)(p=a[c])&&(i=(r?p(e,t,i):p(i))||i);return r&&i&&y(e,t,i),i};let n=class extends d{constructor(){super(...arguments),this.open=!1,this.packages=[],this.loadingPackages=!1}configure(a){this.packages=a.packages||[],this.pyenv=a.pyenv,this.onPackageAdded=a.onPackageAdded,this.onPackageRemoved=a.onPackageRemoved}show(){this.open=!0}hide(){this.open=!1}addPackage(a){var t;if(!a||a.trim()==="")return;const e=a.trim();this.packages.includes(e)||(this.packages=[...this.packages,e],(t=this.onPackageAdded)==null||t.call(this,e))}removePackage(a){var t;this.packages.indexOf(a)>-1&&(this.packages=this.packages.filter(r=>r!==a),(t=this.onPackageRemoved)==null||t.call(this,a))}async reloadPackages(){if(this.pyenv){this.loadingPackages=!0,this.packageLoadError=void 0;try{await this.pyenv.loadPackages(this.packages)}catch(a){this.packageLoadError=String(a)}finally{this.loadingPackages=!1}}}render(){let a;return o`
    ...
    `;s([g({type:Boolean})],n.prototype,"open",2);s([g({type:Array})],n.prototype,"packages",2);s([g({attribute:!1})],n.prototype,"pyenv",2);s([l()],n.prototype,"loadingPackages",2);s([l()],n.prototype,"packageLoadError",2);n=s([f("k-python-package-manager")],n);class w{showPackageManager(e){return this.managerInstance||(this.managerInstance=document.createElement("k-python-package-manager"),document.body.appendChild(this.managerInstance)),this.managerInstance.configure(e),this.managerInstance.show(),this.managerInstance}getManager(){return this.managerInstance}}const P=new w,$=({})=>{k.put("pythonPackageManagerService",P)};export{n as KPythonPackageManager,$ as default,P as pythonPackageManagerService};
