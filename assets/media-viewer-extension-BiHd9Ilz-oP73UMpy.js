import{z as c,u as f,x as d,s as p,Z as m,$ as u,a1 as g,a0 as h}from"./index-BgkfMran.js";import"./preload-helper-WQhrSmCl.js";import"./chunk.LTSJC6DR-BCCP1Gxs.js";var w=Object.defineProperty,v=Object.getOwnPropertyDescriptor,l=(e,t,a,s)=>{for(var i=s>1?void 0:s?v(t,a):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(i=(s?o(t,a,i):o(i))||i);return s&&i&&w(t,a,i),i};const b=[".pdf",".jpg",".jpeg",".png",".gif",".svg",".webp",".bmp",".ico"],y=e=>{const t=e.toLowerCase();return t.endsWith(".pdf")?"file-pdf":t.match(/\.(jpg|jpeg|png|gif|webp|bmp|ico|svg)$/)?"image":"file"},U=e=>{const t=e.getName().toLowerCase();return b.some(a=>t.endsWith(a))};p.registerEditorInputHandler({canHandle:e=>e instanceof f&&U(e),handle:async e=>{const t={title:e.getName(),data:e,key:e.getName(),editorId:"media-viewer",icon:y(e.getName()),noOverflow:!1,state:{}};return t.widgetFactory=()=>d`
