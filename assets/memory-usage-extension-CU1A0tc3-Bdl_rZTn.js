import{c,m as o,n as d}from"./config-ByP2ak92-zMGYTrLw.js";import{t as m,b as l}from"./webawesome-Bcy1vMqC.js";import"./preload-helper-BXl3LOEh.js";import"./chunk.FSRXYGSW-CMgxtNeZ.js";var u=Object.getOwnPropertyDescriptor,g=(e,r,i,a)=>{for(var t=a>1?void 0:a?u(r,i):r,n=e.length-1,s;n>=0;n--)(s=e[n])&&(t=s(t)||t);return t};let p=class extends d{constructor(){super(...arguments),this.updateInterval=null}connectedCallback(){super.connectedCallback(),this.updateInterval=window.setInterval(()=>{this.requestUpdate()},2e3)}disconnectedCallback(){super.disconnectedCallback(),this.updateInterval!==null&&(clearInterval(this.updateInterval),this.updateInterval=null)}render(){const e=performance.memory;if(!e)return l``;const r=(e.totalJSHeapSize/1048576).toFixed(1),i=(e.jsHeapSizeLimit/1048576).toFixed(0),a=e.totalJSHeapSize/e.jsHeapSizeLimit*100,t=a.toFixed(0),n=a>80?"#ff4444":a>60?"#ffaa00":"#44aa44";return l`
        ...
        `}};p=g([m("lyra-memory-usage")],p);c.registerContribution(o,{target:o,label:"Memory",component:"<lyra-memory-usage></lyra-memory-usage>"});
