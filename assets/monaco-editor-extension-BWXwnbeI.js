import{U as g,e as u,s as m}from"./editor.main-C79rY1YI.js";import{e as f,x as d,b as k,c as y,a as w,n as h,r as l,t as v}from"./index-C4bFKT08.js";import{K as P,e as p,P as C,w as x,h as W,F as q}from"./main-CxIJLZi0.js";import{pythonPackageManagerService as $}from"./package-manager-extension-BA0FlSEh.js";function b(e){return new Worker("/assets/editor.worker-Ba5z4c26.js",{type:"module",name:e?.name})}function E(e){return new Worker("/assets/json.worker-De6w3Aj2.js",{type:"module",name:e?.name})}function I(e){return new Worker("/assets/css.worker-Brt0-qFL.js",{type:"module",name:e?.name})}function j(e){return new Worker("/assets/html.worker-DA9W98Qi.js",{type:"module",name:e?.name})}function R(e){return new Worker("/assets/ts.worker-C1ZVYqYQ.js",{type:"module",name:e?.name})}var L=Object.defineProperty,M=Object.getOwnPropertyDescriptor,c=(e,t,r,n)=>{for(var a=n>1?void 0:n?M(t,r):t,s=e.length-1,o;s>=0;s--)(o=e[s])&&(a=(n?o(t,r,a):o(a))||a);return n&&a&&L(t,r,a),a};self.MonacoEnvironment={getWorker(e,t){return t==="json"?new E:t==="css"||t==="scss"||t==="less"?new I:t==="html"||t==="handlebars"||t==="razor"?new j:t==="typescript"||t==="javascript"?new R:new b}};W.registerEditorInputHandler({canHandle:e=>e instanceof q,handle:async e=>{const t={title:e.getName(),data:e,key:e.getName(),editorId:"monaco-editor",icon:"file-pen",noOverflow:!1,state:{}};return t.widgetFactory=()=>d`
