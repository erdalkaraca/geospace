import{n as y,d as c,e as m,f as p,G as h,c as u,t as w}from"./main-BLllCBv8.js";import{a as v,x as r,h as f}from"./index-CBe0mDof.js";var S=Object.defineProperty,k=Object.getOwnPropertyDescriptor,o=(e,t,i,l)=>{for(var s=l>1?void 0:l?k(t,i):t,n=e.length-1,d;n>=0;n--)(d=e[n])&&(s=(l?d(t,i,s):d(s))||s);return l&&s&&S(t,i,s),s};let a=class extends v{constructor(){super(...arguments),this.open=!1}show(e){this.onSave=e,this.gsMap&&(this.workingStyles=JSON.parse(JSON.stringify(this.gsMap.styles||{})),this.workingRules=JSON.parse(JSON.stringify(this.gsMap.styleRules||[]))),this.open=!0,this.requestUpdate()}hide(){this.open=!1,this.selectedStyleId=void 0,this.selectedRuleId=void 0,this.workingStyles=void 0,this.workingRules=void 0,this.gsMap=void 0,this.requestUpdate()}handleCancel(){this.hide()}handleSave(){this.gsMap&&this.workingStyles&&this.workingRules&&(this.gsMap.styles=this.workingStyles,this.gsMap.styleRules=this.workingRules),this.onSave&&this.onSave(),this.hide()}handleStyleSelect(e){this.selectedStyleId=e}handleRuleSelect(e){this.selectedRuleId=e}renderStylesTab(){return r`
    ...
    `;o([y({type:Object})],a.prototype,"gsMap",2);o([y({type:Boolean})],a.prototype,"open",2);o([c()],a.prototype,"selectedStyleId",2);o([c()],a.prototype,"selectedRuleId",2);o([c()],a.prototype,"workingStyles",2);o([c()],a.prototype,"workingRules",2);a=o([m("gs-style-editor")],a);const x=({commandRegistry:e})=>{e.registerAll({command:{id:"edit_styles",name:"Edit Styles",description:"Opens the style editor to define and edit map styles and rules",parameters:[]},handler:{execute:async t=>{const i=p.get();if(!(i instanceof h)){u("No active map editor");return}const l=i.getGsMap();if(!l){u("Map not initialized");return}let s=document.querySelector("gs-style-editor");s||(s=new a,document.body.appendChild(s)),s.gsMap=l,await s.updateComplete,s.show(()=>{i.markDirty(!0),i.refresh(),w("Styles updated")})}},contribution:{target:"toolbar:map-editor",icon:"palette",label:"Edit Styles",disabled:()=>!(p.get()instanceof h)}})};export{x as default};
