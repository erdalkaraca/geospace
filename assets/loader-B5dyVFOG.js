import{G as b}from"./gs-map-editor-BSv0ifMB.js";import{i as D,b as r,d as T,n as I,c as y,t as O}from"./webawesome-C6zoK8ho.js";import{E as w}from"./index-bxjZJoCW.js";import{N as C,t as x,v as L}from"./config-BnnWtrGw-B7Dvw4S0.js";import"./_commonjs-dynamic-modules-TDtrdbi3.js";import"./__vite-browser-external-DrV_kz0N.js";import"./third-party-BW12UeC1.js";const F=D`
    wa-dialog {
        --width: 900px;
    }
...
`;function A(e){const t=e.stroke?.color||"transparent",a=e.fill?.color||"transparent",i=Math.min(e.stroke?.width||1,5),o=e.stroke?.lineDash?.join(" ")||"none",n=e.stroke?.lineCap||"round",l=e.stroke?.lineJoin||"round";return e.image?.type==="circle"?E(e,t,a,i):e.image?.type==="regular-shape"?j(e,t,a,i):e.image?.type==="icon"?z(e):r`
    ...
    `}function le(e,t,a,i){const o=e[t];if(!o)return null;let n=o;for(let c=0;c<a.length-1;c++){const d=a[c];n[d]||(n[d]={}),n=n[d]}const l=a[a.length-1];return n[l]===i?null:(i===void 0?delete n[l]:n[l]=i,{...e})}function se(e){return{onStrokeColorChange:t=>e(["stroke","color"],t),onStrokeWidthChange:t=>e(["stroke","width"],t),onStrokeLineDashChange:t=>e(["stroke","lineDash"],t),onStrokeLineCapChange:t=>e(["stroke","lineCap"],t),onStrokeLineJoinChange:t=>e(["stroke","lineJoin"],t),onFillColorChange:t=>e(["fill","color"],t),onImageTypeChange:t=>e(["image","type"],t),onImageRotationChange:t=>e(["image","rotation"],t),onImageOpacityChange:t=>e(["image","opacity"],t),onImageScaleChange:t=>e(["image","scale"],t),onImageRadiusChange:t=>e(["image","radius"],t),onImageFillColorChange:t=>e(["image","fill","color"],t),onImageStrokeColorChange:t=>e(["image","stroke","color"],t),onImageStrokeWidthChange:t=>e(["image","stroke","width"],t),onImageSrcChange:t=>e(["image","src"],t),onImageColorChange:t=>e(["image","color"],t),onImageAnchorChange:t=>e(["image","anchor"],t),onImagePointsChange:t=>e(["image","points"],t),onImageRadius2Change:t=>e(["image","radius2"],t),onImageAngleChange:t=>e(["image","angle"],t)}}var ce=Object.defineProperty,de=Object.getOwnPropertyDescriptor,v=(e,t,a,i)=>{for(var o=i>1?void 0:i?de(t,a):t,n=e.length-1,l;n>=0;n--)(l=e[n])&&(o=(i?l(t,a,o):l(o))||o);return i&&o&&ce(t,a,o),o};let h=class extends T{constructor(){super(...arguments),this.open=!1,this.handleDialogHide=e=>{e.target.tagName.toLowerCase()==="wa-dialog"&&this.hide()},this.handleCancel=()=>{this.hide()},this.handleSave=()=>{this.gsMap&&this.workingStyles&&this.workingRules&&(this.gsMap.styles=this.workingStyles,this.gsMap.styleRules=this.workingRules),this.onSave?.(),this.hide()},this.handleAddStyle=()=>{console.log("Add style")},this.handleAddRule=()=>{console.log("Add rule")}}show(e){this.onSave=e,this.gsMap&&(this.workingStyles=JSON.parse(JSON.stringify(this.gsMap.styles||{})),this.workingRules=JSON.parse(JSON.stringify(this.gsMap.styleRules||[]))),this.open=!0,this.requestUpdate()}hide(){this.open=!1,this.selectedStyleId=void 0,this.selectedRuleId=void 0,this.workingStyles=void 0,this.workingRules=void 0,this.gsMap=void 0,this.requestUpdate()}render(){return this.open?r`
        ...
        `}renderSelectedStyleDetail(){if(!this.selectedStyleId||!this.workingStyles?.[this.selectedStyleId])return r`
            ...
            `;const e=this.workingStyles[this.selectedStyleId],t=N(this.selectedStyleId,this.workingRules||[]),a=se((i,o)=>this.updateStyleProperty(i,o));return K(this.selectedStyleId,e,t,a)}renderRulesTab(){return r`
