const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/main-B44y2N-Y.js","assets/index-C4bFKT08.js","assets/index-C2t38aP0.css","assets/main-Bk6wZs2B.css"])))=>i.map(i=>d[i]);
import{o as Q,p as L,k as z,J as Y,L as X,K as Z,j as G,c as M,v as R,b as ee,u as te,t as se,r as ae}from"./main-B44y2N-Y.js";import{a as I,n as g,r as k,i as T,x as n,l as p,o as ie,t as q,ab as re,_ as j}from"./index-C4bFKT08.js";var oe=Object.defineProperty,ne=Object.getOwnPropertyDescriptor,N=(s,e,a,t)=>{for(var i=t>1?void 0:t?ne(e,a):e,o=s.length-1,r;o>=0;o--)(r=s[o])&&(i=(t?r(e,a,i):r(i))||i);return t&&i&&oe(e,a,i),i};let C=class extends T{constructor(){super(...arguments),this.isStreaming=!1,this.showHeader=!0,this.attentionInputValue=""}formatTimestamp(){return new Date().toLocaleTimeString()}copyToClipboard(s){navigator.clipboard.writeText(s).catch(e=>{console.error("Failed to copy:",e)})}processMarkdownContent(s){return s.includes("code-block-wrapper")?s:s.replace(/<pre><code([^>]*)>([\s\S]*?)<\/code><\/pre>/gi,(e,a,t)=>`<div class="code-block-wrapper">
    ...
    `;N([g({type:Object,attribute:!1})],C.prototype,"message",2);N([g({type:Boolean})],C.prototype,"isStreaming",2);N([g({type:Boolean})],C.prototype,"showHeader",2);N([g({type:Number,attribute:!1})],C.prototype,"messageIndex",2);N([k()],C.prototype,"attentionInputValue",2);C=N([q("ai-chat-message")],C);var le=Object.defineProperty,ce=Object.getOwnPropertyDescriptor,U=(s,e,a,t)=>{for(var i=t>1?void 0:t?ce(e,a):e,o=s.length-1,r;o>=0;o--)(r=s[o])&&(i=(t?r(e,a,i):r(i))||i);return t&&i&&le(e,a,i),i};let P=class extends T{constructor(){super(...arguments),this.value="",this.disabled=!1,this.busy=!1,this.hasProvider=!0}onInput(s){const e=s.target;this.value=e.value,this.dispatchEvent(new CustomEvent("input-change",{detail:{value:this.value},bubbles:!0,composed:!0}))}onKeyDown(s){s.key==="Enter"&&!s.shiftKey&&(s.preventDefault(),this.send())}async send(){if(!this.value.trim()||this.disabled||!this.hasProvider)return;const s=this.value;this.value="",this.requestUpdate(),await this.updateComplete,this.textareaElement&&(this.textareaElement.value="",this.textareaElement.focus()),this.dispatchEvent(new CustomEvent("send",{detail:{value:s},bubbles:!0,composed:!0}))}cancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}openSettings(){this.dispatchEvent(new CustomEvent("open-settings",{bubbles:!0,composed:!0}))}render(){return n`
    ...
    `;U([g({type:String})],P.prototype,"value",2);U([g({type:Boolean})],P.prototype,"disabled",2);U([g({type:Boolean})],P.prototype,"busy",2);U([g({type:Boolean})],P.prototype,"hasProvider",2);U([re("wa-textarea")],P.prototype,"textareaElement",2);P=U([q("ai-chat-input")],P);var de=Object.defineProperty,pe=Object.getOwnPropertyDescriptor,H=(s,e,a,t)=>{for(var i=t>1?void 0:t?pe(e,a):e,o=s.length-1,r;o>=0;o--)(r=s[o])&&(i=(t?r(e,a,i):r(i))||i);return t&&i&&de(e,a,i),i};let K=class extends T{constructor(){super(...arguments),this.message="No AI provider configured",this.hint="Click the settings button to configure"}render(){return n`
    ...
    `;H([g({type:String})],K.prototype,"message",2);H([g({type:String})],K.prototype,"hint",2);K=H([q("ai-empty-state")],K);var ge=Object.getOwnPropertyDescriptor,ue=(s,e,a,t)=>{for(var i=t>1?void 0:t?ge(e,a):e,o=s.length-1,r;o>=0;o--)(r=s[o])&&(i=r(i)||i);return i};let W=class extends T{render(){return n`
                ...
                ${p(s.length>0,()=>n`
                    ...
                    ${this.pendingToolApprovals.size>0?n`
                        <div class="tool-approval-section">
                            ${Array.from(this.pendingToolApprovals.entries()).map(([t,i])=>{const o=i.request.toolCalls,r=o.length;o.map(c=>{const u=c.function.arguments||"{}";let h={};try{h=JSON.parse(u)}catch{h={}}const A=Object.entries(h).map(([f,b])=>`${f}=${JSON.stringify(b)}`).join(", ");return`${c.function.name}${A?`(${A})`:"()"}`}).join(", ");const l=`Tool execution pending: ${r} tool${r>1?"s":""} (${o[0]?.function.name}${r>1?", ...":""})`;return n`
                                    <wa-details class="approval-details">
                                        ...
                                        <div class="approval-content">
                                            <div class="approval-message">
                                                ...
                                                <ul class="tool-list">
                                                    ${o.map(c=>{const u=c.function.arguments||"{}";let h={};try{h=JSON.parse(u)}catch{h={}}const A=Object.entries(h).length>0?`(${Object.entries(h).map(([b,$])=>`${b}=${JSON.stringify($)}`).join(", ")})`:"()",f=i.allowListSelections.get(c.id)||!1;return n`
