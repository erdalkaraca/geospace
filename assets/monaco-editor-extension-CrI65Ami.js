import{U as p,e as l,s as y}from"./editor.main-V90s_O0y.js";import{e as f,w as g,f as v,d as w,b as k,x as d,F as x,a as W,n as h,c as m,t as C}from"./index-DUZ9xzhO.js";import{e as E,t as u,c as $,P as j,i as P}from"./main-C15lmSu1.js";function R(e){return new Worker("/assets/editor.worker-BKDaejSB.js",{type:"module",name:e==null?void 0:e.name})}function D(e){return new Worker("/assets/json.worker-bnpFxRku.js",{type:"module",name:e==null?void 0:e.name})}function I(e){return new Worker("/assets/css.worker-BAVIDzD3.js",{type:"module",name:e==null?void 0:e.name})}function O(e){return new Worker("/assets/html.worker-De8bSgst.js",{type:"module",name:e==null?void 0:e.name})}function _(e){return new Worker("/assets/ts.worker-8yPRNxAu.js",{type:"module",name:e==null?void 0:e.name})}var b=Object.defineProperty,L=Object.getOwnPropertyDescriptor,s=(e,t,r,o)=>{for(var n=o>1?void 0:o?L(t,r):t,i=e.length-1,c;i>=0;i--)(c=e[i])&&(n=(o?c(t,r,n):c(n))||n);return o&&n&&b(t,r,n),n};self.MonacoEnvironment={getWorker(e,t){return t==="json"?new D:t==="css"||t==="scss"||t==="less"?new I:t==="html"||t==="handlebars"||t==="razor"?new O:t==="typescript"||t==="javascript"?new _:new R}};P.registerEditorInputHandler({canHandle:e=>e instanceof x,handle:async e=>{const t={title:e.getName(),data:e,key:e.getName(),icon:"file-pen",noOverflow:!1,state:{}};return t.widgetFactory=()=>d`
