import{b as r,A as g,i as c,n as p,c as n,t as v}from"./webawesome-C6zoK8ho.js";import{L as f,F as m,d as u}from"./config-BnnWtrGw-B7Dvw4S0.js";var y=Object.defineProperty,b=Object.getOwnPropertyDescriptor,l=(t,e,a,o)=>{for(var i=o>1?void 0:o?b(e,a):e,d=t.length-1,h;d>=0;d--)(h=t[d])&&(i=(o?h(e,a,i):h(i))||i);return o&&i&&y(e,a,i),i};const w=[".pdf",".jpg",".jpeg",".png",".gif",".svg",".webp",".bmp",".ico"],N=t=>{const e=t.toLowerCase();return e.endsWith(".pdf")?"file-pdf":e.match(/\.(jpg|jpeg|png|gif|webp|bmp|ico|svg)$/)?"image":"file"},$=t=>{const e=t.getName().toLowerCase();return w.some(a=>e.endsWith(a))},I=[".jpg",".jpeg",".png",".gif",".svg",".webp",".bmp",".ico"],x=t=>{const e=t.getName().toLowerCase();return I.some(a=>e.endsWith(a))};u.registerEditorInputHandler({editorId:"system.media-viewer",label:"Media viewer",canHandle:t=>t instanceof m&&$(t),handle:async t=>{const e={title:t.getWorkspacePath(),data:t,key:t.getWorkspacePath(),icon:N(t.getName()),noOverflow:!1,state:{}};return e.component=()=>r`
