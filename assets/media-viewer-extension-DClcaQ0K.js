import{x as d,u as c,y as m,z as p,A as u}from"./index-CJNm_9Df.js";import{m as g,F as f,x as h}from"./geospace-app-Dim86q1_.js";import"./preload-helper-WQhrSmCl.js";var w=Object.defineProperty,v=Object.getOwnPropertyDescriptor,l=(e,t,a,s)=>{for(var i=s>1?void 0:s?v(t,a):t,n=e.length-1,o;n>=0;n--)(o=e[n])&&(i=(s?o(t,a,i):o(i))||i);return s&&i&&w(t,a,i),i};const y=[".pdf",".jpg",".jpeg",".png",".gif",".svg",".webp",".bmp",".ico"],b=e=>{const t=e.toLowerCase();return t.endsWith(".pdf")?"file-pdf":t.match(/\.(jpg|jpeg|png|gif|webp|bmp|ico|svg)$/)?"image":"file"},U=e=>{const t=e.getName().toLowerCase();return y.some(a=>t.endsWith(a))};h.registerEditorInputHandler({canHandle:e=>e instanceof f&&U(e),handle:async e=>{const t={title:e.getName(),data:e,key:e.getName(),editorId:"media-viewer",icon:b(e.getName()),noOverflow:!1,state:{}};return t.widgetFactory=()=>d`
