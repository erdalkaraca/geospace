import{U as g,e as u,s as m}from"./editor.main-C6KMLis9.js";import{e as f,x as d,b as k,c as y,a as v,n as h,r as l,t as w}from"./index-ZfqTFlZV.js";import{k as P,g as p,P as C,w as x,v as W,F as q}from"./main-rjErSQkj.js";import{pythonPackageManagerService as $}from"./package-manager-extension-BIKqhMrH.js";function b(e){return new Worker("/assets/editor.worker-DQhYWB7U.js",{type:"module",name:e?.name})}function E(e){return new Worker("/assets/json.worker-CYYcPfDN.js",{type:"module",name:e?.name})}function I(e){return new Worker("/assets/css.worker-CC5rmbn1.js",{type:"module",name:e?.name})}function j(e){return new Worker("/assets/html.worker-Ckn_qFYN.js",{type:"module",name:e?.name})}function R(e){return new Worker("/assets/ts.worker-BCmOSS3C.js",{type:"module",name:e?.name})}var M=Object.defineProperty,L=Object.getOwnPropertyDescriptor,c=(e,t,r,n)=>{for(var a=n>1?void 0:n?L(t,r):t,s=e.length-1,o;s>=0;s--)(o=e[s])&&(a=(n?o(t,r,a):o(a))||a);return n&&a&&M(t,r,a),a};self.MonacoEnvironment={getWorker(e,t){return t==="json"?new E:t==="css"||t==="scss"||t==="less"?new I:t==="html"||t==="handlebars"||t==="razor"?new j:t==="typescript"||t==="javascript"?new R:new b}};W.registerEditorInputHandler({canHandle:e=>e instanceof q,handle:async e=>{const t={title:e.getName(),data:e,key:e.getName(),editorId:"monaco-editor",icon:"file-pen",noOverflow:!1,state:{}};return t.widgetFactory=()=>d`
...
`);s!==e&&this.model.setValue(s)}openPackageManager(){$.showPackageManager({packages:this.requiredPackages,pyenv:this.pyenv,onPackageAdded:e=>{this.requiredPackages.includes(e)||(this.requiredPackages=[...this.requiredPackages,e],this.updatePackagesInContent())},onPackageRemoved:e=>{this.requiredPackages=this.requiredPackages.filter(t=>t!==e),this.updatePackagesInContent()}})}render(){return d`
    ...
    `;c([h({attribute:!1})],i.prototype,"input",2);c([h()],i.prototype,"readOnly",2);c([l()],i.prototype,"canExecute",2);c([l()],i.prototype,"pyenv",2);c([l()],i.prototype,"requiredPackages",2);i=c([w("k-monaco-editor")],i);export{i as KMonacoEditor};
