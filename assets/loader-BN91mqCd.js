import{F as e,V as t,X as n,g as r,h as i,v as a}from"./repeat-CUOIy3cL.js";import{R as o,T as s,j as c,z as l}from"./dist-8hKpvNa5.js";import"./lit-CtVJFi4_.js";import{_ as u}from"./src-BtgKmOay.js";import{t as d}from"./gs-map-editor-CGaDo0VT.js";import"./geo-BwI2KQCN.js";var f=n`
    wa-dialog {
        --width: 900px;
    }
...
`;function p(e){let n=e.stroke?.color||`transparent`,r=e.fill?.color||`transparent`,i=Math.min(e.stroke?.width||1,5),a=e.stroke?.lineDash?.join(` `)||`none`,o=e.stroke?.lineCap||`round`,s=e.stroke?.lineJoin||`round`;return e.image?.type===`circle`?m(e,n,r,i):e.image?.type===`regular-shape`?h(e,n,r,i):e.image?.type===`icon`?g(e):t`
    ...
    `}function m(e,n,r,i){let a=Math.min(e.image?.radius||5,15),o=e.image?.fill?.color||r,s=e.image?.stroke?.color||n,c=Math.min(e.image?.stroke?.width||i,3),l=e.image?.opacity??1,u=(e.image?.rotation||0)*(180/Math.PI),d=e.image?.scale||1;return t`
        <svg width="40" height="40" viewBox="0 0 40 40">
            <circle
                cx="20"
                cy="20"
    ...
    `}function h(e,n,r,i){let a=e.image?.points||5,o=Math.min(e.image?.radius||10,15),s=e.image?.fill?.color||r,c=e.image?.stroke?.color||n,l=Math.min(e.image?.stroke?.width||i,3),u=e.image?.opacity??1,d=((e.image?.rotation||0)+(e.image?.angle||0))*(180/Math.PI),f=_(20,20,o,a,e.image?.radius2);return t`
        <svg width="40" height="40" viewBox="0 0 40 40">
            <polygon
                points="${f}"
                fill="${s}"
    ...
    `}function g(e){let n=e.image?.src,r=e.image?.color||`#0064ff`,i=e.image?.opacity??1,a=(e.image?.rotation||0)*(180/Math.PI),o=e.image?.scale||1;return n?n.startsWith(`data:image/svg+xml`)?t`
            <div
                style="
                    width: 40px;
                    height: 40px;
    ...
    `}function P(e,n){let r=j(e.stroke?.lineDash);return t`
        <div class="form-section">
            ...
            <wa-color-picker
                ...
                opacity
                size="small"
                @change=${e=>n.onStrokeColorChange(e.target.value)}
            ></wa-color-picker>
            <wa-input
                type="number"
                label="Width"
                ...
                min="0"
                step="0.5"
                @input=${e=>n.onStrokeWidthChange(parseFloat(e.target.value))}
            ></wa-input>
            <wa-select
                label="Line Style"
                value="${r}"
                @change=${e=>n.onStrokeLineDashChange(w[e.target.value])}
            >
            ...
            <wa-select
                ...
                @change=${e=>n.onStrokeLineCapChange(e.target.value)}
            >
            ...
            <wa-select
                ...
                @change=${e=>n.onStrokeLineJoinChange(e.target.value)}
            >
    ...
    `}function F(e,n){return t`
        <div class="form-section">
            ...
            <wa-color-picker
                ...
                opacity
                size="small"
                @change=${e=>n.onFillColorChange(e.target.value)}
            ></wa-color-picker>
        </div>
    `}function I(e,n){let r=e.image?.type||`circle`;return t`
        <div class="form-section">
            <h4>Point Symbol</h4>
            <wa-select
                label="Symbol Type"
                value="${r}"
                @change=${e=>n.onImageTypeChange(e.target.value)}
            >
    ...
    `}function L(e,n){return t`
        ...
        <wa-input
            ...
            min="1"
            step="1"
            @input=${e=>n.onImageRadiusChange(parseFloat(e.target.value))}
        ></wa-input>
        <wa-color-picker
            label="Fill Color"
            ...
            opacity
            size="small"
            @change=${e=>n.onImageFillColorChange(e.target.value)}
        ></wa-color-picker>
        <wa-color-picker
            label="Stroke Color"
            ...
            opacity
            size="small"
            @change=${e=>n.onImageStrokeColorChange(e.target.value)}
        ></wa-color-picker>
        <wa-input
            type="number"
            label="Stroke Width"
            ...
            min="0"
            step="0.5"
            @input=${e=>n.onImageStrokeWidthChange(parseFloat(e.target.value))}
        ></wa-input>
    `}function R(e,n){let r=M(e.image?.points,e.image?.radius2),i=e.image?.radius2!==void 0;return t`
        <wa-divider></wa-divider>
        <wa-select
            label="Shape Preset"
            value="${r}"
            @change=${t=>{let r=A[t.target.value];r&&(n.onImagePointsChange(r.points),n.onImageRadius2Change(r.radius2===void 0?void 0:r.radius2*(e.image?.radius||10)))}}
        >
        ...
        <wa-input
            ...
            max="12"
            step="1"
            @input=${e=>n.onImagePointsChange(parseInt(e.target.value))}
        ></wa-input>
        <wa-input
            type="number"
            label="Outer Radius"
        ...
        <wa-switch
            ?checked=${i}
            @change=${t=>{t.target.checked?n.onImageRadius2Change((e.image?.radius||10)*.4):n.onImageRadius2Change(void 0)}}
        >
        ...
        ${i?t`
                  <wa-input
                      ...
                      min="1"
                      step="1"
                      @input=${e=>n.onImageRadius2Change(parseFloat(e.target.value))}
                  ></wa-input>
              `:``}
        <wa-input
            type="number"
            ...
            step="15"
            @input=${e=>n.onImageAngleChange(parseFloat(e.target.value)*Math.PI/180)}
        ></wa-input>
        <wa-color-picker
            label="Fill Color"
            value="${e.image?.fill?.color||`#0064ff`}"
        ...
        <wa-input
            ...
            @input=${e=>n.onImageStrokeWidthChange(parseFloat(e.target.value))}
        ></wa-input>
    `}function z(e,t=24){let n=e.trim();if(!n.startsWith(`<svg`)&&!n.startsWith(`<?xml`))throw Error(`Invalid SVG markup`);return n=n.replace(/<\?xml[^>]*\?>\s*/i,``),n.includes(`width=`)||(n=n.replace(`<svg`,`<svg width="${t}"`)),n.includes(`height=`)||(n=n.replace(`<svg`,`<svg height="${t}"`)),`data:image/svg+xml;base64,${btoa(unescape(encodeURIComponent(n)))}`}function B(e,n){let r=e.image?.src||``,i=r.startsWith(`data:`),a=i?O(r):null,o=a!==null,s=i&&!o,c=!i&&r.length>0,l=(i?k(r):null)||e.image?.color||E;if(!r){let e=D(`marker`,l);setTimeout(()=>n.onImageSrcChange(e),0),r=e,o=!0}let u=`marker`;return o&&a?u=a:o&&!a?u=`marker`:s?u=`paste-svg`:c&&(u=`custom-url`),t`
        <wa-divider></wa-divider>
        <wa-select
            label="Icon Source"
            value="${u}"
            @change=${e=>{let t=e.target.value;if(T[t]){let e=D(t,l);n.onImageSrcChange(e)}else(t===`paste-svg`||t===`custom-url`)&&n.onImageSrcChange(``)}}
        >
            <small>Presets</small>
        ...
        ${c||u===`custom-url`?t`
                  <wa-input
                      ...
                      @input=${e=>n.onImageSrcChange(e.target.value)}
                  ></wa-input>
              `:``}
        ...
        ${u===`paste-svg`?t`
                  <wa-textarea
                      ...
                      rows="4"
                      @input=${e=>{let t=e.target.value.trim();if(t&&t.startsWith(`<svg`))try{let e=z(t,24);n.onImageSrcChange(e)}catch(e){console.warn(`Invalid SVG:`,e)}}}
                  ></wa-textarea>
                  <p class="help-text">
        ...
        ${o?t`
                  <wa-color-picker
                      ...
                      opacity
                      size="small"
                      @change=${e=>{let t=a||u;if(T[t]){let r=D(t,e.target.value);n.onImageSrcChange(r)}}}
                  ></wa-color-picker>
              `:t`
                  <wa-color-picker
                      label="Tint Color"
                      ...
                      opacity
                      size="small"
                      @change=${e=>n.onImageColorChange(e.target.value)}
                  ></wa-color-picker>
                  <p class="help-text">
        ...
        <wa-input
            ...
            max="10"
            step="0.1"
            @input=${e=>n.onImageScaleChange(parseFloat(e.target.value))}
        ></wa-input>
    `}function V(e,n){let r=e.image?.type!==`icon`;return t`
        <wa-divider></wa-divider>
        <wa-input
            type="number"
            ...
            step="15"
            @input=${e=>n.onImageRotationChange(parseFloat(e.target.value)*Math.PI/180)}
        ></wa-input>
        <wa-slider
            label="Opacity"
            ...
            max="100"
            step="5"
            @change=${e=>n.onImageOpacityChange(e.target.value/100)}
        ></wa-slider>
        ${r?t`
                  <wa-input
                      type="number"
    ...
    `}function K(e,t,n,r){let i=e[t];if(!i)return null;let a=i;for(let e=0;e<n.length-1;e++){let t=n[e];a[t]||(a[t]={}),a=a[t]}let o=n[n.length-1];return a[o]===r?null:(r===void 0?delete a[o]:a[o]=r,{...e})}function q(e){return{onStrokeColorChange:t=>e([`stroke`,`color`],t),onStrokeWidthChange:t=>e([`stroke`,`width`],t),onStrokeLineDashChange:t=>e([`stroke`,`lineDash`],t),onStrokeLineCapChange:t=>e([`stroke`,`lineCap`],t),onStrokeLineJoinChange:t=>e([`stroke`,`lineJoin`],t),onFillColorChange:t=>e([`fill`,`color`],t),onImageTypeChange:t=>e([`image`,`type`],t),onImageRotationChange:t=>e([`image`,`rotation`],t),onImageOpacityChange:t=>e([`image`,`opacity`],t),onImageScaleChange:t=>e([`image`,`scale`],t),onImageRadiusChange:t=>e([`image`,`radius`],t),onImageFillColorChange:t=>e([`image`,`fill`,`color`],t),onImageStrokeColorChange:t=>e([`image`,`stroke`,`color`],t),onImageStrokeWidthChange:t=>e([`image`,`stroke`,`width`],t),onImageSrcChange:t=>e([`image`,`src`],t),onImageColorChange:t=>e([`image`,`color`],t),onImageAnchorChange:t=>e([`image`,`anchor`],t),onImagePointsChange:t=>e([`image`,`points`],t),onImageRadius2Change:t=>e([`image`,`radius2`],t),onImageAngleChange:t=>e([`image`,`angle`],t)}}var J=class extends e{constructor(...e){super(...e),this.open=!1,this.handleDialogHide=e=>{e.target.tagName.toLowerCase()===`wa-dialog`&&this.hide()},this.handleCancel=()=>{this.hide()},this.handleSave=()=>{this.gsMap&&this.workingStyles&&this.workingRules&&(this.gsMap.styles=this.workingStyles,this.gsMap.styleRules=this.workingRules),this.onSave?.(),this.hide()},this.handleAddStyle=()=>{console.log(`Add style`)},this.handleAddRule=()=>{console.log(`Add rule`)}}static{this.styles=f}show(e){this.onSave=e,this.gsMap&&(this.workingStyles=JSON.parse(JSON.stringify(this.gsMap.styles||{})),this.workingRules=JSON.parse(JSON.stringify(this.gsMap.styleRules||[]))),this.open=!0,this.requestUpdate()}hide(){this.open=!1,this.selectedStyleId=void 0,this.selectedRuleId=void 0,this.workingStyles=void 0,this.workingRules=void 0,this.gsMap=void 0,this.requestUpdate()}render(){return this.open?t`
        ...
        `}renderStylesTree(){return!this.workingStyles||Object.keys(this.workingStyles).length===0?t`<p class="empty-message">No styles available</p>`:t`
            <wa-tree selection="single" class="style-tree">
                ${Object.entries(this.workingStyles).map(([e])=>this.renderStyleTreeItem(e))}
            </wa-tree>
        `}renderStyleTreeItem(e){let n=this.workingStyles[e];return t`
            <wa-tree-item
        ...
        `}renderSelectedStyleDetail(){if(!this.selectedStyleId||!this.workingStyles?.[this.selectedStyleId])return t`
                <div class="detail-panel empty">
                    <p>Select a style to edit</p>
                </div>
            `;let e=this.workingStyles[this.selectedStyleId],n=v(this.selectedStyleId,this.workingRules||[]),r=q((e,t)=>this.updateStyleProperty(e,t));return N(this.selectedStyleId,e,n,r)}renderRulesTab(){return t`
        ...
        `}renderRulesTree(){return!this.workingRules||this.workingRules.length===0?t`<p class="empty-message">No rules available</p>`:t`
            <wa-tree selection="single" class="rule-tree">
                ${this.workingRules.map((e,t)=>this.renderRuleTreeItem(e,t))}
            </wa-tree>
        `}renderRuleTreeItem(e,n){let r=e.id||`rule-${n}`;return t`
            <wa-tree-item
