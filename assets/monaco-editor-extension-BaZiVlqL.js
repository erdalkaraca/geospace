import{U as m,e as h,s as f}from"./editor.main-DdRjGR0J.js";import{e as k,x as l,b as y,d as w,a as v,n as p,r as u,t as P}from"./index-G4cLbRFh.js";import{h as C,p as g,P as x,w as W,o as $,F as q}from"./main-BS49fa1D.js";import{pythonPackageManagerService as I}from"./package-manager-extension-C1xpkpZo.js";function b(e){return new Worker("/assets/editor.worker-BKDaejSB.js",{type:"module",name:e==null?void 0:e.name})}function E(e){return new Worker("/assets/json.worker-bnpFxRku.js",{type:"module",name:e==null?void 0:e.name})}function R(e){return new Worker("/assets/css.worker-BAVIDzD3.js",{type:"module",name:e==null?void 0:e.name})}function j(e){return new Worker("/assets/html.worker-De8bSgst.js",{type:"module",name:e==null?void 0:e.name})}function M(e){return new Worker("/assets/ts.worker-8yPRNxAu.js",{type:"module",name:e==null?void 0:e.name})}var D=Object.defineProperty,L=Object.getOwnPropertyDescriptor,d=(e,t,n,r)=>{for(var a=r>1?void 0:r?L(t,n):t,s=e.length-1,o;s>=0;s--)(o=e[s])&&(a=(r?o(t,n,a):o(a))||a);return r&&a&&D(t,n,a),a};self.MonacoEnvironment={getWorker(e,t){return t==="json"?new E:t==="css"||t==="scss"||t==="less"?new R:t==="html"||t==="handlebars"||t==="razor"?new j:t==="typescript"||t==="javascript"?new M:new b}};$.registerEditorInputHandler({canHandle:e=>e instanceof q,handle:async e=>{const t={title:e.getName(),data:e,key:e.getName(),editorId:"monaco-editor",icon:"file-pen",noOverflow:!1,state:{}};return t.widgetFactory=()=>l`
