import{l as f,j as b,K as C,u as w,f as m,aa as i,d as u,g as c,B as k,k as x,r as d,w as _,t as h,F as v,b as y}from"./geospace-app-CkDP6MS6.js";import"./preload-helper-WQhrSmCl.js";import"./chunk.IVRNYRHD-89zOMqhG.js";var A=Object.defineProperty,I=Object.getOwnPropertyDescriptor,p=(e,t,o,a)=>{for(var n=a>1?void 0:a?I(t,o):t,s=e.length-1,l;s>=0;s--)(l=e[s])&&(n=(a?l(t,o,n):l(n))||n);return a&&n&&A(t,o,n),n};const T="catalog.root";let r=class extends C{constructor(){super(...arguments),this.treeRef=w()}doBeforeUI(){const e=m.getContributions(T);this.rootNodes=this.toTreeNodes(e)}renderToolbar(){const e=i.get()instanceof r&&u.get()!==void 0;return c`
            <k-command
                cmd="checkout"
    ...
    `;p([b()],r.prototype,"rootNodes",2);r=p([x("gs-catalog")],r);async function $(e,t){if(!e||t.includes("/"))return t;const a=(await e.listChildren(!1))[0];return a?`${a.getName()}/${t}`:t}d({command:{id:"checkout",name:"Checkout",description:"Checkout a catalog item into the workspace",parameters:[{name:"url",description:"the url of the resource to checkout, if not provided, the current selection in the catalog will be used",required:!1}]},handler:{execute:async e=>{let t=e.params&&e.params.url;if(!t){const a=u.get();if(!a||!("url"in a))return;t=a.url}const o=await _.getWorkspace();if(!o){h("No workspace selected.");return}fetch(t,{method:"GET"}).then(a=>a.blob()).then(async a=>{const n=new URL(t).pathname.split("/"),s=n[n.length-1],l=await $(o,s);return o.getResource(l,{create:!0}).then(g=>g.saveContents(a,{contentType:v.BINARY}).then(()=>{y("File checked out: "+s)}))}).catch(a=>{h(String(a))})}}});d({command:{id:"refresh_catalog",name:"Refresh Catalog",description:"Refreshes the catalog view",parameters:[]},handler:{execute:async()=>{const e=i.get();e instanceof r&&e.refresh()}}});d({command:{id:"catalog_expand_all",name:"Expand All Catalog Items",description:"Expands all items in the catalog tree",parameters:[]},handler:{execute:async()=>{const e=i.get();e instanceof r&&e.setAllExpanded(!0)}}});d({command:{id:"catalog_collapse_all",name:"Collapse All Catalog Items",description:"Collapses all items in the catalog tree",parameters:[]},handler:{execute:async()=>{const e=i.get();e instanceof r&&e.setAllExpanded(!1)}}});m.registerContribution("system.fastviews-bottomend",{name:"catalog",label:"Catalog",icon:"book",component:e=>c`<gs-catalog id="${e}"></gs-catalog>`});
